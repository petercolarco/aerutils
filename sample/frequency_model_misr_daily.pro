...
; Procedure call
  pro frequency_model_misr_daily, resolution
...
; Models
  outfilehead  = 'e530.MISR_regions.'+resolution+'.freq.daily.'
  outfilehead2 = 'e530.MISR_regions.'+resolution+'.daily.'
...
;     Control file names
      qawtfile = 'e530_yotc_01.tavg3_2d_aer_Cx.aero_F12_0022.'+sample[ictl]+'.ctl'
