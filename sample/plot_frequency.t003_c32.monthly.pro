  outfilehead = 't003_c32.MOD04.freq.'
...
;  for iyr = 0, 6 do begin
;  for im = 0, 11 do begin
  for iyr = 3, 3 do begin
  for im = 4, 4 do begin
...
; Make plot
  set_plot, 'ps'
  device, /color, file='./output/plots/frequency.t003_c32.MOD04.'+str+'.ps'
  loadct, 39
...
; Read in the files
  ...
  for ictl = 0, nctl-1 do begin
   title_array = 'Fraction of AOT > '+hstr+' ('+str+') ('+sample[ictl]+')'
