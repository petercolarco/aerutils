...
;  satid = 'MOD04'
  ...
  resolution = 'b'
;  resolution = 'ten'
  tag   = satid+'.mm.'+resolution+'.'+weight+'ocn_2003_2011.corrected.daily'
  nymd0 = '20030101'
  nymd1 = '20111231'
...
; angle dependency relative to full swath (subtract from number calculated)
  ...
  fileatemplate =    MODISDIR[0]+'/MODIS/Level3/'+satid+'/'+resolution+'/GRITAS/Y%y4/M%m2' $
                  + ['/'+satid+'_L2_ocn.aero_tc8_051.qast.%y4%m2%d2.nc4', $
                     '/'+satid+'_L2_ocn.supermisr.aero_tc8_051.qast.%y4%m2%d2.nc4', $
                     '/'+satid+'_L2_ocn.misr1.aero_tc8_051.qast.%y4%m2%d2.nc4', $
                     '/'+satid+'_L2_ocn.misr2.aero_tc8_051.qast.%y4%m2%d2.nc4', $
                     '/'+satid+'_L2_ocn.misr3.aero_tc8_051.qast.%y4%m2%d2.nc4', $
                     '/'+satid+'_L2_ocn.caliop1.aero_tc8_051.qast.%y4%m2%d2.nc4', $
                     '/'+satid+'_L2_ocn.caliop2.aero_tc8_051.qast.%y4%m2%d2.nc4', $
                     '/'+satid+'_L2_ocn.caliop3.aero_tc8_051.qast.%y4%m2%d2.nc4' ]
