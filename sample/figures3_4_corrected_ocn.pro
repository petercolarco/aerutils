...
;  satid = 'MOD04'
  ...
  resolution = 'b'
;  resolution = 'ten'
  tag   = satid+'.mm.'+resolution+'.'+weight+'ocn_2003_2011.corrected'
  nymd0 = '20030101'
  nymd1 = '20111231'
...
; New as of 3/2
  ...
  fileatemplate =    MODISDIR[0]+'/MODIS/Level3/'+satid+'/'+resolution+'/GRITAS/Y%y4/M%m2' $
                  + ['/'+satid+'_L2_ocn.aero_tc8_051.qast_qawt.'+weight+'%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.supermisr.aero_tc8_051.qast_qawt.'+weight+'%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.misr1.aero_tc8_051.qast_qawt.'+weight+'%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.misr2.aero_tc8_051.qast_qawt.'+weight+'%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.misr3.aero_tc8_051.qast_qawt.'+weight+'%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.caliop1.aero_tc8_051.qast_qawt.'+weight+'%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.caliop2.aero_tc8_051.qast_qawt.'+weight+'%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.caliop3.aero_tc8_051.qast_qawt.'+weight+'%y4%m2.nc4' ]
  filentemplate =    MODISDIR[0]+'/MODIS/Level3/'+satid+'/'+resolution+'/GRITAS/Y%y4/M%m2' $
                  + ['/'+satid+'_L2_ocn.aero_tc8_051.qast_qafl.%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.supermisr.aero_tc8_051.qast_qafl.%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.misr1.aero_tc8_051.qast_qafl.%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.misr2.aero_tc8_051.qast_qafl.%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.misr3.aero_tc8_051.qast_qafl.%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.caliop1.aero_tc8_051.qast_qafl.%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.caliop2.aero_tc8_051.qast_qafl.%y4%m2.nc4', $
                     '/'+satid+'_L2_ocn.caliop3.aero_tc8_051.qast_qafl.%y4%m2.nc4' ]
...
;  Read the monthly mean files
   ...
   aot_ = aot_-corrfact[itemplate,0]
...
; Plot the PDF
  ...
  ymax = .1
  plot, aotbins, naotbins[*,0,0], thick=3, title = 'MODIS Aqua Ocean', yrange=[0,ymax], $
  ...
  loadct, 0
  difbins = findgen(nbins)*cumbindel+cumbinmin
  plot, difbins, cumbins[*,0,0], thick=3, title = 'MODIS Aqua Ocean', yrange=[0,1], $
