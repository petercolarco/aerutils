...
; 5 seasons: 0 = all year, 1 = DJF, 2 = MAM, 3 = JJA, 4 = SON
  ...
  filetemplate =    MODISDIR[0]+'/MODIS/Level3/MOD04/d/GRITAS/Y%y4/M%m2' $
                 + ['/MOD04_L2_lnd.aero_tc8_051.qast3.%y4%m2%d2.nc4', $
                    '/MOD04_L2_lnd.caliop1.aero_tc8_051.qast3.%y4%m2%d2.nc4', $
                    '/MOD04_L2_lnd.caliop2.aero_tc8_051.qast3.%y4%m2%d2.nc4', $
                    '/MOD04_L2_lnd.misr1.aero_tc8_051.qast3.%y4%m2%d2.nc4', $
                    '/MOD04_L2_lnd.misr2.aero_tc8_051.qast3.%y4%m2%d2.nc4', $
                    '/MOD04_L2_lnd.supermisr.aero_tc8_051.qast3.%y4%m2%d2.nc4' ]
...
;  Method 2 (gridpdf)
;   PDF of saved PDF of each grid box
    2: begin
       arr = fltarr(nbins)
...
;  Method 4 (gridpdf_weight)
;   PDF of saved PDF of each grid box weighted by number of obs
    4: begin
       arr = fltarr(nbins)
       for i = 0, nbins-1 do begin
        arr[i] = total(aotpdf_[*,*,i]*num_,/nan)
       endfor
       end
