...
# Modify below to specify kind of averaging you want: time, resolution, etc.
  set years       = `echo 2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 2010 2011`
...
#      foreach samples (1 2 3 4 5 6 7 8 9 0)
      foreach samples (a b c d e f g h i)
...
#       Average the AOT
        lats4d.sh -v -i qawt.${rand}.ddf -o tmp_qawt.${rand} \
           -func "sum(@*num,t=1,t=$ntime)/sum(num,t=1,t=$ntime)" \
           -vars aot \
        ...
        \mv -f tmp_qawt.${rand}.nc4 $datadir/Y$YYYY/M$MM/$datatyp.$sample$odsver.${qawt}_qawt.num.$YYYY$MM.nc4
