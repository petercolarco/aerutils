...
# Satellite data
  ...
  set datadir   = /misc/prc15/colarco/modis/data/Level3/$satid/hourly/$resolution/GRITAS/
...
#     lats4d.sh -i tmp_qawt.${rand}.nc -o tmp_qawt.10.${rand} -shave -geos10x10a
   ...
   # clean-up
     ...
     mv -f tmp_qawt.${rand}.nc4 \
           $expdir/Y$YYYY/M$MM/$expstr.$datatyp.$sample.thresh.$YYYY$MM.nc4
