...
#     Average the QAFL
      ...
      \mv -f tmp_qawt.${rand}.nc4 $datadir/clim/$datatyp.$odsver.$qawt.clim$MM.nc4
      \mv -f tmp_qafl.${rand}.nc4 $datadir/clim/$datatyp.$odsver.$qafl.clim$MM.nc4
