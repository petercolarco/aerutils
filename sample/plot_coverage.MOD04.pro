...
; and then the ratio of observations (misr, subpoint)
  ...
  title_array = ['# MODIS observations (0.5 x 0.67) 2000 - 2009', $
                 'Ratio #MISR/#MODIS', 'Ratio #Subpoint/#MODIS', $
                 'Ratio #Subpoint (22)/#MODIS']
...
; Make plot
  set_plot, 'ps'
  device, /color, file='./output/plots/coverage.MOD04.d.freq.daily.ps', $
   xsize=18, ysize=16, xoff=.5, yoff=.5, /helvetica, font_size=12
  !p.font=0
  loadct, 39
  colorarray = findgen(10)*25+25
  levelarray = [200,500,1000,2000,5000,10000.,20000,50000,100000,200000]
