...
; For the model: we don't have the QAFL file equivalent,
; so we use the satellite QAFL.

; Procedure call
  pro frequency_model_daily, resolution
...
; Models
  outfilehead  = 'e530_regions.'+resolution+'.freq.daily.'
  outfilehead2 = 'e530_regions.'+resolution+'.daily.'
  sample = ['modis','shift_misr','shift_subpoint','shift_subpoint.obs_22']
  sample = ['shift_subpoint.obs_22']
...
;     Control file names
      qawtfile = 'e530_yotc_01.tavg3_2d_aer_Cx.aero_tc8_005.'+sample[ictl]+'.ctl'
