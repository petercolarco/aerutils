...
#  set DD   = 24
  ...
  set modelo = $model/Y$YYYY/M$MM/MOD04_L2_ocn.aero_tc8_005.qawt
...
#   lats4d.sh -i $modelf -j $swathf -o modis -func "maskout(aodtau,modis.2(z=1))" -shave
...
#   chmod g+s,g+w modis.nc4 &
   chmod g+s,g+w misr.$rand.nc4 &
   chmod g+s,g+w subpoint.$rand.nc4 &
   wait

#   \mv -f modis.nc4    $modelo.modis.$YYYY$MM$DD.nc4
