...
; Get the lifetimes
  expid = ['d_F25b9-base-v1',$      ; no forcing
           'dF_F25b9-base-v1', $    ; OPAC-Spheres
...
;  for iex = 2, 2 do begin
  ...
  set_plot, 'ps'
  device, file = './plot_totexttau.'+expid[0]+'.'+aersite[iex]+'.eps', /color, /helvetica, $
...
; Get the AERONET data
  loadct, 0
  aeronetpath = '../../../aeronet/output/aeronet2nc/'
  nyears = 18
