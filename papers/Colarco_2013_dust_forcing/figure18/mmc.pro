...
nodust       = 'b_F25b9-base-v1'
opac_spheres = 'bF_F25b9-base-v1'
OBS_spheres  = 'bF_F25b9-base-v8'
noaerosol    = nodust
dust         = OBS_spheres
coll         = 'geosgcm_prog'
coll2        = 'tavg3d_carma_p';; duconc 10-7 isoline 

f1  = exppath+noaerosol+'/'+coll+'/'+noaerosol+'.'+coll+'.monthly.clim.DJF.nc4'
f2  = exppath+dust+'/'+coll+'/'+dust+'.'+coll+'.monthly.clim.DJF.nc4'
f3  = exppath+dust+'/'+coll2+'/'+dust+'.'+coll2+'.monthly.clim.DJF.nc4'
fid1 = ncdf_open(f1)
fid2 = ncdf_open(f2)
fid3 = ncdf_open(f3)
...
;;;;; PLOT MMC CHANGES
PSOPEN, FILE='Pete_mmc_obs-no_DJF.ps', $
...
CON, F=DIFF_U_zonal, X=lat, Y=lev,/NOLINES,$
        TITLE='DJF '+DELTA+'U: OBS-Spheres - NOAERO', $
...
CON, F=mmc_diff*1e-10, X=lat, Y=lev,/NOLINES,$
        TITLE='DJF '+DELTA+'MMC: OBS-Spheres - NOAERO', $
