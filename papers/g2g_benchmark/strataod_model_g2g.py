...
for date in dates:
    ...
    extm,latm,rc = model.readzonal(yy,mm,dd=dd,expid="c180R_v10.23.0_g2g")
...
#plt.show()
print('plotting')
fig.savefig('model_strataod_2016_2016.g2g.png')
print('done')
plt.close(fig)

# Write the plotted data to a file
fid = Dataset('geos_daily_zonal.g2g.nc', 'w', format='NETCDF4', clobber=True)
