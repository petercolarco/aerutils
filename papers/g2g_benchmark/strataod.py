...
#plt.show()
print('plotting')
fig.savefig('snppompslp_strataod_2016_2019.png')
print('done')
plt.close(fig)

# Write the plotted data to a file
fid = Dataset('omps_lp_daily_zonal.nc', 'w', format='NETCDF4', clobber=True)
fid.description = "source: OMPS_LP v2.1 gridded data, zonal/daily average, \
                   require scattering angle < 148"
