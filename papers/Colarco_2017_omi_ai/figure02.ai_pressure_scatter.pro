...
; Setup the plot
  plotfile = 'figure02.ai_pressure_scatter.ps'
  set_plot, 'ps'
...
; Panel 1: Joint PDF of AI and Surface Pressure Differences
  ...
  plot, findgen(10), /nodata, $
   ...
   yrange=[-2,2], xrange=[-150,150], $
   ytitle='AI Difference!COMAERUV (own pressure) - MERRAero', $
   xtitle='Surface Pressure Difference [hPa] (OMAERUV - MERRAero)', $
        charsize=.75
  xyouts, .075, .935, /normal, charsize=.75, $
   'a) Histogram of AI and Surface Pressure Differences'
...
; Panel 2: 
  ...
  plot, findgen(10), /nodata, /noerase, $
   ...
   ytitle='AI Difference!COMAERUV - MERRAero'
