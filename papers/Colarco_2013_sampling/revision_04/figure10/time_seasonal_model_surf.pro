...
print, im, seas[im]
    for isam = 0, nsam-1 do begin
     ...
     read_seasonal_model_surf, 'dR_MERRA-AA-r2', sample[isam], yyyy[iy], seas[im], aotsat, $
                    res=res, exclude=exclude, inverse=inverse, $
                    lon0=lon0, lon1=lon1, lat0=lat0, lat1=lat1, reg_aot=reg_aot_, reg_std=reg_std_;, /clear
...
;  save, /all, filename='time_monthly_model.cloud2.sav'
  save, /all, filename='time_seasonal_model_surf.dR_MERRA-AA-r2.noTERRA.allsky.sav'
