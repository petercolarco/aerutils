  nc4readvar, 'MYD04_L2_ocn.caliop1.aero_tc8_051.qast.20100605.nc4', 'aot', $
              aoto, lon=lon, lat=lat
  nc4readvar, 'MYD04_L2_lnd.caliop1.aero_tc8_051.qast3.20100605.nc4', 'aot', $
...
;              /over, image_location=[-1,581])
  im2 = image('caliop1.png',image_dimensions=[687,344], $
