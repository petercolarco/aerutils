...
;  oplot, x, deltal2, thick=8, color=75, lin=2
  if(ireg eq 4) then begin
   ...
   plots, [2,5], .0865*1.8, thick=8, color=75
   xyouts, 6, .091*1.8, 'MODIS along-track !9D!3AOT', charsize=.8, color=254
   xyouts, 6, .085*1.8, 'MODIS across-track !9D!3AOT', charsize=.8, color=75
   plots, [20,23], .0925*1.8, thick=8, color=0
   xyouts, 24, .091*1.8, 'MERRAero along-track !9D!3AOT', charsize=.8
   loadct, 0
   polyfill, [20,23,23,20,20], 1.8*[.085,.085,.088,.088,.085], color=200, /fill
   xyouts, 24, .085*1.8, 'MERRAero !9D!3Forcing', charsize=.8, color=100
   loadct, 39
  endif
...
;stop
  ...
  if(ireg eq 4) then begin
   plots, [3,6], .7, thick=4, color=254
   polyfill, [3,6,6,3,3], [.58,.58,.62,.62,.58], color=208, /fill
   plots, [21,24], .7, thick=4, lin=2, color=254
   xyouts, 7, .68, 'AOT!DFull Swath!N', charsize=.8, color=254
   xyouts, 7, .58, 'Range of !9D!3AOT about AOT!DFull Swath!N', charsize=.8, color=254
   xyouts, 25, .68, '!9D!3AOT as fraction of AOT!DFull Swath!N', charsize=.8, color=254
  endif
