...
print, isample, globaot[*,1,isample]
  ...
  !p.multi = [0,1,2]
  set_plot, 'ps'
  device, file='modis_aot_annual.'+satid+'.'+res+'.exclude_inverse.ocn.eps', /color, /helvetica, font_size=12, $
  ...
  plot, x, globaot[*,0,0], /nodata, yrange=[0.11,.2], $
   xtitle = 'Year', ytitle='AOT', title=satid+' Ocean AOT (Average-then-Mask)', $
...
;  polymaxmin, x, y, thick=8, fill=200
  ...
  oplot, x, globaot[*,0,1], thick=8, lin=2
  oplot, x, globaot[*,0,2], thick=8, color=254
  oplot, x, globaot[*,0,3], thick=8, color=254, lin=2
  oplot, x, globaot[*,0,4], thick=8, color=254, lin=1
  oplot, x, globaot[*,0,5], thick=8, color=75
  oplot, x, globaot[*,0,6], thick=8, color=75, lin=2
  oplot, x, globaot[*,0,7], thick=8, color=75, lin=1
  oplot, x, globaot[*,0,8], thick=8, color=254, lin=3
  oplot, x, globaot[*,0,9], thick=8, color=75, lin=3

  ymax = 0.2
  ymin = 0.11
  dy = ymax-ymin
  plots, [1,2], .94*dy+ymin, thick=8
  plots, [1,2], .87*dy+ymin, thick=8, lin=2
  plots, [4,5], .94*dy+ymin, thick=8, color=254
  plots, [4,5], .87*dy+ymin, thick=8, color=254, lin=2
  plots, [4,5], .80*dy+ymin, thick=8, color=254, lin=1
  plots, [4,5], .73*dy+ymin, thick=8, color=254, lin=3
  plots, [7,8], .94*dy+ymin, thick=8, color=75
  plots, [7,8], .87*dy+ymin, thick=8, color=75, lin=2
  plots, [7,8], .80*dy+ymin, thick=8, color=75, lin=1
  plots, [7,8], .73*dy+ymin, thick=8, color=75, lin=3
  xyouts, 2.1, .925*dy+ymin, 'Full Swath'
  xyouts, 2.1, .855*dy+ymin, 'MW'
  xyouts, 5.1, .925*dy+ymin, 'N1'
  xyouts, 5.1, .855*dy+ymin, 'N2'
  xyouts, 5.1, .785*dy+ymin, 'N3'
  xyouts, 5.1, .715*dy+ymin, 'N4'
...
;  polyfill, [0,max(x)+1,max(x)+1,0,0], [-.01,-.01,.01,.01,-.01], color=200
  loadct, 39
  oplot, x, globaot[*,0,1]-globaot[*,0,0], thick=8, lin=2
  oplot, x, globaot[*,0,2]-globaot[*,0,0], thick=8, color=254
  oplot, x, globaot[*,0,3]-globaot[*,0,0], thick=8, color=254, lin=2
  oplot, x, globaot[*,0,4]-globaot[*,0,0], thick=8, color=254, lin=1
  oplot, x, globaot[*,0,5]-globaot[*,0,0], thick=8, color=75
  oplot, x, globaot[*,0,6]-globaot[*,0,0], thick=8, color=75, lin=2
  oplot, x, globaot[*,0,7]-globaot[*,0,0], thick=8, color=75, lin=1
  oplot, x, globaot[*,0,8]-globaot[*,0,0], thick=8, color=254, lin=3
  oplot, x, globaot[*,0,9]-globaot[*,0,0], thick=8, color=75, lin=3
  ...
  !p.multi = [0,1,2]
  set_plot, 'ps'
  device, file='modis_aot_annual.'+satid+'.'+res+'.exclude_inverse.lnd.eps', /color, /helvetica, font_size=12, $
   xsize=16, ysize=20, xoff=.5, yoff=.5, /encap
  !p.font=0
  loadct, 0
  plot, x, globaot[*,1,0], /nodata, yrange=[0.13,0.23], $
   xtitle = 'Year', ytitle='AOT', title=satid+' Land AOT (Average-then-Mask)', $
   xticks = nyrs+1, xtickn = xticklabels, xminor=1, yminor=2, $
   xstyle=9, ystyle=9, xthick=6, ythick=6, xrange=[0,nyrs+1]
...
;  polymaxmin, x, y, thick=8, fill=200
  ...
  oplot, x, globaot[*,1,1], thick=8, lin=2
  oplot, x, globaot[*,1,2], thick=8, color=254
  oplot, x, globaot[*,1,3], thick=8, color=254, lin=2
  oplot, x, globaot[*,1,4], thick=8, color=254, lin=1
  oplot, x, globaot[*,1,5], thick=8, color=75
  oplot, x, globaot[*,1,6], thick=8, color=75, lin=2
  oplot, x, globaot[*,1,7], thick=8, color=75, lin=1
  oplot, x, globaot[*,1,8], thick=8, color=254, lin=3
  oplot, x, globaot[*,1,9], thick=8, color=75, lin=3
...
;  polyfill, [0,max(x)+1,max(x)+1,0,0], [-.01,-.01,.01,.01,-.01], color=200
  loadct, 39
  oplot, x, globaot[*,1,1]-globaot[*,1,0], thick=8, lin=2
  oplot, x, globaot[*,1,2]-globaot[*,1,0], thick=8, color=254
  oplot, x, globaot[*,1,3]-globaot[*,1,0], thick=8, color=254, lin=2
  oplot, x, globaot[*,1,4]-globaot[*,1,0], thick=8, color=254, lin=1
  oplot, x, globaot[*,1,5]-globaot[*,1,0], thick=8, color=75
  oplot, x, globaot[*,1,6]-globaot[*,1,0], thick=8, color=75, lin=2
  oplot, x, globaot[*,1,7]-globaot[*,1,0], thick=8, color=75, lin=1
  oplot, x, globaot[*,1,8]-globaot[*,1,0], thick=8, color=254, lin=3
  oplot, x, globaot[*,1,9]-globaot[*,1,0], thick=8, color=75, lin=3
  axis, 0, 0, xaxis=0, xticks = nyrs+1, xtickn = make_array(nyrs+2,val=' '), xminor=1
  axis, 0, 0, xaxis=1, xticks = nyrs+1, xtickn = make_array(nyrs+2,val=' '), xminor=1
