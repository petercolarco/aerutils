...
; Get the seasonal time series information
  restore, filename='time_seasonal.tmp.sav'
...
;   position = [0.1,0.15,0.9,0.9], $
  ...
  if(ireg eq 0) then begin
   ...
   plots, [26,29], .074, thick=8, color=75
   plots, [26,29], .066, thick=8, color=254
