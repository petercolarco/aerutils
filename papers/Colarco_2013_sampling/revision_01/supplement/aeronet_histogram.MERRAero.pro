...
; Expid to compare
  expid = ['dR_MERRA-AA-r2','dR_F25b18','cR_F25b18','F25b18']
  expfn = ['/Volumes/bender/prc15/colarco/dR_MERRA-AA-r2/inst2d_hwl_x/aeronet/', $
           '/Volumes/bender/prc14/colarco/dR_F25b18/inst2d_hwl_x/aeronet/', $
           '/Volumes/bender/prc14/colarco/cR_F25b18/inst2d_hwl_x/aeronet/', $
           '/Volumes/bender/prc14/colarco/F25b18/inst2d_hwl_x/aeronet/'] $
          + expid+'.inst2d_hwl.aeronet.%ch.%y4.nc4'
  nexp = n_elements(expid)
 nexp = 1

; How sample?
  yyyy = strpad(findgen(10)+2003.,1000L)
  date0 = '20030101'
  date1 = '20121231'
  nymd = [date0,date1]
  nhms = ['000000','230000']
...
; Read the database of aeronet locations
  ...
  aeronetPath = '/Volumes/bender/prc10/AERONET/LEV30/'
  lambdabase = '550'
  first = 1
  useloc = intarr(nlocs)
  numloc = lonarr(nlocs)
...
if(locwant eq 'Abracos_Hill') then stop
...
;  At this point read the corresponding model
  ...
  save, /all, filename='aeronet_histogram.MERRAero.sav'
