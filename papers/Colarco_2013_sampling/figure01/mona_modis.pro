  nc4readvar, 'MYD04_L2_ocn.aero_tc8_051.qast.20100605.nc4', 'aot', $
              aoto, lon=lon, lat=lat
  nc4readvar, 'MYD04_L2_lnd.aero_tc8_051.qast3.20100605.nc4', 'aot', $
...
;              /over, image_location=[-1,581])
  im2 = image('modis.png',image_dimensions=[687,344], $
