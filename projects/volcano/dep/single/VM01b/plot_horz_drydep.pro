...
; Plot the zonal mean time series of AOT
  ...
  g5expid = 'VM'+g5v+g5s+['01b','02','03','04','05']+'.tavg2d_carma_x.ddf'
...
; Get the GEOS-5 climatology and remove
  g5clim = 'VMcontrol'+['01b','02','03','04','05']+'.tavg2d_carma_x.ddf'
...
;  if(a[0] ne -1) then g5[a] = 0.
  ...
  contour, g5, findgen(60)/12., lat, /nodata, $
   ...
   position=[.1,.25,.95,.92]
  loadct, 70
  levels = findgen(16)*.5e-13 - 4.e-13
  ...
  makekey, .1,.05,.85,.04,0,-.035,colors=colors, $
   label=['-0.4','-0.2','0','0.2','0.4'], /noborder
  loadct, 0
  xyouts, .1, .1, 'Dry Deposition [10!E-12!N kg m!E-2!N s!E-1!N]', /normal
