...
; Experiments
  ...
  case iper of
   0: begin
      range=indgen(112)
      filetag = '0_2'
      titlestr = 'Weeks 0 - 2 Number of models with 50% frequency of volcanic SO2 > 0.2 DU, '
      end
   1: begin
      range=indgen(112)+112
      filetag = '2_4'
      titlestr = 'Weeks 2 - 4 Number of models with 50% frequency of volcanic SO2 > 0.2 DU, '
      end
   2: begin
      range=indgen(112)+224
      filetag = '4_6'
      titlestr = 'Weeks 4 - 6 Number of models with 50% frequency of volcanic SO2 > 0.2 DU, '
      end
  endcase
  ...
  for iexpid = 0, nexpid-1 do begin
   for iexpnm = 0, 4 do begin
    ...
    filetemplate = expid[iexpid]+mon+expnm[iexpnm]+'.tavg2d_aer_x.ddf'
...
; Make a plot of the distribution of SO2 at the half point
  set_plot, 'ps'
  device, file='plot_so2volc.'+mon+'01.thresh.model.weeks'+filetag+'.ps', $
...
; Set up a six-element array of the positions for individual panels
  ...
  red   = [237,127,65,34,12,    152, 0]
  green = [248,205,182,94,44,  152, 0]
  blue  = [177,187,196,168,132,152, 0]
