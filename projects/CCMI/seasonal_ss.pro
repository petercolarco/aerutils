...
; Get the RefD1
  ...
  read_budget_table, 'RefD1', 'SS', yyyy, $
...
; Get the MERRA-2
  ...
  read_budget_table, 'merra2.d5124_m2_jan79.tavg1_2d_aer_Nx', 'SS', yyyy, $
                     emis, sed, dep, wet, scav, burden, tau
  aod_ = mean(tau,dimension=2)

; Make a plot
  set_plot, 'ps'
  device, file='seasonal_ss.ps', /helvetica, font_size=14, $
   /color
  !p.font=0
  ...
  plot, indgen(10), /nodata, $
   ...
   yrange=[0.03,0.06], ytitle='AOD', xstyle=9, ystyle=9
  loadct, 39
