...
; Data file
  dir = '/misc/prc14/colarco/CCMI/ref_c2_h53/geosgcm_flux/'
  filename = dir +  'ref_c2_h53.geosgcm_flux.monthly.201207.nc4'
  nc4readvar, filename, ['RSR','RSRNA','RSRS','RSRSNA'], oc12, lon=lon, lat=lat
  filename = dir +  'ref_c2_h53.geosgcm_flux.monthly.201307.nc4'
  nc4readvar, filename, ['RSR','RSRNA','RSRS','RSRSNA'], oc13, lon=lon, lat=lat
...
; convert the units
  ...
  set_plot, 'ps'
  device, file='ref_c2_h53.rad.201207_201307.ps', font_size=14, /helvetica, /color, $
