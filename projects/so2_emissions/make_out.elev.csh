...
dset tmp/htapv2.2.emisso2.elevated.x3600y1800t12.$yyyy.integrate.nc4
options template
undef 1.e15
...
# lats4d it
lats4d.sh -i htapv2.2.emisso2.elevated.ddf -shave \
          -o out/htapv2.2.emisso2.elevated.x3600y1800t12.$yyyy.integrate.nc4
...
ncatted -O -a units,sanl2,m,c,"kg m-2 s-1" \
           ...
           out/htapv2.2.emisso2.elevated.x3600y1800t12.$yyyy.integrate.nc4
end
