...
dset tmp/htapv2.2.emisso2.surface.x3600y1800t12.%y4.integrate.nc4
options template
undef 1.e15
...
# lats4d it
lats4d.sh -i htapv2.2.emisso2.surface.ddf -v -shave \
          -time 12z15dec$yyyym1 12z17jan$yyyyp1 \
          -o t14/htapv2.2.emisso2.surface.x3600y1800t14.$yyyy.integrate.nc4
...
ncatted -O -a units,sanl1,m,c,"kg m-2 s-1" \
           ...
           t14/htapv2.2.emisso2.surface.x3600y1800t14.$yyyy.integrate.nc4
