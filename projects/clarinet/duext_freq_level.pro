...
; Find frequency
  ...
  set_plot, 'ps'
  device, file='duext_freq_level.ps', /color, /helvetica, font_size=20, $
   xsize=16, ysize=8, xoff=.5, yoff=.5
  !p.font=0

  !p.multi=[0,3,1]

  plot, vert[2,*], alt, /nodata, xrange=[0,.1], xstyle=9, $
   yrange=[0,6], ystyle=9, ytitle='Altitude [km]', $
   xtitle='frequency', xminor=2, yticks=6, yminor=2, $
   title='West', xticks=5
  oplot, vert[0,*]/icnt, alt, thick=8
  oplot, vert2[0,*]/icnt, alt, thick=8, lin=2

  plot, vert[2,*], alt, /nodata, xrange=[0,.5], xstyle=9, $
   yrange=[0,6], ystyle=9, ytitle='Altitude [km]', $
   xtitle='frequency', xminor=2, yticks=6, yminor=2, $
   title='East', xticks=5
  oplot, vert[1,*]/icnt, alt, thick=8
  oplot, vert2[1,*]/icnt, alt, thick=8, lin=2

  plot, vert[2,*], alt, /nodata, xrange=[0,1], xstyle=9, $
   yrange=[0,6], ystyle=9, ytitle='Altitude [km]', $
   xtitle='frequency', xminor=2, yticks=6, yminor=2, $
   title='Africa', xticks=5
  oplot, vert[2,*]/icnt, alt, thick=8
  oplot, vert2[2,*]/icnt, alt, thick=8, lin=2
