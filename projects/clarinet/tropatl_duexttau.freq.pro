; Roosevelt Roads, Key West locations
  wantlon = [-65.648,-81.780]
  wantlat = [ 18.237,24,555]
...
; Pick off the "Julys"
  a = where(long(nymd)/10000L ge 2010 and long(nymd)/10000L le 2017 and $
...
; Make a plot
  set_plot, 'ps'
  device, file='tropatl_duexttau.freq.july.ps', /helvetica, font_size=12, $
