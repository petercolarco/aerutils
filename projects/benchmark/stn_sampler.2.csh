#!/bin/csh
  setenv PYTHONPATH ./:/misc/prc00/colarco/GAAS/Linux/lib/Python:/misc/prc00/colarco/GAAS/Linux/lib/Python/pyobs:/misc/prc00/colarco/GAAS/Linux/lib/Python/pyods#:/usr/lib/portage/pym:/share/dasilva/epd/gaas/epd-7.3-2-rh5-x86_64:
...
#  set varssfc = DUSMASS,SSSMASS,BCSMASS,OCSMASS,SO4SMASS,SO2SMASS
  ...
  set outfile = /misc/prc17/colarco/c180R_pI33p9s12_volc/c180R_pI33p9s12_volc.inst2d_hwl_x.aeronet.$YYYY.nc4

  ./stn_sampler.py -v -V $vars aeronet_locations_v3.txt c180R_pI33p9s12_volc.ddf \
                         ${YYYY}-01-01T00:00:00 ${YYYY}-01-01T23:00:00
