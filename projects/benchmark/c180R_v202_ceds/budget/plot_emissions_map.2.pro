...
;  carbon
  ...
  filename = '/misc/prc18/colarco/'+expid+'/tavg2d_aer_x/'+expid+'.tavg2d_aer_x.monthly.clim.ANN.nc4'
  draft = 0
  draft = 1
...
; Dust
  ...
  loadct, 55
  plotgrid, duem*convfac, levelarray, colorarray_, lon, lat, dx, dy, /map
  loadct, 0
  map_continents, thick=1.5
  map_set, limit=[-80,0,80,360], position=position[*,0], /noerase
  makekey, 0.025, .695, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=['5','10','20','50','100','150','200']
  loadct, 55
  makekey, 0.025, .695, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=[' ',' ',' ',' ',' ',' ',' ']
...
; Sea salt
  ...
  loadct, 57
  plotgrid, ssem*convfac, levelarray, colorarray_, lon, lat, dx, dy, /map
  loadct, 0
  map_continents, thick=1.5
  map_set, limit=[-80,0,80,360], position=position[*,1], /noerase
  makekey, 0.525, .695, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=['2','5','10','15','20','30','50']
  loadct, 57
  makekey, 0.525, .695, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=[' ',' ',' ',' ',' ',' ',' ']
...
; Particulate Organic Matter
  ...
  loadct, 53
  plotgrid, ocem*convfac, levelarray, colorarray_, lon, lat, dx, dy, /map
  loadct, 0
  map_continents, thick=1.5
  map_set, limit=[-80,0,80,360], position=position[*,2], /noerase
  makekey, 0.025, .365, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=['0.05','0.1','0.2','0.5','1','2','5']
  loadct, 53
  makekey, 0.025, .365, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=[' ',' ',' ',' ',' ',' ',' ']
  ...
  loadct, 0
  xyouts, .025, .645, /normal, 'White Organic Aerosol [g m!E-2!N yr!E-1!N]'
...
; Brown Carbon
  loadct, 0
  colorarray_ = reverse(colorarray)
  colorarray_ = reverse(findgen(7)*18)
  levelarray = [0.05,.1,.2,.5,1,2,5]
  map_set, limit=[-70,0,80,360], position=position[*,3], /noerase
  loadct, 66
  plotgrid, brcem*convfac, levelarray, colorarray_, lon, lat, dx, dy, /map
  loadct, 0
  map_continents, thick=1.5
  map_set, limit=[-80,0,80,360], position=position[*,2], /noerase
  ...
  makekey, 0.525, .365, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=[' ',' ',' ',' ',' ',' ',' ']
  totem = total(area*brcem)*convfac/1.e12
  totstr = string(totem,format='(f5.1)')+' Tg yr!E-1!N'
  loadct, 0
  xyouts, .525, .645, /normal, 'Brown Organic Aerosol [g m!E-2!N yr!E-1!N]'
...
; Sulfate - Primary + Gas
  ...
  loadct, 53
  plotgrid, suem*convfac, levelarray, colorarray_, lon, lat, dx, dy, /map
  loadct, 0
  map_continents, thick=1.5
  map_set, limit=[-80,0,80,360], position=position[*,4], /noerase
  makekey, 0.025, .035, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=['0.02','0.05','0.1','0.2','0.5','1','2']
  loadct, 53
  makekey, 0.025, .035, .45, .02, 0, -0.02, align=0, $
   color=colorarray_, label=[' ',' ',' ',' ',' ',' ',' ']
  ...
  totstr = string(totem,format='(f5.1)')+' Tg yr!E-1!N'
  loadct, 0
  xyouts, .025, .315, /normal, 'Sulfate+gas production [g m!E-2!N yr!E-1!N]'
...
; Sulfate - wet
  ...
  loadct, 57
  plotgrid, suwt*convfac, levelarray, colorarray_, lon, lat, dx, dy, /map
  loadct, 0
  map_continents, thick=1.5
  ...
  totstr = string(totem,format='(f5.1)')+' Tg yr!E-1!N'
  loadct, 0
  xyouts, .525, .315, /normal, 'Sulfate wet production [g m!E-2!N yr!E-1!N]'
