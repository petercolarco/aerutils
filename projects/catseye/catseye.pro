...
; Make a plot
  ...
  plot, indgen(10), /nodata, $
        ...
        yrange=[0,1.5], ytitle='AOT', ystyle=9, $
        position=[.15,.4,.9,.95]
  oplot, findgen(24), aot_, thick=6
  axis, yaxis=1, yrange=[0,3], ytitle='Precipitation [mm day!E-1!N]', /save
  oplot, findgen(24), pls_*86400, thick=6, color=84
  oplot, findgen(24), pcu_*86400, thick=6, color=84, lin=2

  plot, indgen(24), /nodata, /noerase, $
        xrange=[0,24], xtitle='Hour [UTC]', xstyle=9, $
        yrange=[0,600], ytitle='Number', ystyle=9, $
        position=[.15,.1,.9,.35], yminor=1
  oplot, findgen(24), n, thick=6
