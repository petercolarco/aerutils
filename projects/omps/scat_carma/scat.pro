...
; And construct the phase function
  ...
  set_plot, 'ps'
  device, file='p11.laramie.'+expid+'.ps', /color, /helvetica, font_size=14
  !p.font=0
  loadct, 39
  ...
  set_plot, 'ps'
  device, file='p11.laramie.'+expid+'.divide4pi.ps', /color, /helvetica, font_size=14
  !p.font=0
  loadct, 39
  fac = 1./(4.*!pi)
  plot, p11[*,0], /nodata, thick=3, $
  ...
  oplot, p11[*,33]*fac, thick=6, color=176 ; 20 km
  ...
  loadct, 0
  oplot, p11omps*fac, thick=8, color=160   ; omps
  xyouts, 140, 100, 'OMPS (solid)', color=160
  oplot, p11erns*fac, thick=8, color=160, lin=2   ; omps
  xyouts, 140, 60, 'Ernest (dashed)', color=160
