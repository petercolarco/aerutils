...
; Optics tables
  fileSU = '/share/colarco/fvInput/AeroCom/x/carma_optics_SU.v6.nbin=38.nc'
...
; Get a model profile
  expid = 'c48F_pI33p2_spinup_38'
  filename = '../../carma/profile/'+expid+'.tavg3d_carma_v.monthly.197906.nc4'
  wantlon = -105.
  wantlat = 41.
