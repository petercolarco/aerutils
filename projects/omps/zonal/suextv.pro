...
; Get a variable
  nc4readvar, filename, 'suextcoefvolc', su, lon=lon, lat=lat, lev=lev
  a = where(su gt 1e14)
  su[a] = !values.f_nan
; zonal mean
...
;   Now make a plot
    set_plot, 'ps'
    device, file='suextv.latmin='+strcompress(string(latmin),/rem)+'.ps', $
    ...
    contour, sup*1e6, x, zu, /cell, $
     ...
     title='Sulfate Extinction (volcanic sources) [Mm!E-1!N], ' $
