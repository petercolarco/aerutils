...
; Get a variable
  ...
  nc4readvar, filename, 'suextcoefvolc', su2, lon=lon, lat=lat, lev=lev
  su = su+su2
  a = where(su gt 1e14)
  su[a] = !values.f_nan
; zonal mean
...
; Colors
  ...
  levels = [5,10,20,50,100,200,500]/100.
...
;   Now make a plot
    set_plot, 'ps'
    device, file='suexttv.latmin='+strcompress(string(latmin),/rem)+'.ps', $
    ...
    contour, sup*1e6, x, zu, /cell, $
     ...
     title='Sulfate Extinction (all sources) [Mm!E-1!N], ' $
