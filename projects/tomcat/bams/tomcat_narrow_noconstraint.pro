...
; Get "TOMCAT2:
  get_sample, 'tomcat2.nadir', fnoff, nts, tom2, tom2hr, tom2hrn, tom2hrhst, tom2hrs, tom2hrmn, tom2hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon;, /trnd;, /taod

; Get "TOMCAT3"
  get_sample, 'tomcat3.nadir', fnoff, nts, tom3, tom3hr, tom3hrn, tom3hrhst, tom3hrs, tom3hrmn, tom3hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon

; Get "TOMCAT4"
  get_sample, 'tomcat4.nadir', fnoff, nts, tom4, tom4hr, tom4hrn, tom4hrhst, tom4hrs, tom4hrmn, tom4hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon
...
; Get "TOMCAT1"
  ...
  set_plot, 'ps'
  device, file='tomcat_narrow_noconstraint.site.pdf_pm25.range.'+filetag+'.ps', /color, /helvetica, font_size=12, $
...
; TOMCAT4
  ...
  openw, lun, 'tomcat_narrow_noconstraint.pdf_pm25.range.'+filetag+'.stats.txt', /get
  printf, lun, 'full'
