...
; Get "ISS3"
  get_sample, 'iss1.c1440_NR_0.5000.450km', filetag, tom3, tom3hr, tom3hrn, tom3hrhst, tom3hrs, tom3hrmn, tom3hrmx, $
                  /tcld, /taod

; Get "ISS4"
  get_sample, 'issall.c1440_NR_0.5000.450km', filetag, tom4, tom4hr, tom4hrn, tom4hrhst, tom4hrs, tom4hrmn, tom4hrmx, $
                  /tcld, /taod

  set_plot, 'ps'
  device, file='iss_cloud_aod01.site.pdf_pblh.range.'+filetag+'.norm.ps', /color, /helvetica, font_size=14, $
...
; Output some text files
  ...
  openw, lun, filetag+'.iss1.450km.txt', /get
  ...
  openw, lun, filetag+'.issall.450km.txt', /get
