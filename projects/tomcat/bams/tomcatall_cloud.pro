...
; Get "TOMCAT1"
  get_sample, 'tomcat1.nadir', fnoff, nts, tom1, tom1hr, tom1hrn, tom1hrhst, tom1hrs, tom1hrmn, tom1hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon, /tcld
...
; Get "TOMCAT4"
  ...
  set_plot, 'ps'
  device, file='tomcatall_cloud.site.pdf_pm25.range.'+filetag+'.ps', /color, /helvetica, font_size=12, $
...
; TOMCAT4
  ...
  openw, lun, 'tomcatall_cloud.pdf_pm25.range.'+filetag+'.stats.txt', /get
  printf, lun, 'full'
