...
; Get the full
  get_sample, 'full', filetag, fnoff, nts, full, fullhr, fullhrn, fullhrhst, fullhrs, fullhrmn, fullhrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon

; Get "TOMCAT1"
  get_sample, 'tomcat1.nadir', filetag, fnoff, nts, tom1, tom1hr, tom1hrn, tom1hrhst, tom1hrs, tom1hrmn, tom1hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon, /tcld, /taod
; Get "TOMCAT2:
  get_sample, 'tomcatall.nadir', filetag, fnoff, nts, tom2, tom2hr, tom2hrn, tom2hrhst, tom2hrs, tom2hrmn, tom2hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon, /tcld, /taod

; Get "TOMCAT3"
  get_sample, 'tomcat1.450km', filetag, fnoff, nts, tom3, tom3hr, tom3hrn, tom3hrhst, tom3hrs, tom3hrmn, tom3hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon, /tcld, /taod

; Get "TOMCAT4"
  get_sample, 'tomcatall.450km', filetag, fnoff, nts, tom4, tom4hr, tom4hrn, tom4hrhst, tom4hrs, tom4hrmn, tom4hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon, /tcld, /taod
