...
; Get "TOMCAT1"
  ...
  set_plot, 'ps'
  device, file='tomcat_wide_noconstraint.site.pdf_pm25.range.'+filetag+'.ps', /color, /helvetica, font_size=12, $
...
; TOMCAT4
  ...
  openw, lun, 'tomcat_wide_noconstraint.pdf_pm25.range.'+filetag+'.stats.txt', /get
  printf, lun, 'full'
