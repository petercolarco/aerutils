...
; Get "TOMCAT4"
  ...
  set_plot, 'ps'
  device, file='tomcatall1deg_cloud_aod01.site.pdf_pm25.range.'+filetag+'.ps', /color, /helvetica, font_size=12, $
...
; TOMCAT4
  ...
  openw, lun, 'tomcatall1deg_cloud_aod01.pdf_pm25.range.'+filetag+'.stats.txt', /get
  printf, lun, 'full'
