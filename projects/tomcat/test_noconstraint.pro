...
; Get "CATS" - equivalent to ISS1
  get_sample, 'iss1', fnoff, nts, cats, catshr, catshrn, catshrhst, catshrs, catshrmn, catshrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon;, /trnd, /taod, /tcld

; Get "TOMCAT1" - equivalent to ISS1 (450km)
...
; Get "TOMCAT2" - equivalent to DUALISS (450km)
  get_sample, 'dualissday.450km', fnoff, nts, tom2, tom2hr, tom2hrn, tom2hrhst, tom2hrs, tom2hrmn, tom2hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon, unionorbit='dualiss'
...
; Get CALIPSO
  ...
  set_plot, 'ps'
  device, file='test_noconstraint.site.pdf_pblh.range.'+filetag+'.ps', /color, /helvetica, font_size=12, $
...
; TOMCAT (2)
  ...
  openw, lun, 'test_noconstraint.site.pdf_pblh.range.'+filetag+'.stats.txt', /get
  printf, lun, 'full'
