...
; Get "TOMCAT1" - equivalent to ISS1 (450km) -- but only AOD > 0.2 
  get_sample, 'iss1day.450km', fnoff, nts, tom1, tom1hr, tom1hrn, tom1hrhst, tom1hrs, tom1hrmn, tom1hrmx, $
                  wantlat=wantlat, wantlon=wantlon, lat=lat, lon=lon, /daod, unionorbit='iss1'
...
; Get CALIPSO
  ...
  set_plot, 'ps'
  device, file='test_nocloud_dayaod.site.pdf_pblh.range.'+filetag+'.ps', /color, /helvetica, font_size=12, $
...
; TOMCAT (2)
  ...
  openw, lun, 'test_nocloud_dayaod.site.pdf_pblh.range.'+filetag+'.stats.txt', /get
  printf, lun, 'full'
