...
; Export
  openw, lun1, 'argos1.csv', /get
  openw, lun2, 'argos2.csv', /get
  openw, lun3, 'argos3.csv', /get
  openw, lun4, 'argos4.csv', /get
  openw, lun5, 'argos5.csv', /get
  openw, lun6, 'argos6.csv', /get
  openw, lun7, 'argos7.csv', /get
  openw, lun8, 'argos8.csv', /get
