...
;  Get the information write a grads template
   x = strpos(file[ifile],'2011m')+5
   mm = strmid(file[ifile],x,2)
   dd = strmid(file[ifile],x+2,2)
   fileout = strmid(file[ifile],0,x+4)+'.vl_rad.geos5_pressure.he5'

   tdef = 'tdef time 1 linear 12z'+dd+mon[fix(mm)-1]+'2011 24hr'
