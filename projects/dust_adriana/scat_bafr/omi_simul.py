...
#   Hack to take out region "b"
    ...
    omi.sample.DU001 = maximum(zero_arr,omi.sample.DU001-omi.sample.DU001bafr)
    omi.sample.DU002 = maximum(zero_arr,omi.sample.DU002-omi.sample.DU002bafr)
    omi.sample.DU003 = maximum(zero_arr,omi.sample.DU003-omi.sample.DU003bafr)
    omi.sample.DU004 = maximum(zero_arr,omi.sample.DU004-omi.sample.DU004bafr)
    omi.sample.DU005 = maximum(zero_arr,omi.sample.DU005-omi.sample.DU005bafr)
