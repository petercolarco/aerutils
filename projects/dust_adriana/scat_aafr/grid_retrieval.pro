...
; create the output filename
  ...
  u10m_   = make_array(nx,ny,val=1.e15)
  ...
  nu10m__    = make_array(nx,ny,val=0)
  ...
  if(a[0] ne -1) then ix[a] = 0
  for ipts = 0L, npts-1 do begin
   if(u10m[ipts] gt -1e14) then begin
    u10m__[ix[ipts],iy[ipts]] = u10m__[ix[ipts],iy[ipts]] + u10m[ipts]
    nu10m__[ix[ipts],iy[ipts]] = nu10m__[ix[ipts],iy[ipts]] + 1
   endif
  endfor
  a = where(nu10m__ gt 0)
  u10m_[a] = u10m__[a]/nu10m__[a]
  endif
...
; Write an intermediary file
  ...
  fileout = 'aot.'+rnum+'.nc'
   cdfid = ncdf_create(fileout, /clobber)
    ...
    idU10M = NCDF_VARDEF(cdfid,'u10m',[idLon,idLat], /float)
    ...
    idnU10m = NCDF_VARDEF(cdfid,'nu10m',[idLon,idLat], /float)
    ...
    ncdf_varput, cdfid, idU10M, u10m_
    ...
    ncdf_varput, cdfid, idnU10M, nu10m__
   ncdf_close, cdfid
