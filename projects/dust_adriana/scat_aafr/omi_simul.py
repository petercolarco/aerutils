...
from numpy import savez, load, tile,zeros,size,transpose,where,zeros_like,maximum
...
#   Parse and create filenames, open and read files
    ...
    model_file = '/discover/nobackup/pcolarco/GAAS/src/Components/scat/adriana/'\
                 + '2011_a2_apport_frland_9_aer_L2-OMAERUV_'+vtime+'Full.npz'
    model_filen = '2011_a2_apport_frland_9_aer_L2-OMAERUV_'+vtime+'Full.npz'
    omi = OMAERUV_L2(omi_file)
    omi.sampleLoadz(model_file)

#   Hack to take out region "b"
    zero_arr = zeros_like(omi.sample.DU001)
    omi.sample.DU001 = maximum(zero_arr,omi.sample.DU001-omi.sample.DU001aafr)
    omi.sample.DU002 = maximum(zero_arr,omi.sample.DU002-omi.sample.DU002aafr)
    omi.sample.DU003 = maximum(zero_arr,omi.sample.DU003-omi.sample.DU003aafr)
    omi.sample.DU004 = maximum(zero_arr,omi.sample.DU004-omi.sample.DU004aafr)
    omi.sample.DU005 = maximum(zero_arr,omi.sample.DU005-omi.sample.DU005aafr)
...
#    for i in range(70001,nobs,mobs):
    ...
    savez('./ai.'+model_filen,lon=lons[Igood_],\
    lat=lats[Igood_],\
    rad_OMI=omi.radiance[omi.sample.iGood],rad_VL=radiance_,\
    AI_VL=AI_,AI_OMI=omi.ai[omi.sample.iGood], refl_VL=refl_,\
    refl_OMI=omi.Reflectivity[omi.sample.iGood],SSA = SSA_, AOT = AOT_, \
    i388calc=i388calc_, trans=trans_, spher=spher_,residue=residue_,brdf=BRDF_)

    savez('./radiance.'+model_filen,lon=lons, lat=lats,\
    rad_OMI=omi.radiance[omi.sample.iGood],rad_VL=radiance_,\
    )
