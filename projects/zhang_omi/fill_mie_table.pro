...
;   If a particular wavelength is requested, then return only that
      ...
      for ibin = 0, nbin-1 do begin
       ...
       for im = 0, 5 do begin
        for imom = 0, nmom-1 do begin
         pmom_[irh,ibin,imom,im] = interpolate(pmom[*,irh,ibin,imom,im],il)
        endfor
       endfor
      endfor
     endfor
    ...
    str = {reff:reff, lambda: lambda, qext:qext, qsca:qsca, bext:bext, bsca:bsca, $
           g:g, bbck:bbck, rh:rh, rmass:rmass, refr:refr, refi:refi, pmom:pmom, nmom:nmom}
