  expid = 'C90c_HTcntl_clim.monthly'
...
;                            0.002,0.003,0.004,0.005,0.1,0.2]
  ...
  nc4readvar, filename, varn, ext, lon=lon, lat=lat, sum=sum, wantlev=wantlev[jj], lev=lev
...
; Now make a plot
  set_plot, 'ps'
  device, file='plot_ext_zonal_vertical_long.'+expid+'.'+varo+ $
