...
; Get the budget items
  filename = 'c180R_pI33p7.tavg2d_aer_x.monthly.201606.nc4'
  aertype_ = aertype
  ...
  filename = 'c180R_pI33p7.tavg2d_aer_x.monthly.201612.nc4'
  aertype_ = aertype
...
; Make a plot
  set_plot, 'ps'
  device, file='lifetime_size.c180.'+aertype+'.ps', /color, font_size=12
  !p.font=0
