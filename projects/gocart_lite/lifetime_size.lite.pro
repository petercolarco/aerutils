...
; sum over bins
  ...
  aer[*,*,*,1] = aer2
  aertype_ = aertype
  filename = 'c48R_pI33p7lite.tavg3d_aer_v.monthly.201606.nc4'
...
; Get the budget items
  ...
  filename = 'c48R_pI33p7lite.tavg2d_aer_x.monthly.201606.nc4'
  aertype_ = aertype
...
; Make a plot
  set_plot, 'ps'
  device, file='lifetime_size.lite.'+aertype+'.ps', /color, font_size=12
  !p.font=0
