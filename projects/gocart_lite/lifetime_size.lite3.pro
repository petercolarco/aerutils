...
; sum over bins
  aer1 = total(aer[*,*,*,0:2],4)
  aer2 = total(aer[*,*,*,3:4],4)
  aer  = fltarr(144,91,72,2)
  aer[*,*,*,0] = aer1
  aer[*,*,*,1] = aer2
  aertype_ = aertype
  filename = 'c48R_pI33p7lite3.tavg3d_aer_v.monthly.201606.nc4'
...
; Get the budget items
  ...
  filename = 'c48R_pI33p7lite3.tavg2d_aer_x.monthly.201606.nc4'
  aertype_ = aertype
...
; Losses are the integral of components
  ...
  lossbin_ = fltarr(2,2)
  lossbin_[*,1] = lossbin[0:1,1]
  lossbin_[0,0] = total(lossbin[0:2,0])
  lossbin_[1,0] = total(lossbin[3:4,0])
  lossbin = lossbin_
...
; Make a plot
  set_plot, 'ps'
  device, file='lifetime_size.lite3.'+aertype+'.ps', /color, font_size=12
  !p.font=0
  ...
  loadct, 39
  oplot, indgen(2)+1, lifebin[*,0], thick=6, color=color
  oplot, indgen(2)+1, lifebin[*,1], thick=6, color=color, lin=2
