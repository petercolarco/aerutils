...
;  for imm = 1, 12 do begin
  for imm = 1, 1 do begin
   for idd = 1, 31 do begin
    mm = strpad(imm,10)
    dd = strpad(idd,10)
    filen = file_search('/misc/prc19/colarco/OBS/A-CCP/SS450/LevelB/Y2006/M'$
...
; Make a plot
  ...
  make_plot, 'ss450.nadir.first_day.vfirst.ps', vfirst, vfirst, lono, lato, dx, dy, levels, colors
  make_plot, 'ss450.nadir.first_day.vsecnd.ps', vsecnd, vfirst, lono, lato, dx, dy, levels, colors
  make_plot, 'ss450.nadir.first_day.vthird.ps', vthird, vfirst, lono, lato, dx, dy, levels, colors
  make_plot, 'ss450.nadir.first_day.vforth.ps', vforth, vfirst, lono, lato, dx, dy, levels, colors

  levels = findgen(10)+1
  colors = 250-findgen(10)*25
  make_plot, 'ss450.nadir.first_day.diffr.2_1.ps', vsecnd-vfirst, vfirst, lono, lato, dx, dy, levels, colors
  make_plot, 'ss450.nadir.first_day.diffr.3_2.ps', vthird-vsecnd, vfirst, lono, lato, dx, dy, levels, colors
  make_plot, 'ss450.nadir.first_day.diffr.4_3.ps', vforth-vthird, vfirst, lono, lato, dx, dy, levels, colors
