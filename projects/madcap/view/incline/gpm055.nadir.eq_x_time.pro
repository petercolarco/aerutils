...
jump:
  ...
  set_plot, 'ps'
  device, file='gpm055.nadir.eq_x_time.ps', /color, /helvetica, font_size=14, $
   xsize=20, ysize=12
  !p.font=0
...
;  oplot, findgen(365)+1, sct, thick=4, color=84
  ...
  set_plot, 'ps'
  device, file='gpm055.nadir.eq_x_time.sza.ps', /color, /helvetica, font_size=14, $
   xsize=20, ysize=12
  !p.font=0
...
;  oplot, findgen(365)+1, sct, thick=4, color=84
  ...
  set_plot, 'ps'
  device, file='gpm055.nadir.eq_x_time.scat.ps', /color, /helvetica, font_size=14, $
   xsize=20, ysize=12
  !p.font=0
