...
; Make a plot
  set_plot, 'ps'
  device, file='ss450.300km.scat.max.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
  ...
  plot, indgen(10), /nodata, $
   ...
   title='Sun-Synchronous, Maximum Scattering Angle', $
...
; Make a plot
  set_plot, 'ps'
  device, file='ss450.300km.scat.ge165.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
  ...
  plot, indgen(10), /nodata, $
   ...
   xtickn = [string(xtickv[0:7],format='(i3)'),' '], $
   yticks=8, ytickn=[' ','-60','-40','-20','0','20','40','60',' '], $
   title='Sun-Synchronous, Occurrence of Maximum Scattering Angle > 165!Eo!N', $
   xtitle='Day of Year', ytitle='Latitude'
  levels = 80+findgen(10)*10
  dx = 1.
  dy = 1.
...
; Make a plot
  set_plot, 'ps'
  device, file='ss450.300km.scat.min.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
  ...
  plot, indgen(10), /nodata, $
   ...
   xtickn = [string(xtickv[0:7],format='(i3)'),' '], $
   yticks=8, ytickn=[' ','-60','-40','-20','0','20','40','60',' '], $
   title='Sun-Synchronous, Minimum Scattering Angle', $
   xtitle='Day of Year', ytitle='Latitude'
...
; Make a plot
  set_plot, 'ps'
  device, file='ss450.300km.scat.diff.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
  ...
  plot, indgen(10), /nodata, $
   ...
   xtickn = [string(xtickv[0:7],format='(i3)'),' '], $
   yticks=8, ytickn=[' ','-60','-40','-20','0','20','40','60',' '], $
   title='Sun-Synchronous, Range Scattering Angle', $
   xtitle='Day of Year', ytitle='Latitude'
...
; Print the fraction of time scat > 165
  ...
  openw, lun, 'ss450.300km.scat.max_freq.txt', /get
  a = where(scatmxo ge 130.)
  b = where(finite(scatmxo) eq 1)
  printf, lun, n_elements(a), n_elements(b)
