...
;    Reduce based on expected time of orbit (see inclined case)
      sza  = sza[0:5555]
      lon  = lon[0:5555]
      lat  = lat[0:5555]
      scat = scat[0:5555]
...
jump:
  ...
  set_plot, 'ps'
  device, file='ss450.nadir.lat_x_time.fday.ps', /color, /helvetica, font_size=14, $
   xsize=24, ysize=14
  !p.font=0
  loadct, 0
  ...
  set_plot, 'ps'
  device, file='ss450.nadir.lat_x_time.ps', /color, /helvetica, font_size=14, $
   xsize=24, ysize=14
  !p.font=0
...
; histogram
  set_plot, 'ps'
  device, file='ss450.nadir.lat_x_time_hist.ps', /color, /helvetica, font_size=14, $
   xsize=24, ysize=14
  !p.font=0
