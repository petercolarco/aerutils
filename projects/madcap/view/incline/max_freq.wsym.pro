...
; Plot it
  set_plot, 'ps'
  device, file='max_freq.wsym.ps', /color, /helvetica, font_size=12
  !p.font=0
  ...
  plots, thresh[0:8], freq[0:8,0,0], color=48, psym=sym(1)
  plots, thresh[0:8], freq[0:8,0,1], color=48, psym=sym(1)
  plots, thresh[0:8], freq[0:8,1,0], color=84, psym=sym(5)
  plots, thresh[0:8], freq[0:8,1,1], color=84, psym=sym(5)
  plots, thresh[0:8], freq[0:8,2,0], color=16, psym=sym(2)
  plots, thresh[0:8], freq[0:8,2,1], color=16, psym=sym(2)
  plots, thresh[0:8], freq[0:8,3,0], color=208, psym=sym(4)
  plots, thresh[0:8], freq[0:8,3,1], color=208, psym=sym(4)
  plots, thresh[0:8], freq[0:8,4,0], color=0, psym=sym(3)
  plots, thresh[0:8], freq[0:8,4,1], color=0, psym=sym(3)

  xyouts, 163, .87, /data, "45!Eo!N", color=48
  xyouts, 163, .82, /data, "50!Eo!N", color=84
  xyouts, 163, .77, /data, "55!Eo!N", color=16
  xyouts, 163, .72, /data, "60!Eo!N", color=208
  xyouts, 163, .67, /data, "65!Eo!N", color=0
  plots, 162, .88, psym=sym(1), color=48
  plots, 162, .83, psym=sym(5), color=84
  plots, 162, .78, psym=sym(2), color=16
  plots, 162, .73, psym=sym(4), color=208
  plots, 162, .68, psym=sym(3), color=0
