...
; Make a plot
  set_plot, 'ps'
  device, file='gpm.nadir.scat.max.2.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Make a plot
  set_plot, 'ps'
  device, file='gpm.nadir.scat.min.2.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Make a plot
  set_plot, 'ps'
  device, file='gpm.nadir.scat.diff.2.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
