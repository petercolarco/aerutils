...
; Make a plot
  set_plot, 'ps'
  device, file='gpm045.100km.scat.max.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Make a plot
  set_plot, 'ps'
  device, file='gpm045.100km.scat.ge165.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Make a plot
  set_plot, 'ps'
  device, file='gpm045.100km.scat.min.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Make a plot
  set_plot, 'ps'
  device, file='gpm045.100km.scat.diff.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Print the fraction of time scat > 165
  ...
  openw, lun, 'gpm045.100km.scat.max_freq.txt', /get
