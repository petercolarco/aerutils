...
; Make a plot
  set_plot, 'ps'
  device, file='gpm050.500km.scat.max.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Make a plot
  set_plot, 'ps'
  device, file='gpm050.500km.scat.min.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Make a plot
  set_plot, 'ps'
  device, file='gpm050.500km.scat.diff.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Print the fraction of time scat > 170
  ...
  print, 'Fraction >= 170: '+n_elements(a), n_elements(b)

  openw, lun, 'gpm050.500km.scat.max_freq.txt', /get
