...
jump:
  ...
  set_plot, 'ps'
  device, file='gpm055.nadir.lat_x_time.fday.ps', /color, /helvetica, font_size=14, $
   xsize=24, ysize=14
  !p.font=0
  loadct, 0
  ...
  set_plot, 'ps'
  device, file='gpm055.nadir.lat_x_time.ps', /color, /helvetica, font_size=14, $
   xsize=24, ysize=14
  !p.font=0
...
; histogram
  set_plot, 'ps'
  device, file='gpm055.nadir.lat_x_time_hist.ps', /color, /helvetica, font_size=14, $
   xsize=24, ysize=14
  !p.font=0
