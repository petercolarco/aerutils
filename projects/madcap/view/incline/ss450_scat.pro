...
; Areal statistics
  ...
  xyouts, 20, -65, /data, 'Areal Coverage Max Scattering Angle > 155!Eo!N = '+f, color=0
  a = where(scatmxo ge 165)
  b = where(finite(scatmxo) eq 1)
  f = string(n_elements(a)*100./n_elements(b),format='(f5.2)')+'%'
  xyouts, 20, -72, /data, 'Areal Coverage Max Scattering Angle > 165!Eo!N = '+f, color=0
  device, /close
