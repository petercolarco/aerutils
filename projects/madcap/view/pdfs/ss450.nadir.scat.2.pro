...
; Make a plot
  set_plot, 'ps'
  device, file='ss450.nadir.scat.max.2.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
; Make a plot
  set_plot, 'ps'
  device, file='ss450.nadir.scat.min.2.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
  ...
  plot, indgen(10), /nodata, $
   xrange=[0,365], yrange=[-90,90], $
   xstyle=1, ystyle=1, position=[.05,.15,.95,.95], $
   title='Sunsynchronous, Minimum Scattering Angle', $
   xtitle='Day of Year', ytitle='Latitude', yticks=6
...
; Make a plot
  set_plot, 'ps'
  device, file='ss450.nadir.scat.diff.2.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
