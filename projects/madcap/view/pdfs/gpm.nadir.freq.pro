...
; parts
  set_plot, 'ps'
  device, file='gpm.nadir.freq.2006'+mm[im]+'.ps', /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=24, ysize=16, /color
  !p.font=0
  map_set, title='Precessing Platform, 2006'+mm[im], position=[.02,.1,.98,.92]
  loadct, 0
  map_continents, fill_continents=1, color=200
  plotgrid, num, [1], [140], lon_, lat_, dx, dy, /map
  makekey, .2,.05,.1,.035,0,-0.025,align=0,colors=[140],labels='Any'
  loadct, 39
