...
; Make a plot
  set_plot, 'ps'
  device, file='gpm.nadir.scat_ltr.max.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
...
;  levels = findgen(10)*10.+30.
  ...
  set_plot, 'ps'
  device, file='gpm.nadir.scat_ltr.min.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
  loadct, 0
  plot, indgen(10), /nodata, $
...
;  levels = findgen(10)*10.+30.
  ...
  set_plot, 'ps'
  device, file='gpm.nadir.scat_ltr.max155.ps', /color, /helvetica, font_size=12, $
   xsize=30, ysize=18
  !p.font=0
  loadct, 0
  plot, indgen(10), /nodata, $
