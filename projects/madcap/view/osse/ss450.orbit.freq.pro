...
; Get the filenames to probe...
  filen = file_search('/misc/prc19/colarco/OBS/A-CCP/SS450/LevelB','*200601*nc4')
...
; parts
  set_plot, 'ps'
  device, file='ss450.orbit.freq.ps', /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=24, ysize=16, /color
  !p.font=0
  map_set, title='Sunsynchronous Platform, January 2006', $
   position=[.05,.15,.95,.9]
  loadct, 0
