...
; parts
  set_plot, 'ps'
  device, file='sunsynch.orbit.view.ps', /helvetica, font_size=14, $
  ...
  device, file='sunsynch.orbit2.view.ps', /helvetica, font_size=14, $
  ...
  device, file='sunsynch.sza.view.ps', /helvetica, font_size=14, $
  ...
  device, file='sunsynch.vza.view.ps', /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=16, ysize=16, /color
  loadct, 39
  !p.font=0
  plot, indgen(100), /nodata, $
  ...
  device, file='sunsynch.scat.view.ps', /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=16, ysize=16, /color
  loadct, 39
  !p.font=0
  plot, indgen(100), /nodata, $
