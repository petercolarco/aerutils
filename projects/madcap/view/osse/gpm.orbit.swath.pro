...
; parts
  set_plot, 'ps'
  device, file='gpm.orbit.swath.ps', /helvetica, font_size=14, $
  ...
  device, file='gpm.orbit2.swath.ps', /helvetica, font_size=14, $
  ...
  device, file='gpm.sza.swath.ps', /helvetica, font_size=14, $
  ...
  device, file='gpm.vza.swath.ps', /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=16, ysize=16, /color
  loadct, 39
  !p.font=0
  plot, indgen(100), /nodata, $
  ...
  device, file='gpm.scat.swath.ps', /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=16, ysize=16, /color
  loadct, 39
  !p.font=0
  plot, indgen(100), /nodata, $
