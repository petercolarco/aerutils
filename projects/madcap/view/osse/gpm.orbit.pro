...
; parts
  set_plot, 'ps'
  device, file='gpm.orbit.ps', /helvetica, font_size=14, $
  ...
  device, file='gpm.orbit2.ps', /helvetica, font_size=14, $
  ...
  device, file='gpm.sza.ps', /helvetica, font_size=14, $
  ...
  device, file='gpm.vza.ps', /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=16, ysize=16, /color
  !p.font=0
  plot, indgen(100), /nodata, $
  ...
  device, file='gpm.scat.ps', /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=16, ysize=16, /color
  !p.font=0
  plot, indgen(100), /nodata, $
