...
# CALIPSO model at daylight for cloud fraction < 80%
  lats4d.sh -v -i c1440_NR.hr.ddf -j c1440_NR.hr_met.ddf \
            ...
            -func "maskout(maskout(tle_mask(@.1,calipso.tle),if(cosz(tle_mask(@.1,calipso.tle),h)>0,1,-1)),-(cldtot.2-0.8))" 
...
# CALIPSO model at daylight for cloud fraction < 80%
  lats4d.sh -v -i c1440_NR.hr.ddf -j c1440_NR.hr_met.ddf \
            ...
            -func "maskout(maskout(tle_mask(@.1,calipso.tle,50,50),if(cosz(tle_mask(@.1,calipso.tle,50,50),h)>0,1,-1)),-(cldtot.2-0.8))" 
