...
; Get the full model
  ddf = 'c1440_NR.full.day.cloud.monthly.duexttau.ddf'
  print, ddf
  ga_times, ddf, nymd, nhms, template=template
  filename=strtemplate(template,nymd,nhms)
  nc4readvar, filename, ['duexttau'], aot
...
; Get the global mean aod
  ...
  for j = 0, ntle-1 do begin
   for i = 0, nswa-1 do begin
    ddf = 'c1440_NR.'+tle[j]+'.'+swath[i]+'.day.cloud.monthly.duexttau.ddf'
    print, ddf
    ga_times, ddf, nymd, nhms, template=template
    filename=strtemplate(template,nymd,nhms)
    nc4readvar, filename, ['duexttau'], aot_
...
; Make some plots
  set_plot, 'ps'
  device, file='duexttau_timeseries_swath.dual.day.cloud.part.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
...
; Difference in global mean
  device, file='duexttau_timeseries_swath.dual.day.cloud.part.global_diff.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
  ...
  plot, indgen(13), /nodata, $
   xrange=[0,13], xstyle=1, xticks=13, $
   xtickn=[' ','J','F','M','A','M','J','J','A','S','O','N','D',' '], $
   yrange=[-0.02,0.02], yticks=8, ystyle=1
...
; Difference in global mean -- alternative
  device, file='duexttau_timeseries_swath.dual.day.cloud.part.global_diff2.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
