...
; Get the full model
  ddf = 'c1440_NR.full.day.monthly.ddf'
  print, ddf
  ga_times, ddf, nymd, nhms, template=template
  filename=strtemplate(template,nymd,nhms)
  nc4readvar, filename, ['pblh'], aot
...
; Get the global mean aod
  ...
  for j = 0, ntle-1 do begin
   for i = 0, nswa-1 do begin
    ddf = 'c1440_NR.'+tle[j]+'.'+swath[i]+'.day.monthly.ddf'
    print, ddf
    ga_times, ddf, nymd, nhms, template=template
    filename=strtemplate(template,nymd,nhms)
    nc4readvar, filename, ['pblh'], aot_
...
; Make some plots
  set_plot, 'ps'
  device, file='pblh_timeseries_swath.dual.day.part.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
  ...
  plot, indgen(13), /nodata, $
   ...
   yrange=[400,1200.], yticks=8, ystyle=1
...
; Difference in global mean
  device, file='pblh_timeseries_swath.dual.day.part.global_diff.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
...
; Difference in global mean -- alternative
  device, file='pblh_timeseries_swath.dual.day.part.global_diff2.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
