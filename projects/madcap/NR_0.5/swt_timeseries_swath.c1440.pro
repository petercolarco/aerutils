...
; Get the global mean aod
  ...
  for j = 0, ntle-1 do begin
   for i = 0, nswa-1 do begin
    ddf = 'c1440_NR.'+tle[j]+'.nodrag.'+swath[i]+'.swt.day.monthly.ddf'
    print, ddf
    ga_times, ddf, nymd, nhms, template=template
    filename=strtemplate(template,nymd,nhms)
...
; Make some plots
  set_plot, 'ps'
  device, file='swt_timeseries_swath.day.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
...
; Difference in global mean
  device, file='swt_timeseries_swath.day.global_diff.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
...
; Difference in global mean -- alternative
  device, file='swt_timeseries_swath.day.global_diff2.c1440.ps', /helvetica, font_size=12, /color
  !p.font=0
