...
cat> $file <<EOF
dset /misc/prc19/colarco/c1440_NR/day/$tle/c1440_NR.$tle.${swath_}.day.cloud.daily.%y4%m2%d2.$ext
options template
...
cat> full.ddf <<EOF
dset /misc/prc19/colarco/c1440_NR/day/full/c1440_NR.full.day.cloud.daily.%y4%m2%d2.nc
options template
tdef time 365 linear 12z1jan2006 24hr
EOF
