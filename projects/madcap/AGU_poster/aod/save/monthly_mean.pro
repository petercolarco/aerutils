; Monthly mean AOD plot for May
  ...
  ddf1 = 'c1440_NR.sunsynch_500km.nodrag.1000km.ddf'
...
print, nt0, nt1
  ...
  set_plot, 'ps'
  device, file='monthly_mean.aod.'+mon[it]+'.ps', /color, /helvetica, font_size=12, $
  ...
  set_plot, 'ps'
  device, file='monthly_mean.num.'+mon[it]+'.ps', /color, /helvetica, font_size=12, $
   xoff=.5, yoff=.5, xsize=18, ysize=28
  !p.font=0
