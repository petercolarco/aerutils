...
; save the monthly mean values
  ...
  get_stat, 'c1440_NR.gpm.nodrag.nadir.ddf', res_gpm_0, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.gpm.nodrag.100km.ddf', res_gpm_1, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.gpm.nodrag.300km.ddf', res_gpm_2, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.gpm.nodrag.500km.ddf', res_gpm_3, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.gpm.nodrag.1000km.ddf', res_gpm_4, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.sunsynch_500km.nodrag.nadir.ddf', res_sun_0, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.sunsynch_500km.nodrag.100km.ddf', res_sun_1, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.sunsynch_500km.nodrag.300km.ddf', res_sun_2, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.sunsynch_500km.nodrag.500km.ddf', res_sun_3, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.sunsynch_500km.nodrag.1000km.ddf', res_sun_4, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.dual.nadir.ddf', res_dual_0, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.dual.100km.ddf', res_dual_1, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.dual.300km.ddf', res_dual_2, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.dual.500km.ddf', res_dual_3, nt0=nt0, nt1=nt1, wantlat=[-65,65]
  get_stat, 'c1440_NR.dual.1000km.ddf', res_dual_4, nt0=nt0, nt1=nt1, wantlat=[-65,65]
...
; plot
  set_plot, 'ps'
  device, file='pdf.aod.'+mon[it]+'.65.ps', /color, /helvetica, font_size=14, $
...
; Plot the time series median and mean values
  set_plot, 'ps'
  device, file='pdf.aod_month.65.median.ps', /color, /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=24, ysize=14
  !p.font=0
  loadct, 0
  plot, indgen(10), /nodata, $
   xrange=[0,13], yrange=[0,.1], xstyle=9, ystyle=9, $
  ...
  set_plot, 'ps'
  device, file='pdf.aod_month.65.mean.ps', /color, /helvetica, font_size=14, $
   xoff=.5, yoff=.5, xsize=24, ysize=14
  !p.font=0
  loadct, 0
  plot, indgen(10), /nodata, $
   xrange=[0,13], yrange=[0.05,.2], xstyle=9, ystyle=9, $
   xticks=13, xtickname=make_array(14,val=' ')
  loadct,56
