...
file2 = '/misc/prc19/colarco/c1440_NR_0.5000/day/gpm.nodrag/c1440_NR.gpm.nodrag.500km.day.cloud.daily.20060605.nc'
file3 = '/misc/prc19/colarco/c1440_NR_0.5000/day/sunsynch_500km.nodrag/c1440_NR.sunsynch_500km.nodrag.500km.day.cloud.daily.20060605.nc'
file4 = '/misc/prc19/colarco/c1440_NR_0.5000/day/dual/c1440_NR.dual.500km.day.cloud.daily.20060605.nc4'
file5 = '/misc/prc19/colarco/c1440_NR_0.5000/day/full/c1440_NR.full.day.cloud.daily.20060605.nc'
...
ax2.set_title('Inclined, Precessing', fontsize=20)
...
ax3.set_title('Polar, Sun-Synchronous', fontsize=20)
...
ax4.set_title('Constellation', fontsize=20)
...
ax5.set_title('Full', fontsize=20)
...
# SAVE AND CLEAR
plt.savefig('plots/aod_map_strip2.png', dpi=200)
#plt.show()
plt.cla()
