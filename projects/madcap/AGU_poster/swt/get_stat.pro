  ...
  nc4readvar, filename, ['swtnt'], aot, wantlat=wantlat, wantlon=wantlon, lon=lon, lat=lat
  nc4readvar, filename, ['swtntcln'], aot_, wantlat=wantlat, wantlon=wantlon, lon=lon, lat=lat
  a = where(aot lt 1.e12)
  b = where(aot gt 1.e12)
  aot[b] = !values.f_nan
  aot_[b] = !values.f_nan
  aot = aot-aot_
; Make a mean
