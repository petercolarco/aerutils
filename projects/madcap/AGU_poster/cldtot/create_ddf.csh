...
cat> $file <<EOF
dset /misc/prc19/colarco/c1440_NR_0.5000/day/$tle/c1440_NR.$tle.${swath_}.swt.day.daily.%y4%m2%d2.$ext
options template
...
cat> full.ddf <<EOF
dset /misc/prc19/colarco/c1440_NR_0.5000/day/full/c1440_NR.full.swt.day.daily.%y4%m2%d2.nc
options template
tdef time 365 linear 12z1jan2006 24hr
EOF
