...
# Full model AOD
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.full.swtnet.monthly.2016${mm}.${hh}z

# Full model at daylight
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.full_day.swtnet.monthly.2016${mm}.${hh}z \
...
# Full model at daylight for cloud fraction < 80%
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -j c180R_pI33p7.3hr_surf.ddf \
            -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.full_day_cloud.swtnet.monthly.2016${mm}.${hh}z \
            -func "maskout(maskout(@.1,swtnet-0.0001),-(cldtt.2-0.8))" 
 

# CALIPSO model AOD
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.calipso.swtnet.monthly.2016${mm}.${hh}z \
            -func "tle_mask(@.1,calipso.tle)"

# CALIPSO model at daylight
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.calipso_day.swtnet.monthly.2016${mm}.${hh}z \
            -func "maskout(tle_mask(@.1,calipso.tle),tle_mask(swtnet,calipso.tle)-0.0001)" 

# CALIPSO model at daylight for cloud fraction < 80%
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -j c180R_pI33p7.3hr_surf.ddf \
            -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.calipso_day_cloud.swtnet.monthly.2016${mm}.${hh}z \
...
# CALIPSO model AOD
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.calipso_swath.swtnet.monthly.2016${mm}.${hh}z \
            -func "tle_mask(@.1,calipso.tle,50,50)"

# CALIPSO model at daylight
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.calipso_swath_day.swtnet.monthly.2016${mm}.${hh}z \
            -func "maskout(tle_mask(@.1,calipso.tle,50,50),tle_mask(swtnet,calipso.tle,50,50)-0.0001)" 

# CALIPSO model at daylight for cloud fraction < 80%
  lats4d.sh -v -i c180R_pI33p7.3hr_surf.ddf -j c180R_pI33p7.3hr_surf.ddf \
            -ftype xdf -vars swtnet swtnetna swtnetc swtnetcna -mean \
            -time ${hh}z1$mon[$mm]2016 ${hh}z$ndy[$mm]$mon[$mm]2016 8  -o ${fileout}.calipso_swath_day_cloud.swtnet.monthly.2016${mm}.${hh}z \
