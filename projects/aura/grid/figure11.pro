; Colarco
; February 2016
; Four Panel Plot to Fraction of AOD as Dust Retrieved

; Setup the plot
  plotfile = 'figure11.ps'
  set_plot, 'ps'
...
; Panel 1: SSA Plots (June)
  ...
  xyouts, .025, .955, /normal, charsize=.75, $
   'a) OMAERUV Fraction of AOD Retrievals Returned as Dust (June 2007)'
  dx = lon[1]-lon[0]
  dy = lat[1]-lat[0]
...
; Panel 2: SSA Plots (July)
  ...
  xyouts, .525, .955, /normal, charsize=.75, $
   'b) OMAERUV Fraction of AOD Retrievals Returned as Dust (July 2007)'
  dx = lon[1]-lon[0]
  dy = lat[1]-lat[0]
...
; Panel 3: SSA Plots (August)
  ...
  xyouts, .025, .455, /normal, charsize=.75, $
   'c) OMAERUV Fraction of AOD Retrievals Returned as Dust (August 2007)'
  dx = lon[1]-lon[0]
  dy = lat[1]-lat[0]
...
; Panel 4: SSA Plots (September)
  ...
  xyouts, .525, .455, /normal, charsize=.75, $
   'd) OMAERUV Fraction of AOD Retrievals Returned as Dust (September 2007)'
  dx = lon[1]-lon[0]
  dy = lat[1]-lat[0]
