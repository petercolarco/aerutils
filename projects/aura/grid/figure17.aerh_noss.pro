...
; Setup the plot
  plotfile = 'figure17.aerh_noss.ps'
  set_plot, 'ps'
...
; Panel 1: AOD Plots (July)
  filetemplate = 'monthly.sampled_ext.aerh_noss.ctl'
  ...
  filetemplate = 'monthly.pgeo.aerh_noss.ctl'
...
; AOD is OMI - MERRAero
  ...
  loadct, 0
  plots, [-40,-30,-30,-40,-40], [12,12,16,16,12], thick=6, lin=0
...
; a box, and compare model SSA to OMAERUV SSA for dust retrievals
  files  = file_search('/misc/prc14/colarco/aura/dR_MERRA-AA-r2-v1621f_Full/', $
                       'OMI-Aura_L2-OMAERUV_2007m07*vl_rad.geos5_pressure.ext_noss.he5')
