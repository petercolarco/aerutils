...
; Get the OMI and model AI
  filename = '/misc/prc14/colarco/aura/dR_MERRA-AA-r2-v1621f/v7_5/dR_MERRA-AA-r2-v1621.ai.'+datewant+'.nc4'
...
; Get the OMI and model AAOD
  filename = '/misc/prc14/colarco/aura/dR_MERRA-AA-r2-v1621f/v7_5/dR_MERRA-AA-r2-v1621.aot_omi388.200708.nc4'
  nc4readvar, filename, 'aaot', aaot_omi, lon=lon, lat=lat
  filename = '/misc/prc14/colarco/aura/dR_MERRA-AA-r2-v1621f/v7_5/dR_MERRA-AA-r2-v1621.aot388.200708.nc4'
...
; Now make a plot
  set_plot, 'ps'
  device, file='data_comparison.'+datewant+'.ps', /color, $
