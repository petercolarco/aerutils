...
; The sensitivity test was valid for fltarr(45,71,3,9) nodes
  ...
  plot, prs[a], (i388c_omi[a]-i388c[a])/i388c[a], thick=8, $
        xtitle='pressure [hPa]', $
        ytitle='Fractional !9D!3I!D388calc!N (OMAERUV-MERRAero)'

  plot, prs[a], spher_omi[a]-spher[a], thick=8, $
        xtitle='pressure [hPa]', $
        ytitle='!9D!3spher!N (OMAERUV-MERRAero)'
  plot, prs[a], (spher_omi[a]-spher[a])/spher[a], thick=8, $
        xtitle='pressure [hPa]', $
        ytitle='Fractional !9D!3spher!N (OMAERUV-MERRAero)'

  plot, prs[a], trans_omi[a]-trans[a], thick=8, $
        xtitle='pressure [hPa]', $
        ytitle='!9D!3trans!N (OMAERUV-MERRAero)'
  plot, prs[a], (trans_omi[a]-trans[a])/trans[a], thick=8, $
        xtitle='pressure [hPa]', $
        ytitle='Fractional !9D!3trans!N (OMAERUV-MERRAero)'
  ...
  plot, prs[a], (ler_omi_-ler_)/ler_, thick=8, $
        xtitle='pressure [hPa]', $
        ytitle='Fractional !9D!3LER!N (OMAERUV-MERRAero)'
