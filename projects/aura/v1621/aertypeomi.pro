...
; Files
  ...
  ofiles = ['2007m0605-o15360_julian156_PGEOS_OCT232015.nc', '2007m0605-o15361_julian156_PGEOS_OCT232015.nc', $
            '2007m0605-o15362_julian156_PGEOS_OCT232015.nc', '2007m0605-o15363_julian156_PGEOS_OCT232015.nc', $
            '2007m0605-o15364_julian156_PGEOS_OCT232015.nc', '2007m0605-o15365_julian156_PGEOS_OCT232015.nc', $
            '2007m0605-o15366_julian156_PGEOS_OCT232015.nc', '2007m0605-o15367_julian156_PGEOS_OCT232015.nc', $
            '2007m0605-o15368_julian156_PGEOS_OCT232015.nc', '2007m0605-o15369_julian156_PGEOS_OCT232015.nc', $
            '2007m0605-o15370_julian156_PGEOS_OCT232015.nc', '2007m0605-o15371_julian156_PGEOS_OCT232015.nc', $
            '2007m0605-o15372_julian156_PGEOS_OCT232015.nc', '2007m0605-o15373_julian156_PGEOS_OCT232015.nc' ]
...
;   Get the OMI returned values and map
    ...
    id    = ncdf_varid(cdfid,'AERO_MODEL')
    ncdf_varget, cdfid, id, res_inp
    ncdf_close, cdfid
    a = where(aod_inp lt 0)
    res_inp[a] = aod_inp[a]
...
; Now set up a plot
  set_plot, 'ps'
  device, file='aertypeomi.ps', xsize=16, ysize=12, xoff=.5, yoff=.5, /color, /helvetica
  !p.font=0
  loadct, 0
  p0 = 0
  p1 = 0
...
; plot positive RES
  loadct, 39
  a = where(res gt -1 and res lt 250)
  res = res[a]
  lon = lon[a]
  lat = lat[a]
  nxy = n_elements(a)
  a = where(res eq 1)  ; nonabsorbing
  res[a] = 176
  a = where(res eq 2)  ; dust
  res[a] = 208
  a = where(res eq 3)  ; smoke
  res[a] = 254
