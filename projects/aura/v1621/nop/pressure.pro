...
; Files
  files = ['OMI-Aura_L2-OMAERUV_2007m0605t0056-o15360_v003-2015m0918t202921.vl_rad.he5', $
...
; Now set up a plot
  set_plot, 'ps'
  device, file='pressure.ps', xsize=16, ysize=12, xoff=.5, yoff=.5, /color, /helvetica
  !p.font=0
  loadct, 39
  p0 = 0
  p1 = 0
