...
; Get the OMI and model AI
  filename = '/misc/prc14/colarco/aura/dR_MERRA-AA-r2-v1621f/v5_5/dR_MERRA-AA-r2-v1621.ai.'+datewant+'.nc4'
...
; Get the OMI and model AAOD
  filename = '/misc/prc14/colarco/aura/dR_MERRA-AA-r2-v1621f/v5_5/dR_MERRA-AA-r2-v1621.aot_omi388.'+datewant+'.nc4'
  nc4readvar, filename, 'aaot', aaot_omi, lon=lon, lat=lat
  filename = '/misc/prc14/colarco/aura/dR_MERRA-AA-r2-v1621f/v5_5/dR_MERRA-AA-r2-v1621.aot388.'+datewant+'.nc4'
