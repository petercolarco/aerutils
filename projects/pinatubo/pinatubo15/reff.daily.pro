...
; Get the file
  ...
  nc4readvar, filedir+filename, 'suextcoef', suext, /template
...
;    Threshold on a minimum value of SUEXT
     if(suext[ix,iy,iz] gt 0.00001) then begin
