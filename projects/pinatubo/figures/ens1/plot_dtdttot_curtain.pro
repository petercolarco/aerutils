...
; Get the ozone VMR
  ...
  nc4readvar, filename0, 'dtdttot', t_0, lon=lon, lat=lat, lev=lev
  filename1 = filedir+expid1+'/geosgcm_tend/'+expid1+'.geosgcm_tend.monthly.'+datewant+'.nc4'
  nc4readvar, filename1, 'dtdttot', t_1, lon=lon, lat=lat, lev=lev
...
; Make a plot of the difference
  set_plot, 'ps'
  device, file='plot_dtdttot_curtain.'+datewant+'.ps', $
