...
; all qbo out of phase, broad versus narrow injection
  file  = 'plot_zonal_avhrr_panel.qbo_out_of_phase.ps'
  expid = ['c48F_H43_pinatubo15', 'c48F_H43_pinatubo15+sulfate', $
           'c48Fc_H43_pinatubo15v2', 'c48Fc_H43_pinatubo15v2+sulfate', $
           'c48Fc_H43_pin15+sulf+cerro']

; first two QBO out of phase, broad injection, last three QBO in
; phase and narrow
  file  = 'plot_zonal_avhrr_panel.qbo_in_phase.ps'
  expid = ['c48Fc_H43_pin15v2+sulf', 'c48Fc_H43_pin15v2+sulf+cerro', $
           'c48Fc_H43_pin15v2+sulf+cerro', 'c48Fc_H43_pin15v2+sulf+cerro_2', $
...
; Now cycle on model experiments to compare and plot
  ...
  for iexpid = 0, 4 do begin
   ...
   filename = filename[a]
   nc4readvar, filename, ['suexttau','suexttauvolc'], su, lon=lon, lat=lat, /sum
   nt = n_elements(a)
