...
; Experiments
  expid = ['c48Fc_H43_pin15v2+sulf+cerro.tavg2d_carma_x.daily.ddf', $    ; C+sulf, narrow, QBO in phase
           'c48Fc_H43_pin15v2+sulf+cerro_2.tavg2d_carma_x.daily.ddf', $
           'c48Fc_H43_pin15v2+sulf+cerro_3.tavg2d_carma_x.daily.ddf', $
           'c48Fc_H43_pinatubo15.tavg2d_carma_x.daily.ddf', $           ; C, broad             QBO out of phase
           'c48Fc_H43_pinatubo15+sulfate.tavg2d_carma_x.daily.ddf', $   ; C+sulf, broad
           'c48Fc_H43_pinatubo15v2.tavg2d_carma_x.daily.ddf', $         ; C, narrow
           'c48Fc_H43_pinatubo15v2+sulfate.tavg2d_carma_x.daily.ddf', $ ; C+sulf, narrow
           'c180Fc_H43_pin15+sulf+cerro.tavg2d_carma_x.daily.ddf', $    ; c180, C+sulf, narrow
           'c180Fc_H43_pin15v2+sulf+cerro.tavg2d_carma_x.daily.ddf']    ; c180, C+sulf, narrow (QBO in phase)
  ...
  set_plot, 'ps'
  device, file='plot_so4volc.qbo.ps', /helvetica, font_size=14, /color
  !p.font=0
