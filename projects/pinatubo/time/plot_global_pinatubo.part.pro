...
; Get the model fields
  expid = ['c48Fc_H43_pinatubo15+sulfate', $
           'c48F_H43_pinatubo15+sulfate']
  expid = ['c48Fc_H43_pin15v2+sulf+cerro', $
...
;    fake double resolution of suext and suang
  ...
  set_plot, 'ps'
  device, file='plot_global_pinatubo.part.ps', $
  ...
  loadct, 39
  oplot, x, suext[*,0,1], thick=8, color=84         ; carma
  oplot, x, suext[*,1,0], thick=8, color=208        ; gocart
  loadct, 0
  ...
  loadct, 39
  oplot, x, suang[*,0,1], thick=8, color=84         ; carma
  oplot, x, suang[*,1,0], thick=8, color=208        ; gocart
  ...
  loadct, 39
  oplot, x, sucm[*,0,1], thick=8, color=84         ; carma
  oplot, x, sucm[*,1,0], thick=8, color=208        ; gocart
  ...
  oplot, x, sume[*,0,1], thick=8, color=84         ; carma
  oplot, x, sume[*,1,0], thick=8, color=208        ; gocart
