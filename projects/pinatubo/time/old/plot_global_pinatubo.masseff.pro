...
; CARMA Pinatubo Only
  ...
  nc4readvar, filename, 'suexttau', suexttauv_pinc, lon=lon, lat=lat
...
; Global total (Tg SO4)
  ...
  suext_pin45 = aave(suexttau_pin45/so4cmass_pin45,area)/1000
  suext_pin   = aave(suexttauv_pin/so4cmassv_pin,area)/1000
  suext_pinc  = aave(suexttauv_pinc/so4cmassv_pinc,area)/1000

  set_plot, 'ps'
  device, file='plot_global_pinatubo.masseff.compare.ps', $
