...
exppath      = './'
carnexpl     = 'c90Fc_I10pa3_expl'
krotkove     = 'c90Fc_I10pa3_sulf'
coll         = 'geosgcm_prog'

f1  = exppath+'/'+carnexpl+'.'+coll+'.monthly.199108.nc4'
f2  = exppath+'/'+krotkove+'.'+coll+'.monthly.199108.nc4'
fid1 = ncdf_open(f1)
fid2 = ncdf_open(f2)
...
;;;;; PLOT MMC CHANGES
  set_plot, 'ps'
  device, file = 'alternate-explosive.ps', /helvetica, font_size=16, /color, $
...
; solid/dashed contour lines are for no_u_zonal (i.e.,f1 run)
; color is difference f2 - f1
  ...
  contour, diff_u_zonal, lat, lev, /nodata, color=iblack, /noerase, $
           ...
           title='U-Wind (Alternative Pinatubo - Explosive)'
...
; color is difference f2 - f1
  ...
  contour, mmc_diff*1e-10, lat, lev, /nodata, color=iblack, /noerase, $
           ...
           ystyle=1,xstyle=1, yticks=7, xticks=6, charsize=.6, $
           ytitle='Pressure [hPa]', xtitle='Latitude', $
           title='Mean Meridional Circulation (Alternative Pinatubo - Explosive)'
