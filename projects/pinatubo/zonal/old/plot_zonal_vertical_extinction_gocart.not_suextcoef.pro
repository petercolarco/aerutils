...
; Plot the zonal mixing ratio of sulfate over time
  ...
  nt = n_elements(nymd)
  nc4readvar, filename, ['duextcoef','ssextcoef','ocextcoef','bcextcoef'], su, lon=lon, lat=lat, /sum
...
; Loop and plot
  ...
  set_plot, 'ps'
  device, file='plot_zonal_vertical_extinction_gocart.not_suextcoef.clim.'+expid+'.'+strmid(nymd[i],0,6)+'.ps', /color, $
  ...
  xyouts, .15, .12, 'total aerosol - sulfate extinction [Mm-1]', /normal
