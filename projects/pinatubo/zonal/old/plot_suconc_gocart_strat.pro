  filetemplate = 'c48F_G41-spin.tavg3d_aer_p.ddf'
  ga_times, filetemplate, nymd, nhms, template=template
  filename=strtemplate(template,nymd,nhms)
  nc4readvar, filename, 'so4s', suconc, lon=lon, lat=lat, lev=lev, wantlat=[-2,2]
  nc4readvar, filename, 'airdens', rhoa, lon=lon, lat=lat, lev=lev, wantlat=[-2,2]
  suconc = suconc * rhoa
...
; Now make a plot
  set_plot, 'ps'
  device, file='plot_suconc_gocart_strat.ps', /color, /helvetica, font_size=12, $
