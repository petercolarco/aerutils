...
data = np.load('radiance.c90Fc_I10pa3_pin_ash02_aer_L2-OMAERUV_2007m0617t0756Full.npz')
x = data['rad_VL'].shape
x = x[0]/60
...
data = np.load('ai.c90Fc_I10pa3_pin_ash02_aer_L2-OMAERUV_2007m0617t0756Full.npz')
g = f.get('HDFEOS/SWATHS/Aerosol NearUV Swath/Data Fields')
v = g.get('Residue')
...
#data3 = np.load('/misc/prc15/colarco/c90Fc_I10pa3_pin_ash02/inst3d_aer_v/Y2007/M06/c90Fc_I10pa3_pin_ash02_aer_L2-OMAERUV_2007m0617t0756Full.npz')
