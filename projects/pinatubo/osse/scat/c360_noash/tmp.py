...
data = np.load('radiance.c360Fc_asdI10_pin_aer_L2-OMAERUV_2007m0617t2246Full.npz')
x = data['rad_VL'].shape
x = x[0]/60
...
data = np.load('ai.c360Fc_asdI10_pin_aer_L2-OMAERUV_2007m0617t2246Full.npz')
g = f.get('HDFEOS/SWATHS/Aerosol NearUV Swath/Data Fields')
v = g.get('Residue')
...
#data3 = np.load('/misc/prc15/colarco/c360Fc_asdI10_pin/inst3d_aer_v/Y2007/M06/c360Fc_asdI10_pin_aer_L2-OMAERUV_2007m0617t2246Full.npz')
