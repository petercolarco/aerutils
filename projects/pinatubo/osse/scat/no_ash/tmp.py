...
f = h5py.File('OMI-Aura_L2-OMAERUV_2007m0702t2341-o15767_v003-2015m0918t212900.vl_rad.he5',mode='r+')
g = f.get('HDFEOS/SWATHS/Aerosol NearUV Swath/Data Fields')
v = g.get('NormRadiance')
# Open the model return and stuff the radiances
data = np.load('radiance.c90Fc_H54p3_pin_aer_L2-OMAERUV_2007m0702t2341Full.npz')
x = data['rad_VL'].shape
x = x[0]/60
...
data = np.load('ai.c90Fc_H54p3_pin_aer_L2-OMAERUV_2007m0702t2341Full.npz')
g = f.get('HDFEOS/SWATHS/Aerosol NearUV Swath/Data Fields')
v = g.get('Residue')
...
#data3 = np.load('/misc/prc15/colarco/c90Fc_H54p3_pin/inst3d_aer_v/Y2007/M06/c90Fc_H54p3_pin_aer_L2-OMAERUV_2007m0702t2341Full.npz')
