...
; create the output filename
  ...
  rad322_ = make_array(nx,ny,val=1.e15)
  ...
  rad322__ = make_array(nx,ny,val=0.)
  ...
  nrad322__ = make_array(nx,ny,val=0)
  ...
  if(a[0] ne -1) then ix[a] = 0
  for ipts = 0L, npts-1 do begin
   if(rad322[ipts] gt -1e14) then begin
    rad322__[ix[ipts],iy[ipts]] = rad322__[ix[ipts],iy[ipts]] + rad322[ipts]
    nrad322__[ix[ipts],iy[ipts]] = nrad322__[ix[ipts],iy[ipts]] + 1
   endif
  endfor
  a = where(nrad322__ gt 0)
  rad322_[a] = rad322__[a]/nrad322__[a]
...
; Write an intermediary file
  ...
  fileout = 'aot.'+rnum+'.nc'
   cdfid = ncdf_create(fileout, /clobber)
    ...
    idRad322  = NCDF_VARDEF(cdfid,'rad322',[idLon,idLat], /float)
    ...
    idnRad322  = NCDF_VARDEF(cdfid,'nrad322',[idLon,idLat], /float)
    ...
    ncdf_varput, cdfid, idRad322, rad322_
    ...
    ncdf_varput, cdfid, idnRad322, nrad322__
