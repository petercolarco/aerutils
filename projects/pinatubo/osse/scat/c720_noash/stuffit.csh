...
# Copy OMI L2 file locally and stuff it with model produced radiances
  ...
  foreach file (`\ls -1 /misc/prc08/colarco/OMAERUV_V1621_DATA/2007/OMI-Aura_L2-OMAERUV_2007m0617*he5`)
...
data = np.load('radiance.c720Fc_asdI10_pin_aer_L2-${fileend}Full.npz')
x = data['rad_VL'].shape
x = x[0]/60
...
data = np.load('ai.c720Fc_asdI10_pin_aer_L2-${fileend}Full.npz')
g = f.get('HDFEOS/SWATHS/Aerosol NearUV Swath/Data Fields')
v = g.get('Residue')
...
#data3 = np.load('/misc/prc15/colarco/c720Fc_asdI10_pin/inst3d_aer_v/Y2007/M06/c720Fc_asdI10_pin_aer_L2-${fileend}Full.npz')
