...
; Read my gridded retrievals files
  ...
  pro read_retrieval, filen, lon, lat, $
                      ler388, aod, ssa, $
                      residue, ai, prs, prso, $
                      rad322, rad354, rad388, aerh=aerh, aert=aert, $
    ...
    var_id  = h5d_open(file_id,'HDFEOS/SWATHS/Aerosol NearUV Swath/Data Fields/rad_VL')
    rad_    = h5d_read(var_id)
    rad388  = reform(rad_[9,*,*],nxy)
    rad354  = reform(rad_[6,*,*],nxy)
    rad322  = reform(rad_[2,*,*],nxy)
