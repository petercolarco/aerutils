; Database of events
  ...
  dates = [20060904, 20070526, 20070626, 20070708, $
  ...
  filename = '/misc/prc15/colarco/dR_MERRA-AA-r2/inst3d_aer_v/Y'+yyyy+'/M'+mm+'/dR_MERRA-AA-r2.inst3d_aer_v.'+nymd+'_2100z.nc4'
...
; Make a plot
  set_plot, 'ps'
  device, file='dR_MERRA-AA-r2.'+nymd+'.ps', /color, /helvetica, $
  ...
  plot, indgen(10), /nodata, /noerase, $
   xrange=[30,60], xstyle=9, yrange=[0,20], ystyle=9, $
   xtitle='latitude', ytitle='altitude [km]', $
   title='MERRAero: OCphilic [ug m!E-3!N], '+nymd, $
