; Database of events
  ...
  filename = '/misc/prc14/colarco/dR_F25b18/inst3d_aer_v/Y2007/M'+mm+'/dR_F25b18.inst3d_aer_v.'+nymd+'_2100z.nc4'
  nc4readvar, filename, 'bcphilicbiob', oc, lon=lon, lat=lat
...
; Make a plot
  set_plot, 'ps'
  device, file='test.'+nymd+'.ps', /color, /helvetica, $
  ...
  plotgrid, oc*rhoa*1e9, levels/10, colors, x, y, dx, dy
