; Plot the monthly mean AOT over Greenland
  ...
  levels = [-2000.,-25,-15,-10,-5,-1,1,5,10,15,25]/10.
...
; Data file
  ...
  nc4readvar, filename, ['ocdp','ocsd','ocsv','ocwt'], oc12, lon=lon, lat=lat, /template, /sum
  filename = '/misc/prc13/MERRA2/d5124_m2_jan10/Y2013/M07/d5124_m2_jan10.tavg1_2d_aer_Nx.monthly.201307.nc4'
  nc4readvar, filename, ['ocdp','ocsd','ocsv','ocwt'], oc13, lon=lon, lat=lat, /template, /sum
...
; convert the units
  ...
  set_plot, 'ps'
  device, file='MERRA2.ocdep.201207_201307.ps', font_size=14, /helvetica, /color, $
