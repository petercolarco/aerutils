...
; Data file
  ...
  nc4readvar, filename, 'bcembb', oc12, lon=lon, lat=lat
  filename = '/misc/prc13/MERRA2/d5124_m2_jan10/Y2013/M07/d5124_m2_jan10.tavg1_2d_aer_Nx.monthly.201307.nc4'
  nc4readvar, filename, 'bcembb', oc13, lon=lon, lat=lat
  area, lon, lat, nx, ny, dx, dy, area, grid='d'

; convert the units
  oc = (oc12-oc13)*31.*86400*1000.*1000.  ; mg m-2
  
  
  set_plot, 'ps'
  device, file='MERRA2.bcembb.201207_201307.ps', font_size=14, /helvetica, /color, $
