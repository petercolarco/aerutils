...
; Experiment
  expid = 'bF_F25b9-base-v1.tavg2d_carma_x.sahara'
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
  duem_bF_v1 = reform(emis[im,*])

  expid = 'bF_F25b9-base-v5.tavg2d_carma_x.sahara'
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
  duem_bF_v5 = reform(emis[im,*])

  expid = 'bF_F25b9-base-v6.tavg2d_carma_x.sahara'
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
  duem_bF_v6 = reform(emis[im,*])

  expid = 'bF_F25b9-base-v7.tavg2d_carma_x.sahara'
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
  duem_bF_v7 = reform(emis[im,*])

  expid = 'b_F25b9-base-v1.tavg2d_carma_x.sahara'
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
  duem_b_v1 = reform(emis[im,*])

  expid = 'bF_F25b9-base-v8.tavg2d_carma_x.sahara'
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
  duem_bF_v8 = reform(emis[im,*])

  expid = 'bF_F25b9-base-v10.tavg2d_carma_x.sahara'
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
  duem_bF_v10 = reform(emis[im,*])

  expid = 'bF_F25b9-base-v11.tavg2d_carma_x.sahara'
  years_ = strpad(findgen(17)+2011,1000)
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
  duem_bF_v11 = reform(emis[im,*])

  expid = 'bF_F25b9-kok-v11.tavg2d_carma_x.sahara'
  years_ = strpad(findgen(17)+2011,1000)
  read_budget_table, expid, 'DU', years, emis, sed, dep, wet, scav, burden, tau, rc=rc
...
; Plot the different instances
  set_plot, 'ps'
  device, file='annual_emissions_carma.sahara.ps', /color, /helvetica, $
...
; Plot the box-whisker plot
  device, file='annual_emissions_carma.sahara.stat.ps', /color, /helvetica, $
