...
;  Do the aggregation
   ...
   b = where(nn eq 0)
   pm25[b] = !values.f_nan
   save_diurnal_nc, 'pm25_annual.'+type+'.2014', nx, ny, nt, $
                    lon, lat, pm25, 'pm25', nn


end

make_pm25_annual, 'nadir040'
make_pm25_annual, 'wide040'
stop

make_pm25_annual, 'full'
make_pm25_annual, 'nadir045'
make_pm25_annual, 'nadir050'
make_pm25_annual, 'nadir055'
make_pm25_annual, 'nadir060'
make_pm25_annual, 'nadir065'
make_pm25_annual, 'wide045'
make_pm25_annual, 'wide050'
make_pm25_annual, 'wide055'
make_pm25_annual, 'wide060'
make_pm25_annual, 'wide065'
