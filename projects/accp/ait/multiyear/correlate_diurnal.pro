  ...
  incstr = ['45','55','65']+'!Eo!N'
  noerase = 0
  colors = 90+findgen(ninc)*80
...
print, ix, iy, max(correl[ix,iy,*,*]), min(correl[ix,iy,*,*])
    ...
    for iinc = 0, ninc-1 do begin
     ...
     polyfill, 1+iinc+[-0.33,0,0,-.33,-.33], [0,0,y,y,0], color=colors[iinc]-20, /data
     y = correl[ix,iy,iinc,1]
     polyfill, 1+iinc+[0,.33,.33,0,0], [0,0,y,y,0], color=colors[iinc], /data
