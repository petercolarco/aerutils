  pro gather_diurnal_pm25_reg, fileh, out
...
; Do a global average diurnal cycle
  ...
  c = where(frocean eq 1. and latt ge 45.)
  d = where(frocean ne 1. and latt ge 45.)
  e = where(frocean eq 1. and latt le -45.)
  f = where(frocean ne 1. and latt le -45.)
  g = where(frocean eq 1. and latt gt -45. and latt lt 45.)
  h = where(frocean ne 1. and latt gt -45. and latt lt 45.)
  for it = 0, nt-1 do begin
   ...
   l = where(latt gt -45. and latt lt 45.)
