...
; Read in the land/ocean fraction
  ...
  p_full = reform(p_full,nx,ny,nt)
plot, p_full[198,106,*]*1e9, thick=6  ; Bodele
oplot, p_full[103,129,*]*1e9, thick=2  ; GSFC
oplot, p_full[103,129,*]*1e9*10, thick=2, lin=2  ; GSFC
stop
