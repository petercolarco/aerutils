...
; Read a day of coverage for GPM and SS450 @ 1100km swath
  ...
  filename = '/misc/prc19/colarco/M2R12K/hourly/M2R12K.sunsynch_450km_1330crossing.nodrag.1100km.pm.hourly.20140605.nc4'
...
; Make a map of the region
  set_plot, 'ps'
  device, file='hurricane_region.gpm.ps', /color
...
; Make a map of the region
  set_plot, 'ps'
  device, file='hurricane_region.ss450.ps', /color
  map_set, limit=maplimit
...
; Make a map of the region
  set_plot, 'ps'
  device, file='hurricane_region.merge.ps', /color
  map_set, limit=maplimit
