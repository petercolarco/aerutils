...
; Adjust jday to 2016
  jdayf = julday_nymd(20151231L,0L)+1.d/24.
  djday = jdayf-jday0[0]
  jday  = jday0+djday
...
;   Use gr_circ_rte to fill in points in between CALIOP orbit
    ...
    write_mask, '/misc/prc18/colarco/mask/', 'mask.calipso.offset-1hr', nx, ny, dx, dy, datef, lon, lat, mask, res='d'
