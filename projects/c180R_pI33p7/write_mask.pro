  pro write_mask, outPath, filehead, nx, ny, dx, dy, date, $
                  lon, lat, mask, resolution=resolution, $
...
;  Process and store file
   ...
   spawn, '/bin/mv -f test.'+rnum+'.nc4 '+outPath+'Y'+yyyy+'/M'+mm+'/'+filehead+'.'+datestr+'.nc4'
