; Colarco, March 2019
; offset observing longitude by +10 degrees
...
; Here is a "nominal" CALIPSO orbit valid in 2009
  ...
  tracklon = tracklon+10.
  tracklon[where(tracklon gt 180.)] = tracklon[where(tracklon gt 180.)]-360.
...
;   Use gr_circ_rte to fill in points in between CALIOP orbit
    ...
    write_mask, '/misc/prc18/colarco/mask/', 'mask.calipso.offset+10deg', nx, ny, dx, dy, datef, lon, lat, mask, res='d'
