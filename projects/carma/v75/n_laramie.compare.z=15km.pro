...
; Get a model profile
  ...
  filename = '/misc/prc18/colarco/'+expid+'/tavg3d_carma_v/1988/'+expid+'.tavg3d_carma_v.monthly.clim.ANN.nc4'
  wantlon = -105.
  wantlat = 41.
...
; Find 15 km
  a = where(z gt 14.5 and z lt 15.5)
  n = fltarr(nbin)
...
; plot
  set_plot, 'ps'
  device, file='n_laramie.compare.z=15km.ps', /helvetica, font_size=14, /color
  !p.font=0
