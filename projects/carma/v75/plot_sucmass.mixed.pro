; Make a plot of the global mean sulfate column mass
  ...
  set_plot, 'ps'
  device, file='plot_sucmass.mixed.ps', /helvetica, font_size=12, /color, $
  ...
  plot, indgen(nt), sucmass, /nodata, $
   ...
   xthick=6, ythick=6, $
   xtickname = xtickn, $
   ytitle = 'Sulfate column loading [Tg]', yrange=[.6,5]
  oplot, indgen(nt), sucmass+mxsucmass, thick=12, color=176
  oplot, indgen(nt), mxsucmass, thick=12, color=176, lin=1
  oplot, indgen(nt), sucmass, thick=12, color=176, lin=2
  oplot, indgen(nt), gsucmass, thick=12
