...
; Now massage n, nz0 so that smallest bin plotted is at 0.01 um
  ...
  rp   = [r[0],r[b]]*1.e6
  n_    = [n_[0],n_[b]]
  nz0m_ = [nr_[0,0],nr_[b,0]]
  nz0p_ = [nr_[0,1],nr_[b,1]]
...
; plot
  set_plot, 'ps'
  device, file='n_laramie.compare.ps', /helvetica, font_size=14, /color
  !p.font=0
...
; presuming a value of rh and t...
  ...
  polymaxmin, rwetum, [[nz0m_],[nz0p_]], fillcolor=180, /noave
  loadct, 39
  oplot, rwetum, n_, thick=6, color=254
