; Make a plot of the global mean sulfate column mass
  ...
  set_plot, 'ps'
  device, file='plot_smcmass.mixed.ps', /helvetica, font_size=12, /color, $
  ...
  plot, indgen(nt), sucmass, /nodata, $
   ...
   xthick=6, ythick=6, $
   xtickname = xtickn, $
   ytitle = 'Carbonaceous aerosol column loading [Tg]', yrange=[0,5]
  oplot, indgen(nt), mxsmcmass, thick=12, color=254
  oplot, indgen(nt), gsmcmass, thick=12
