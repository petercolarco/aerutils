...
; Intended to be used for annual mean climatology
  ...
  nc4readvar, filename, 'pso2_ocs_jocs', pso2_ocs
...
; Get Valentina's results
  ...
  nc4readvar, filename, 'pso2_ocs_jocs', pso2_ocs_ace
...
; Now make a plot
  set_plot, 'ps'
  device, file='contour_pso2_jocs.diff.valentina.ps', /color, /helvetica, font_size=12, $
  ...
  contour, diff_pso2, lat_ace, zu, /nodata, /noerase, $
   title = 'Difference Valentina - Model pSO2_jOCS from OCS [pptv day!E-1!N]', $
   position=[.1,.2,.9,.9], $
