; Global, monthly mean dry aerosol PSD by species
  ...
  filenames = ['c48F_pI33p3_carma_ex.tavg3d_carma_v.19790701_0900z.nc4', $
               'c48F_pI33p3_carma_mx.tavg3d_carma_v.19790701_0900z.nc4', $
               'c48F_pI33p3_carma_mx2.tavg3d_carma_v.19790701_0900z.nc4']
...
; Get the aerosols
  ...
  if(i gt 0) then nc4readvar, filename, 'sumx0', sumxs, /template
...
; Do the vertical integration
  ...
  for ibin = 0, nbin-1 do begin
   ...
   if(i gt 0) then sumx[*,*,ibin] = total(sumxs[*,*,*,ibin]*delp,3)/9.81
  endfor
...
; sulfate primary group
  ...
  if(i eq 0) then begin
   set_plot, 'ps'
   device, file='global_psd.ps', /color, /helvetica, font_size=14
   !p.font=0
  ...
  if(i gt 0) then oplot, 2.*r, fac*aave(sumx-du-ss-sm,area)*r/dr, thick=6, color=36, lin=i
