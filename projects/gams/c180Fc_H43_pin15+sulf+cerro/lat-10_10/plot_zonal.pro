...
;  Make a plot
   ...
   loadct, 0
   contour, su_zonal_sam, findgen(61), z, /nodata, $
   ...
   loadct, 64
   contour, su_zonal_sam, findgen(61), z, /overplot, $
    levels=levels, c_colors=colors, /cell
   makekey, .15, .1, .8, .05, 0, -.05, $
...
; Make a plot
   ...
   loadct, 0
   contour, su_zonal_sam-su_zonal, findgen(61), z, /nodata, $
    yrange=[10,40], ytitle='Altitude [km]', $
    xrange=[-1,60], xticks=1, xminor=1, xtickn=[' ', ' '], $
    xstyle=1, ystyle=1, $
    position=[.15,.25,.95,.95], $
   ...
   colors=indgen(13)*20
   contour, su_zonal_sam-su_zonal, findgen(61), z, /overplot, $
    levels=levels, c_colors=colors, /cell
   makekey, .15, .1, .8, .05, 0, -.05, $
...
; Make a plot
  ...
  loadct, 0
  contour, (su_zonal_sam-su_zonal)/su_zonal, findgen(61), z, /nodata, $
   yrange=[10,40], ytitle='Altitude [km]', $
   xrange=[-1,60], xticks=1, xminor=1, xtickn=[' ', ' '], $
   xstyle=1, ystyle=1, $
   position=[.15,.25,.95,.95], $
  ...
  levels=[-2000.,-.5,-.2,-.1,-.05,-.02,-.01,0.01,0.02,0.05,.1,.2,.5]
  colors=indgen(13)*20
  contour, (su_zonal_sam-su_zonal)/su_zonal, findgen(61), z, /overplot, $
   levels=levels, c_colors=colors, /cell
  makekey, .15, .1, .8, .05, 0, -.05, $
   labels=make_array(13,val=' '), $
   colors=colors
