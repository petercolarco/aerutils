...
; Optics tables
  ...
  fileDU = '/share/colarco/fvInput/AeroCom/x/carma_optics_DU.v15.nbin=22.nc'
...
; Get tables
  ...
  tables = {strSU:strSU, strDU:strDU}

; Get a model profile
  filename = '/misc/prc18/colarco/c90Fc_H54p3_pin/tavg3d_carma_v/c90Fc_H54p3_pin.tavg3d_carma_v.monthly.199106.nc4'
  wantlon = -25.
;  wantlon = 145.
  wantlat = 10.
;  wantlat = 60.
...
; And construct the phase function
  ...
  set_plot, 'ps'
  device, file='p11.ash.ps', /color, /helvetica, font_size=14
  !p.font=0
  loadct, 39
...
; Do the sulfate portion by itself
...
; And construct the phase function
  ...
  oplot, p11[*,50], thick=6, lin=2 ; 5 km
  oplot, p11[*,43], thick=6, lin=2, color=60 ; 10 km
  oplot, p11[*,38], thick=6, lin=2, color=84 ; 15 km
  oplot, p11[*,33], thick=6, lin=2, color=176 ; 20 km
  oplot, p11[*,29], thick=6, lin=2, color=208 ; 25 km
  oplot, p11[*,25], thick=6, lin=2, color=254 ; 30 km
