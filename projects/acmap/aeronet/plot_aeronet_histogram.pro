...
;  hist = float(hist)/max(hist[*,0])
  ...
  plot, bins, hist[*,0], /nodata, $
   ...
   xrange=[-.25,.25], xstyle=9, yrange=[0.,0.11], ystyle=9, thick=3, $
   xticks=10;, $; /ylog, $
...
;  xyouts, .13, .0935, 'MERRAero'
  ...
  if(nexp gt 1) then begin
   loadct, 39
   oplot, bins, hist[*,0], thick=8, color=0
   oplot, bins, hist[*,1], thick=8, color=254, lin=2
   oplot, bins, hist[*,2], thick=8, color=84, lin=2
   oplot, bins, hist[*,3], thick=8, color=208, lin=2
   oplot, bins, hist[*,4], thick=8, color=254, lin=1
   oplot, bins, hist[*,5], thick=8, color=84, lin=1
   oplot, bins, hist[*,6], thick=8, color=208, lin=1
   oplot, bins, hist[*,7], thick=8, color=254
   oplot, bins, hist[*,8], thick=8, color=84
   oplot, bins, hist[*,9], thick=8, color=208


   loadct, 0
   plots, [.08,.12], .095, thick=8,color=160, lin=2
   plots, [.08,.12], .089, thick=8,color=160, lin=1
   plots, [.08,.12], .083, thick=8,color=160
   xyouts, .13, .0935, '2!Eo!N'
   xyouts, .13, .0875, '1!Eo!N'
   xyouts, .13, .0815, '0.5!Eo!N'
   loadct, 39
   plots, [.18,.22], .095, thick=8,color=254
   plots, [.18,.22], .089, thick=8,color=84
   plots, [.18,.22], .083, thick=8,color=208
   xyouts, .23, .0935, 'R!Dinst!N'
   xyouts, .23, .0875, 'R!Dincr!N'
   xyouts, .23, .0815, 'CTM'
...
; Make a map showing the distributions
  set_plot, 'ps'
  modnum = 8
  device, file='plot_aeronet_histogram.map.c180Rreg_H54p3-acma.ps', /color, font_size=12, $
   xoff=.5, yoff=.5, xsize=14, ysize=12
  !p.font=0
