...
; Expid to compare
  expid = ['dR_MERRA-AA-r2','eR_F25b18','dR_F25b18','cR_F25b18','F25b18', $
           'c180R_G40b11','c90R_G40b11','c48R_G40b11','c180R_H40_acma']
  expfn = ['/misc/prc15/colarco/dR_MERRA-AA-r2/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/eR_F25b18/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/dR_F25b18/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/cR_F25b18/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/F25b18/inst2d_hwl_x/aeronet/',    $
           '/misc/prc14/colarco/c180R_G40b11/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/c90R_G40b11/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/c48R_G40b11/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/c180R_H40_acma/inst2d_hwl_x/aeronet/'] $
          + expid+'.inst2d_hwl.aeronet.%ch.%y4.nc4'
  expid = ['dR_MERRA-AA-r2','c180R_H40_acma','c48R_H40_acma']
  expfn = ['/misc/prc15/colarco/dR_MERRA-AA-r2/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/c180R_H40_acma/inst2d_hwl_x/aeronet/', $
           '/misc/prc14/colarco/c48R_H40_acma/inst2d_hwl_x/aeronet/'] $
          + expid+'.inst2d_hwl.aeronet.%ch.%y4.nc4'
  expid = ['c48R','c48Rreg','c48ctm','c90R','c90Rreg','c90ctm','c180R','c180Rreg','c180ctm']+'_H54p3-acma'
  expfn =  '/misc/prc18/colarco/'+expid+'/inst2d_hwl_x/aeronet/' $
          + expid+'.inst2d_hwl.aeronet.%ch.%y4.nc4'

; Put the MERRA2 stuff first
  expid = ['MERRA2',expid]
  expfn = ['/misc/prc13/MERRA2/aeronet/MERRA2.tavg1_2d_aer_Nx.aeronet.2008.nc4',expfn]

  nexp = n_elements(expid)

; How sample?
  yyyy = strpad(findgen(1)+2008.,1000L)
  date0 = '20080101'
  date1 = '20081231'
  nymd = [date0,date1]
  nhms = ['000000','230000']
...
;   Get MERRA2 first
    if(iexp eq 0) then begin
     read_stn, expfn[iexp], locwant, 'TOTEXTTAU', modelAOT, nymd_, nhms_
     modaot_ = modelaot[a]
    endif else begin
  ...
  save, /all, filename='aeronet_histogram.sav'
