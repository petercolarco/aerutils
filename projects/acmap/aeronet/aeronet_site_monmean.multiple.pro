...
; existing in output/mon_mean and output/histogram
  expid = ['eR_F25b18','dR_F25b18','cR_F25b18','F25b18','c180R_G40b11','c90R_G40b11','c48R_G40b11'] + '.inst2d_hwl.aeronet'
  colors = [0, 75, 176, 254, 75, 176, 254]
  lins   = [0,  0,   0,   0,  2,   2,   2]
  expid = ['c180R_G40b11','c90R_G40b11','c48R_G40b11', $
           'c180R_G40b11_merra2','c90R_G40b11_merra2','c48R_G40b11_merra2'] + '.inst2d_hwl.aeronet'
  colors = [75, 176, 254, 75, 176, 254]
  lins   = [ 0,   0,   0,  2,   2,   2]
  expid = ['c180R_H54p3-acma','c90R_H54p3-acma','c48R_H54p3-acma', $
           'c180R_H54p3-acma','c90Rreg_H54p3-acma','c48Rreg_H54p3-acma'] + '.inst2d_hwl.aeronet'
  colors = [75, 176, 254, 75, 176, 254]
  lins   = [ 0,   0,   0,  2,   2,   2]
