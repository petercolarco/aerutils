...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_totexttau_all_diff.ps', /color, /helvetica, font_size=12, $
  ...
  expid = ['dR_MERRA-AA-r2', 'c180R_G41_acma_merra2_noq', 'c180F_G41_acma', $
           'c48R_G41_acma_noq', 'c48R_G41_acma_merra2_noq', 'c48F_G41_acma' ]
  title = expid
...
; Get the 2 degree
   datafil = '/misc/prc14/colarco/'+expid[0]+'/tavg2d_aer_x/'+expid[0]+'.tavg2d_aer_x.monthly.clim.ANN.b.nc4'
   nc4readvar, datafil, 'totexttau', tau, lon=lon, lat=lat, lev=lev
   a = where(lat gt 90 or lat lt -90)
   tau[*,a] = !values.f_nan
   tau[where(tau gt 1e14)] = !values.f_nan
