...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_ssexttau_all_diff.ps', /color, /helvetica, font_size=16, $
...
; Get the b-resolution baseine
  datafil = '/misc/prc14/colarco/dR_F25b18/tavg2d_aer_x/dR_F25b18.tavg2d_aer_x.monthly.clim.ANN.b.nc4'
