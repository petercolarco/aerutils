...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_misr_all.saf.straight.ps', /color, /helvetica, font_size=16, $
...
; MERRAero
  iplot = 0
  datafil = '/misc/prc15/colarco/dR_MERRA-AA-r2/inst2d_hwl_x/Y2007/dR_MERRA-AA-r2.inst2d_hwl_x.monthly.2007ASO.nc4'
...
; c180R_G40b11
  iplot = 1
  datafil = '/misc/prc14/colarco/c180R_G40b11/inst2d_hwl_x/Y2007/c180R_G40b11.inst2d_hwl_x.monthly.2007ASO.nc4'
  nc4readvar, datafil, 'totexttau', tau, lon=lon, lat=lat, lev=lev
  a = where(lat gt 60 or lat lt -60)
  tau[*,a] = !values.f_nan
  tau[where(tau gt 1e14)] = !values.f_nan
...
; c90R_G40b11
  iplot = 2
  datafil = '/misc/prc14/colarco/c90R_G40b11/inst2d_hwl_x/Y2007/c90R_G40b11.inst2d_hwl_x.monthly.2007ASO.nc4'
  nc4readvar, datafil, 'totexttau', tau, lon=lon, lat=lat, lev=lev
  a = where(lat gt 60 or lat lt -60)
  tau[*,a] = !values.f_nan
  tau[where(tau gt 1e14)] = !values.f_nan
...
; c48R_G40b11
  iplot = 3
  datafil = '/misc/prc14/colarco/c48R_G40b11/inst2d_hwl_x/Y2007/c48R_G40b11.inst2d_hwl_x.monthly.2007ASO.nc4'
  nc4readvar, datafil, 'totexttau', tau, lon=lon, lat=lat, lev=lev
  a = where(lat gt 60 or lat lt -60)
  tau[*,a] = !values.f_nan
  tau[where(tau gt 1e14)] = !values.f_nan
...
; dR_F25b18
  iplot = 5
  datafil = '/misc/prc14/colarco/dR_F25b18/inst2d_hwl_x/Y2007/dR_F25b18.inst2d_hwl_x.monthly.2007ASO.nc4'
  nc4readvar, datafil, 'totexttau', tau, lon=lon, lat=lat, lev=lev
  a = where(lat gt 60 or lat lt -60)
  tau[*,a] = !values.f_nan
  tau[where(tau gt 1e14)] = !values.f_nan
...
; cR_F25b18
  iplot = 6
  datafil = '/misc/prc14/colarco/cR_F25b18/inst2d_hwl_x/Y2007/cR_F25b18.inst2d_hwl_x.monthly.2007ASO.nc4'
  nc4readvar, datafil, 'totexttau', tau, lon=lon, lat=lat, lev=lev
  a = where(lat gt 60 or lat lt -60)
  tau[*,a] = !values.f_nan
  tau[where(tau gt 1e14)] = !values.f_nan
...
; F25b18
  iplot = 7
  datafil = '/misc/prc14/colarco/F25b18/inst2d_hwl_x/Y2007/F25b18.inst2d_hwl_x.monthly.2007ASO.nc4'
  nc4readvar, datafil, 'totexttau', tau, lon=lon, lat=lat, lev=lev
  a = where(lat gt 60 or lat lt -60)
  tau[*,a] = !values.f_nan
  tau[where(tau gt 1e14)] = !values.f_nan
