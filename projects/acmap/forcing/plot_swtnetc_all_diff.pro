; Make a plot of the SWTNETC forcing difference relative to standard, 6 panel

; Setup the plot
  set_plot, 'ps'
  device, file='plot_swtnetc_all_diff.ps', /color, /helvetica, font_size=16, $
...
; datafiles
  datafils = ['/misc/prc18/colarco/c180Rreg_H54p3-acma/geosgcm_surf/c180Rreg_H54p3-acma.geosgcm_surf.monthly.clim.ANN.b.nc4', $
              '/misc/prc18/colarco/c90Rreg_H54p3-acma/geosgcm_surf/c90Rreg_H54p3-acma.geosgcm_surf.monthly.clim.ANN.b.nc4', $
              '/misc/prc18/colarco/c48Rreg_H54p3-acma/geosgcm_surf/c48Rreg_H54p3-acma.geosgcm_surf.monthly.clim.ANN.nc4', $
              '/misc/prc18/colarco/c180F_H54p3-acma/geosgcm_surf/c180F_H54p3-acma.geosgcm_surf.monthly.clim.ANN.b.nc4', $
              '/misc/prc18/colarco/c90F_H54p3-acma/geosgcm_surf/c90F_H54p3-acma.geosgcm_surf.monthly.clim.ANN.b.nc4', $
...
; 
  ...
  nc4readvar, datafil, ['swtnetc','swtnetcna'], tau, lon=lon, lat=lat, lev=lev
  nc4readvar, '/misc/prc18/colarco/c48R_H54p3-acma/tavg2d_aer_x/c48R_H54p3-acma.tavg2d_aer_x.monthly.clim.ANN.nc4', 'lwi', lwi
