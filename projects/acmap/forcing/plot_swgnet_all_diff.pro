; Make a plot of the SWGNET forcing difference relative to standard, 6 panel

; Setup the plot
  set_plot, 'ps'
  device, file='plot_swgnet_all_diff.ps', /color, /helvetica, font_size=16, $
...
; 
  ...
  nc4readvar, datafil, ['swgnet','swgnetna'], tau, lon=lon, lat=lat, lev=lev
