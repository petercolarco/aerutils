; Make a plot of the SWTNET forcing, 6 panel

; Setup the plot
  set_plot, 'ps'
  device, file='plot_swtnet_all.ps', /color, /helvetica, font_size=16, $
...
; datafiles
  datafils = ['/misc/prc14/colarco/c360R_H53-acma/geosgcm_surf/c360R_H53-acma.geosgcm_surf.monthly.clim.JJA.nc4', $
              '/misc/prc14/colarco/c180R_H53-acma/geosgcm_surf/c180R_H53-acma.geosgcm_surf.monthly.clim.JJA.nc4', $
              '/misc/prc14/colarco/c90R_H53-acma/geosgcm_surf/c90R_H53-acma.geosgcm_surf.monthly.clim.JJA.nc4', $
              '/misc/prc14/colarco/c360F_H53-acma/geosgcm_surf/c360F_H53-acma.geosgcm_surf.monthly.clim.JJA.nc4', $
              '/misc/prc14/colarco/c180F_H53-acma/geosgcm_surf/c180F_H53-acma.geosgcm_surf.monthly.clim.JJA.nc4', $
...
; 
  ...
  nc4readvar, '/misc/prc14/colarco/c180R_H53-acma/tavg2d_aer_x/c180R_H53-acma.tavg2d_aer_x.monthly.clim.ANN.nc4', 'lwi', lwi
...
; 
  ...
  datafil = datafils[iplot]
  nc4readvar, datafil, ['swtnet','swtnetna'], tau, lon=lon, lat=lat, lev=lev
  nc4readvar, '/misc/prc14/colarco/c90R_H53-acma/tavg2d_aer_x/c90R_H53-acma.tavg2d_aer_x.monthly.clim.ANN.nc4', 'lwi', lwi
  tau = reform(tau[*,*,0]-tau[*,*,1])
  dx = lon[1]-lon[0]
  dy = lat[1]-lat[0]
  area, lon, lat, nx, ny, dx, dy, area
...
; 
  ...
  datafil = datafils[iplot]
  nc4readvar, datafil, ['swtnet','swtnetna'], tau, lon=lon, lat=lat, lev=lev
  nc4readvar, '/misc/prc14/colarco/c48R_H53-acma/tavg2d_aer_x/c48R_H53-acma.tavg2d_aer_x.monthly.clim.ANN.nc4', 'lwi', lwi
  tau = reform(tau[*,*,0]-tau[*,*,1])
  dx = lon[1]-lon[0]
  dy = lat[1]-lat[0]
  area, lon, lat, nx, ny, dx, dy, area
