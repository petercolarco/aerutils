...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_merraero_two_diff.ps', /color, /helvetica, font_size=16, $
  ...
  datafils = ['/misc/prc15/colarco/dR_MERRA-AA-r2/inst2d_hwl_x/Y2007/dR_MERRA-AA-r2.inst2d_hwl_x.MISR_L2.aero_tc8_F12_0022.noqawt.2007.nc4', $
...
; Baseline
  ...
  nc4readvar, datafil, 'totexttau', duem, lon=lon, lat=lat, lev=lev, /sum
...
; Get the b-resolution
  datafil = '/misc/prc15/colarco/dR_MERRA-AA-r2/inst2d_hwl_x/Y2007/dR_MERRA-AA-r2.inst2d_hwl_x.MISR_L2.aero_tc8_F12_0022.noqawt.2007.b.nc4'
  nc4readvar, datafil, 'totexttau', duem_b, lon=lon, lat=lat, lev=lev, /sum
