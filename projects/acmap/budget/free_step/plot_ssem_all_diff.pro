...
; c180R_G40b11
  ...
  plotgrid, ssem, levels, dcolors, lon, lat, dx, dy, /map
  ...
  title = 'c180R_G40b11'
  mval  = string(total(area*ssem)*1.e-9,format='(f6.1)')+' Tg'
...
; c180F_G40b11
  ...
  nc4readvar, datafil, 'ssem', ssem, lon=lon, lat=lat, lev=lev, /tem, /sum
  ssem = ssem*365.*86400.   ; kg m-2 yr-1
  ssem = ssem-ssem_base
  map_set, p0, p1, position=position[*,iplot], /noerase, /noborder, limit=geolimits, /robinson, /iso
  plotgrid, ssem, levels, dcolors, lon, lat, dx, dy, /map
  ...
  area, lon, lat, nx, ny, dx, dy, area
  title = 'c180F_G40b11'
  mval  = string(total(area*ssem)*1e-9,format='(f6.1)')+' Tg'
  xyouts, position[0,iplot], position[3,iplot]-.075, title, color=iblack, /normal, charsize=.6
  xyouts, position[2,iplot]-.16, position[3,iplot]-.075, mval, color=iblack, /normal, charsize=.6, align=.5 
...
; c90F_G40b11
  ...
  area, lon, lat, nx, ny, dx, dy, area
  title = 'c90F_G40b11'
  mval  = string(total(area*ssem)*1e-9,format='(f7.1)')+' Tg'
  xyouts, position[0,iplot], position[3,iplot]-.075, title, color=iblack, /normal, charsize=.6
  xyouts, position[2,iplot]-.16, position[3,iplot]-.075, mval, color=iblack, /normal, charsize=.6, align=.5 
