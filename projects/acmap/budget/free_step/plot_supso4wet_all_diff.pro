...
; c180R_G40b11
  ...
  nc4readvar, datafil, ['supso4wt','supso4aq'], supd, lon=lon, lat=lat, lev=lev, /sum
...
; DIFFERENCE PLOT
  supd_base = supd
  loadct, 0
  levels = [-2000,-.5,-.2,-.1,-.05,-.01,.01,.05,.1,.2,.5]
  makekey, .25, .07, .5, .03, 0, -.04, align=.5, charsize=.6, $
           color=make_array(11,val=0), $
           label=[' ','-0.5','-0.2','-0.1','-0.05','-0.01','0.01','0.05','0.1','0.2','0.5']
