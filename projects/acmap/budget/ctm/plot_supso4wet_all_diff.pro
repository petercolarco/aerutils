...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_supso4wet_all_diff.ps', /color, /helvetica, font_size=16, $
...
; Baseline
  ...
  nc4readvar, datafil, ['supso4aq','supso4wt'], duem, lon=lon, lat=lat, lev=lev, /sum
...
; Get the b-resolution
  ...
  nc4readvar, datafil, ['supso4aq','supso4wt'], duem_b, lon=lon, lat=lat, lev=lev, /sum
...
; Get the c-resolution
  ...
  nc4readvar, datafil, ['supso4aq','supso4wt'], duem_c, lon=lon, lat=lat, lev=lev, /sum
  duem_c = duem_c*365.*86400.*1000.
  duem_base_c = duem_c

  for iplot = 1, 5 do begin

   nc4readvar, datafils[iplot], ['supso4aq','supso4wt'], duem, lon=lon, lat=lat, lev=lev, /sum
   duem = duem*365.*86400.*1000.   ; g m-2 yr-1
   area, lon, lat, nx, ny, dx, dy, area
