...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_cldtt_all.ps', /color, /helvetica, font_size=16, $
  ...
  nc4readvar, datafils[iplot], ['cldtt'], cldtt, lon=lon, lat=lat, lev=lev, /sum
  dx = lon[1]-lon[0]
  dy = lat[1]-lat[0]
  title = titles[iplot]
  plot_map, cldtt, lon, lat, dx, dy, levels, dcolors, $
