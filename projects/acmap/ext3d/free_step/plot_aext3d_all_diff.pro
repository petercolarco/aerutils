...
; c180R_G40b11
  iplot = 0
  datafil = '/misc/prc14/colarco/c180R_G40b11/inst3d_ext-532nm_v/c180R_G40b11.inst3d_ext-532nm_v.monthly.clim.ANN.nc4'
  nc4readvar, datafil, ['extinction','ssa'], tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau[*,*,*,0]*(1.-tau[*,*,*,1]),1)/nx)
  tau_base = tau
...
; DIFFERENCE PLOT
  ...
  tvlct, red, green, blue
  levels = [-2000,-5,-2,-1,-0.5,-.1,.1,0.5,1,2,5]/10000.
  dcolors=indgen(n_elements(levels))
  igrey  = n_elements(red)-2
  iblack = n_elements(red)-1
...
; c180F_G40b11
  iplot = 3
  datafil = '/misc/prc14/colarco/c180F_G40b11/inst3d_ext-532nm_v/c180F_G40b11.inst3d_ext-532nm_v.monthly.clim.ANN.nc4'
  nc4readvar, datafil, ['extinction','ssa'], tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau[*,*,*,0]*(1.-tau[*,*,*,1]),1)/nx)-tau_base
  plot, indgen(2), /nodata, position=position[*,iplot], /noerase, $
        xrange=[-90,90], yrange=[1000,500], /ylog, color=iblack, $
        xstyle=1, xticks=6, ystyle=1, yticks=5, ytickv=[1000,900,800,700,600,500], charsize=.8
  contour, tau, lat, lev, /over, levels=levels, /fill, c_colors=dcolors
...
; Get the c-resolution baseine
  datafil = '/misc/prc14/colarco/c180R_G40b11/inst3d_ext-532nm_v/c180R_G40b11.inst3d_ext-532nm_v.monthly.clim.ANN.c.nc4'
  nc4readvar, datafil, ['extinction','ssa'], tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau_base = reform(total(tau[*,*,*,0]*(1.-tau[*,*,*,1]),1)/nx)



; c90R_G40b11
  iplot = 1
  datafil = '/misc/prc14/colarco/c90R_G40b11/inst3d_ext-532nm_v/c90R_G40b11.inst3d_ext-532nm_v.monthly.clim.ANN.nc4'
  nc4readvar, datafil, ['extinction','ssa'], tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau[*,*,*,0]*(1.-tau[*,*,*,1]),1)/nx)-tau_base
...
; c90F_G40b11
  iplot = 4
  datafil = '/misc/prc14/colarco/c90F_G40b11/inst3d_ext-532nm_v/c90F_G40b11.inst3d_ext-532nm_v.monthly.clim.ANN.nc4'
  nc4readvar, datafil, ['extinction','ssa'], tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau[*,*,*,0]*(1.-tau[*,*,*,1]),1)/nx)-tau_base
...
; Get the c-resolution baseine
  datafil = '/misc/prc14/colarco/c180R_G40b11/inst3d_ext-532nm_v/c180R_G40b11.inst3d_ext-532nm_v.monthly.clim.ANN.b.nc4'
  nc4readvar, datafil, ['extinction','ssa'], tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau_base = reform(total(tau[*,*,*,0]*(1.-tau[*,*,*,1]),1)/nx)
...
; c48R_G40b11_step
  iplot = 2
  datafil = '/misc/prc14/colarco/c48R_G40b11_step/inst3d_ext-532nm_v/c48R_G40b11_step.inst3d_ext-532nm_v.monthly.clim.ANN.nc4'
  nc4readvar, datafil, ['extinction','ssa'], tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau[*,*,*,0]*(1.-tau[*,*,*,1]),1)/nx)-tau_base
...
; c48F_G40b11
  iplot = 5
  datafil = '/misc/prc14/colarco/c48F_G40b11/inst3d_ext-532nm_v/c48F_G40b11.inst3d_ext-532nm_v.monthly.clim.ANN.nc4'
  nc4readvar, datafil, ['extinction','ssa'], tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau[*,*,*,0]*(1.-tau[*,*,*,1]),1)/nx)-tau_base
