...
; c180R_G40b11
  iplot = 0
  datafil = '/misc/prc14/colarco/c180R_G40b11/inst3d_ext-532nm_v/dust/c180R_G40b11/inst3d_ext-532nm_v/c180R_G40b11.inst3d_ext-532nm_v.monthly.clim.JJA.nc4'
...
; dR_F25b18
  iplot = 3
  datafil = '/misc/prc14/colarco/dR_F25b18/inst3d_ext-532nm_v/dust/dR_F25b18/inst3d_ext-532nm_v/dR_F25b18.inst3d_ext-532nm_v.monthly.clim.JJA.nc4'
  nc4readvar, datafil, 'extinction', tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
...
; Get the c-resolution baseine
  datafil = '/misc/prc14/colarco/c180R_G40b11/inst3d_ext-532nm_v/dust/c180R_G40b11/inst3d_ext-532nm_v/c180R_G40b11.inst3d_ext-532nm_v.monthly.clim.JJA.c.nc4'
...
; c90R_G40b11
  iplot = 1
  datafil = '/misc/prc14/colarco/c90R_G40b11/inst3d_ext-532nm_v/dust/c90R_G40b11/inst3d_ext-532nm_v/c90R_G40b11.inst3d_ext-532nm_v.monthly.clim.JJA.nc4'
  nc4readvar, datafil, 'extinction', tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau,1)/nx)-tau_base
...
; cR_F25b18
  iplot = 4
  datafil = '/misc/prc14/colarco/cR_F25b18/inst3d_ext-532nm_v/dust/cR_F25b18/inst3d_ext-532nm_v/cR_F25b18.inst3d_ext-532nm_v.monthly.clim.JJA.nc4'
  nc4readvar, datafil, 'extinction', tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau,1)/nx)-tau_base
...
; Get the c-resolution baseine
  datafil = '/misc/prc14/colarco/c180R_G40b11/inst3d_ext-532nm_v/dust/c180R_G40b11/inst3d_ext-532nm_v/c180R_G40b11.inst3d_ext-532nm_v.monthly.clim.JJA.b.nc4'
  nc4readvar, datafil, 'extinction', tau_base, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau_base = reform(total(tau_base,1)/nx)
...
; c48R_G40b11
  iplot = 2
  datafil = '/misc/prc14/colarco/c48R_G40b11/inst3d_ext-532nm_v/dust/c48R_G40b11/inst3d_ext-532nm_v/c48R_G40b11.inst3d_ext-532nm_v.monthly.clim.JJA.nc4'
  nc4readvar, datafil, 'extinction', tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau,1)/nx)-tau_base
...
; F25b18
  iplot = 5
  datafil = '/misc/prc14/colarco/F25b18/inst3d_ext-532nm_v/dust/F25b18/inst3d_ext-532nm_v/F25b18.inst3d_ext-532nm_v.monthly.clim.JJA.nc4'
  nc4readvar, datafil, 'extinction', tau, lon=lon, lat=lat, lev=lev
; Zonal mean
  nx = n_elements(lon)
  tau = reform(total(tau,1)/nx)-tau_base
