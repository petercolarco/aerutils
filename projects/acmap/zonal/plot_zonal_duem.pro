...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_zonal_duem.ps', /color, /helvetica, font_size=16, $
...
;  seasons = ['M01','M02','M03','M04']
  ...
  for iseas = 0, 3 do begin
   ...
   plot, findgen(10), /nodata, thick=3, /noerase, $
         ...
         yrange=[0,25], ytitle='Emissions [Tg mon!E-1!N]', yticks=5, ystyle=9, $
...
check, duem
    oplot, lat, duem, thick=6, color=color[iexpid], lin=lins[iexpid]
   endfor
   xyouts, -85, .18*25/.2, seasons[iseas]
  endfor
