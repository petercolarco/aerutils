...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_zonal_supso4g_diff.ps', /color, /helvetica, font_size=16, $
...
;  seasons = ['M01','M02','M03','M04']
  ...
  for iseas = 0, 3 do begin
   ...
   plot, findgen(10), /nodata, thick=3, /noerase, $
         ...
         yrange=[-.06,.06], ytitle='!9D!3Production [Tg mon!E-1!N]', yticks=4, ystyle=9, $
   ...
   for iexpid = 0, nexpid-1 do begin
    ...
    nc4readvar, datafil, ['supso4g'], pso4, lon=lon, lat=lat, lev=lev
