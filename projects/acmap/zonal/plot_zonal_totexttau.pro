...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_zonal_totexttau.ps', /color, /helvetica, font_size=16, $
  ...
  color  = [254, 254, 254, 76, 76, 76, 208, 176]
  lins   = [0,   1,   2,   0,  1,  2,  1,   1]
...
;  seasons = ['M01','M02','M03','M04']
  ...
  for iseas = 0, 3 do begin
   ...
   plot, findgen(10), /nodata, thick=3, /noerase, $
         ...
         yrange=[0,.3], ytitle='AOD', yticks=3, ystyle=9, $
