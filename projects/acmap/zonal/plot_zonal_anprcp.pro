...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_zonal_anprcp.ps', /color, /helvetica, font_size=16, $
...
;  seasons = ['M01','M02','M03','M04']
  ...
  for iseas = 0, 3 do begin
   ...
   plot, findgen(10), /nodata, thick=3, /noerase, $
         ...
         yrange=[0,2], ytitle='Precipitation [mm day!E-1!N]', yticks=4, ystyle=9, $
