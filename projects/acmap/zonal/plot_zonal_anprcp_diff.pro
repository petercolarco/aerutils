...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_zonal_anprcp_diff.ps', /color, /helvetica, font_size=16, $
...
;  seasons = ['M01','M02','M03','M04']
  ...
  for iseas = 0, 3 do begin
   ...
   plot, findgen(10), /nodata, thick=3, /noerase, $
         ...
         yrange=[-.5,.5], ytitle='!9D!3Precipitation [mm day!E-1!N]', yticks=4, ystyle=9, $
   ...
   for iexpid = 0, nexpid-1 do begin
    ...
    nc4readvar, datafil, 'anprcp', prec, lon=lon, lat=lat, lev=lev
   ...
   xyouts, -85, .0325*.5/.04, seasons[iseas]
  endfor
