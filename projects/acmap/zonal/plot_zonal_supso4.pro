...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_zonal_supso4.ps', /color, /helvetica, font_size=16, $
...
;  seasons = ['M01','M02','M03','M04']
  ...
  for iseas = 0, 3 do begin
   ...
   plot, findgen(10), /nodata, thick=3, /noerase, $
         ...
         yrange=[0,.8], ytitle='Production [Tg mon!E-1!N]', yticks=4, ystyle=9, $
...
print, total(pso4)
   ...
   xyouts, -85, .18*.8/.2, seasons[iseas]
  endfor
