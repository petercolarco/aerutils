...
; Setup the plot
  set_plot, 'ps'
  device, file='plot_tprec_all_diff.ps', /color, /helvetica, font_size=16, $
...
; c180R_H40_acma
  ...
  nc4readvar, datafil, ['tprec'], tprec, lon=lon, lat=lat, lev=lev, /sum
  tprec = tprec*86400.   ; mm day-1
  dx = lon[1]-lon[0]
  dy = lat[1]-lat[0]
  title = 'R!U1/2!S!Eo!N'
  plot_map, tprec, lon, lat, dx, dy, levels, dcolors, $
