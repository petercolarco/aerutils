...
# Script requires arguments expid and resolution
#  e.g., "./model2satellite_monmean.sample.csh c48R_H54p3-acma b"
# Setup is for current version of those expids

  if ( $#argv < 2 ) then
   echo "Insufficient arguments for link_missing"
   echo "./model2satellite_monmean.sample.csh expid resolution"
   exit 1
  endif

# Model parameters (to be modified)
#  set expid      = c48R_H54p3-acma
#  set resolution = b
  set expid      = $1
  set resolution = $2
