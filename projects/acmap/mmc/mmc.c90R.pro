...
opac_spheres = 'c90R_G40b11'
noaerosol    = nodust
dust         = OPAC_spheres
coll         = 'geosgcm_prog'

f1  = exppath+noaerosol+'/'+coll+'/'+noaerosol+'.'+coll+'.monthly.clim.ANN.c.nc4'
...
;;;;; PLOT MMC CHANGES
  set_plot, 'ps'
  device, file = 'c90R.ps', /helvetica, font_size=16, /color, $
...
; Plot the u wind
  ...
  contour, diff_u_zonal, lat, lev, /nodata, color=iblack, /noerase, $
           ...
           title='U-Wind (Ganymed!U1!S!Eo!N - Fortuna!U1/2!S!Eo!N)'
...
; Plot the MMC
  ...
  contour, mmc_diff*1e-10, lat, lev, /nodata, color=iblack, /noerase, $
           ...
           ystyle=1,xstyle=1, yticks=7, xticks=6, charsize=.6, $
           ytitle='Pressure [hPa]', xtitle='Latitude', $
           title='Mean Meridional Circulation (Ganymed!U1!S!Eo!N - Fortuna!U1/2!S!Eo!N)'
