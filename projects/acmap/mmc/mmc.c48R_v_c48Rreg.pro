...
nodust       = 'c48R_H40_acma'
opac_spheres = 'c48Rreg_H40_acma'
noaerosol    = nodust
dust         = OPAC_spheres
coll         = 'geosgcm_prog'
...
;;;;; PLOT MMC CHANGES
  set_plot, 'ps'
  device, file = 'c48R_v_c48Rreg.ps', /helvetica, font_size=16, /color, $
...
; Plot the u wind
  ...
  contour, diff_u_zonal, lat, lev, /nodata, color=iblack, /noerase, $
           ...
           title='U-Wind (Rreg!U2!S!Eo!N - R!U2!S!Eo!N)'
...
; Plot the MMC
  ...
  contour, mmc_diff*1e-10, lat, lev, /nodata, color=iblack, /noerase, $
           ...
           ystyle=1,xstyle=1, yticks=7, xticks=6, charsize=.6, $
           ytitle='Pressure [hPa]', xtitle='Latitude', $
           title='Mean Meridional Circulation (Rreg!U2!S!Eo!N - R!U2!S!Eo!N)'
