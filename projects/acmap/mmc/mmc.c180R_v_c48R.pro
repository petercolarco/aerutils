...
;;;;; PLOT MMC CHANGES
  set_plot, 'ps'
  device, file = 'c180R_v_c48R.ps', /helvetica, font_size=16, /color, $
...
; Plot the u wind
  ...
  contour, diff_u_zonal, lat, lev, /nodata, color=iblack, /noerase, $
           ...
           title='U-Wind (R!U2!S!Eo!N - R!U1/2!S!Eo!N)'
...
; Plot the MMC
  ...
  contour, mmc_diff*1e-10, lat, lev, /nodata, color=iblack, /noerase, $
           ...
           ystyle=1,xstyle=1, yticks=7, xticks=6, charsize=.6, $
           ytitle='Pressure [hPa]', xtitle='Latitude', $
           title='Mean Meridional Circulation (R!U2!S!Eo!N - R!U1/2!S!Eo!N)'
