...
; from here: /misc/opk01/topete/du/
  ...
  pro getoptics, model, mee, ssa
   ...
   filename = filedir+'integ-du_'+model+'_lognorm_vmd35-raw.nc'
...
; Make a series of plots
  for imod = 0,7 do begin
   set_plot, 'ps'
   device, file='dust_param_lognormal.models_lognorm_vmd35.'+models[imod]+'.ps', /color, $
...
;  forcing
  ...
  device, /close
   ...
   set_plot, 'ps'
   device, file='dust_param_lognormal.model_lognorm_vmd35.2.'+models[imod]+'.ps', /color, $
    /helvetica, font_size=14, xsize=42, ysize=14
   !p.font=0
...
; Some kind of synthesis figure
  set_plot, 'ps'
  device, file='dust_param_lognormal.models_lognorm_vmd35.ps', /helvetica, font_size=14, $
