...
; from here: /misc/opk01/topete/du/
  ...
  xyouts, 0.6, 1.85, 'D!IV!N = 2.5 !9m!3m', color=84, /data
  xyouts, 0.6, 1.71, 'D!IV!N = 4.5 !9m!3m', color=148, /data
  loadct, 0
  ...
  xyouts, 0.6, 1.78, 'D!IV!N = 3.5 !9m!3m', color=160, /data
  xyouts, 1.05, 1.63, '!4OPAC!3', color=100, /data
  plots, 0.85, 1.6575, psym=sym(1), color=100, symsize=1.25
;  xyouts, 5.75, 1.71, '!4NAAPS!3', /data
;  plots, 5.55, 1.7375, psym=sym(5), symsize=1.25
  plots, [.1,0.75]+3., 1.87, thick=12, color=160, lin=1
  plots, [.1,0.75]+3., 1.80, thick=12, color=160, lin=0
  plots, [.1,0.75]+3., 1.73, thick=12, color=160, lin=2
  xyouts, 4, 1.85, '!9s!3 = ln(1.7)', color=160, /data
  xyouts, 4, 1.78, '!9s!3 = ln(2.0)', color=160, /data
  xyouts, 4, 1.71, '!9s!3 = ln(2.3)', color=160, /data
;  plots, [0,7], 1, thick=6
...
;  plots, [0,7], -.457, thick=6
  ...
  pro getoptics, model, mee, ssa
   filedir = '/misc/opk01/topete/du/'
   filename = filedir+'integ-du_'+model+'-raw.nc'
...
; Make a series of plots
  for imod = 0,7 do begin
   set_plot, 'ps'
   device, file='dust_param_lognormal.models_nonsphere.'+models[imod]+'.ps', /color, $
...
;  forcing
  ...
  device, /close
   ...
   set_plot, 'ps'
   device, file='dust_param_lognormal.model_nonsphere.2.'+models[imod]+'.ps', /color, $
    /helvetica, font_size=14, xsize=42, ysize=14
   !p.font=0
...
; Some kind of synthesis figure
  set_plot, 'ps'
  device, file='dust_param_lognormal.models_nonsphere.ps', /helvetica, font_size=14, $
