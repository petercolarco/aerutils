...
; from here: /misc/opk01/topete/du/
  pro getoptics, model, mee, ssa
   ...
   filename = filedir+'integ-du_'+model+'_lognorm-raw.nc'
...
; Make a series of plots
  for imod = 0,7 do begin
   set_plot, 'ps'
   device, file='dust_param_lognormal.models_lognorm.'+models[imod]+'.ps', /color, $
...
;  forcing
  ...
  device, /close
   ...
   set_plot, 'ps'
   device, file='dust_param_lognormal.model_lognorm.2.'+models[imod]+'.ps', /color, $
    /helvetica, font_size=14, xsize=42, ysize=14
   !p.font=0
...
; Some kind of synthesis figure
  set_plot, 'ps'
  device, file='dust_param_lognormal.models_lognorm.ps', /helvetica, font_size=14, $
