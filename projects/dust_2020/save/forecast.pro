  ...
  nc4readvar, filename[0], 'duexttau', duext, wantlon=[-65.6], wantlat=[18.4]

; make a plot
  set_plot, 'ps'
  device, file='forecast.0.ps', /color, /helvetica, font_size=18, $
   xsize=30, ysize=16
  !p.font=0
...
; make a plot
  set_plot, 'ps'
  device, file='forecast.ps', /color, /helvetica, font_size=18, $
   xsize=30, ysize=16
  !p.font=0
  ...
  for i = 1, 10 do begin
   nc4readvar, filename[i], 'duexttau', duext, wantlon=[-65.6], wantlat=[18.4]
