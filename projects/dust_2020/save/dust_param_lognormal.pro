...
; AOD and SSA integrated. Use NAAPS to set the total mass load
  ...
  tau_table = fltarr(8,351,101)
  mee_table = fltarr(8,351,101)
  mfr_table = fltarr(8,351,101)
  afr_table = fltarr(8,351,101)
  ssa_table = fltarr(8,351,101)
  frc_table = fltarr(8,351,101)

  models = ['GEOS','AM4','MONARCH','ModelE','IFS','SILAM','UM','NAAPS']
...
; dither about some values
  ...
  loadct, 39
  plot, tau[a], /nodata, $
   xrange=[0,6], yrange=[0.5,2], $
   xstyle=1, ystyle=9, xticks=6, yticks=6, $
   ytitle='"Normalized" AOD', $
   position=[.05,.25,.3,.95], xtickname=make_array(7,val=' ')
  ...
  xyouts, 3, 1.85, 'VMD = 2.5 !9m!3m', color=84, /data
  xyouts, 3, 1.71, 'VMD = 4.5 !9m!3m', color=148, /data
  loadct, 0
  ...
  xyouts, 3, 1.78, 'VMD = 3.5 !9m!3m', color=160, /data
  plots, [0,6], 1, thick=6
  plots, [3,3.75], 1.64, thick=12, color=160, lin=1
  plots, [3,3.75], 1.57, thick=12, color=160, lin=2
  xyouts, 4, 1.63, '!9s!3 = 1.7', color=160, /data
  xyouts, 4, 1.55, '!9s!3 = 2.3', color=160, /data
...
; Co-Albedo
  ...
  plot, 1-ssa[a], /nodata, /noerase, $
   xrange=[0,6], yrange=[0,0.2], $
   xstyle=1, ystyle=1, xticks=6, yticks=4, $
   ytitle='Co-Albedo', $
   position=[.4,.25,.65,.95], xtickname=make_array(7,val=' ')
  ...
  plots, [0,6], .12, thick=6

; Forcing
  loadct, 39
  plot, frc[a], /nodata, /noerase, $
   xrange=[0,6], yrange=[-1.1,-0.1], $
   xstyle=1, ystyle=1, xticks=6, yticks=5, $
   ytitle='"Normalized" Forcing', $
   position=[.725,.25,.975,.95], xtickname=make_array(7,val=' ')
