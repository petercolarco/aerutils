...
;  plots, [15,25], 10^(alog10(3.)+.1), thick=1, color=0
  plots, [15,25], 10^(alog10(3.)), thick=18, color=48
  plots, [15,25], 10^(alog10(3.)-.1), thick=18, color=254
  plots, [15,25], 10^(alog10(3.)-.2), thick=18, color=208
  plots, [15,25], 10^(alog10(3.)-.3), thick=18, color=176
  plots, [15,25], 10^(alog10(3.)-.4), thick=18, color=84
;  plots, 19, 10^(alog10(3.)-.5), psym=sym(4), symsize=1.5
  loadct, 0
  plots, [15,25], 10^(alog10(3.)-.5), thick=18, color=100
  plots, [15,25], 10^(alog10(3.)-.6), thick=18, color=160
  plots, [15,25], 10^(alog10(3.)-.7), thick=18, color=160, lin=2
...
;  xyouts, 30, 10^(alog10(3.)+.07), 'CARMA'
  ...
  xyouts, 30, 10^(alog10(3.)-.43), 'IFS'
  xyouts, 30, 10^(alog10(3.)-.53), 'NAAPS'
  xyouts, 30, 10^(alog10(3.)-.63), 'SILAM'
  xyouts, 30, 10^(alog10(3.)-.73), 'UM'
...
;  plots, 5, mee, psym=sym(4), color=0, symsize=3
  loadct, 0
  plots, [0.4,10], mee, thick=18, color=100
  loadct, 39
