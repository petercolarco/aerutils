; Plot the size bins used in the ICAP models
  ...
  names = ['GEOS','MODELe', 'IFS','SILAM','MONARCH','MASINGAR',$
           'UM','NAAPS','AM4']
  ...
  plot, indgen(10), /nodata, $
   ...
   yrange=[0.5,1], ystyle=9, ytitle='SSA!D550 nm!N', ythick=3, yminor=5, $
   position=[.1,.12,.85,.92]
...
; MASINGAR
  ...
  nbin=nbins[imod]
  for ibin = 0, nbin-2 do begin
   plots,[xmin[ibin],xmin[ibin+1]], ssa[ibin], thick=18, color=40, noclip=0
   plots,[xmin[ibin+1],xmin[ibin+1]], [ssa[ibin],ssa[ibin+1]], thick=18, color=40
  endfor
  plots, [xmin[nbin-1],xmax], ssa[nbin-1], thick=18, color=40
