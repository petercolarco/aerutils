...
; from here: /misc/opk01/topete/du/
  ...
  pro getoptics, model, mee, ssa
   ...
   filename = filedir+'integ-du_'+model+'_lognorm_opac-raw.nc'
...
; Make a series of plots
  for imod = 0,7 do begin
   set_plot, 'ps'
   device, file='dust_param_lognormal.models_lognorm_opac.'+models[imod]+'.ps', /color, $
...
;  forcing
  ...
  device, /close
   ...
   set_plot, 'ps'
   device, file='dust_param_lognormal.model_lognorm_opac.2.'+models[imod]+'.ps', /color, $
    /helvetica, font_size=14, xsize=42, ysize=14
   !p.font=0
...
; Some kind of synthesis figure
  set_plot, 'ps'
  device, file='dust_param_lognormal.models_lognorm_opac.ps', /helvetica, font_size=14, $
...
; dither about some values
  ...
  xyouts, 5.75, 1.78, '!4OPAC!3', color=100, /data
  plots, [0,7], 1, thick=6
  plots, [3,3.75], 1.64, thick=12, color=160, lin=1
  plots, [3,3.75], 1.57, thick=12, color=160, lin=0
  plots, [3,3.75], 1.50, thick=12, color=160, lin=2
  xyouts, 4, 1.63, '!9s!3 = 1.7', color=160, /data
  xyouts, 4, 1.56, '!9s!3 = 2.0', color=160, /data
  xyouts, 4, 1.49, '!9s!3 = 2.3', color=160, /data
