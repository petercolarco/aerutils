; Plot the size bins used in the ICAP models
  ...
  set_plot, 'ps'
  device, file='dust_bins.4.ps', /color, /helvetica, font_size=14, $
...
;  plots, 5, y, psym=sym(4), color=255, symsize=2
  ...
  loadct, 39
  xyouts, .012, 1.75, /data, '!4GEOS'
  xyouts, .012, 1.25, /data, '!4OPAC Desert', color=148
  xyouts, .012, 0.75, /data, '!4Kok et al. (2017)', color=84
  loadct, 0
  xyouts, .012, 0.25, /data, '!4Remote Sensing!3', color=140
