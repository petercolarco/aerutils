...
; from here: /misc/opk01/topete/du/
  ...
  xyouts, 1.5, 1.41, '!4OPAC!3', color=100, /data
  plots, 0.925, 1.4275, psym=sym(1), color=100, symsize=1.25
;  xyouts, 5.75, 1.71, '!4NAAPS!3', /data
;  plots, 5.55, 1.7375, psym=sym(5), symsize=1.25
  plots, [.1,0.75]+.5, 1.64, thick=12, color=160, lin=1
  plots, [.1,0.75]+.5, 1.57, thick=12, color=160, lin=0
  plots, [.1,0.75]+.5, 1.50, thick=12, color=160, lin=2
  xyouts, 1.5, 1.63, '!9s!3 = ln(1.7)', color=160, /data
  xyouts, 1.5, 1.56, '!9s!3 = ln(2.0)', color=160, /data
  xyouts, 1.5, 1.49, '!9s!3 = ln(2.3)', color=160, /data
;  plots, [0,7], 1, thick=6
...
; Make a series of plots
  for imod = 0,7 do begin
   set_plot, 'ps'
   device, file='dust_param_lognormal.models.'+models[imod]+'.ps', /color, $
...
;  forcing
  ...
  device, /close
   ...
   set_plot, 'ps'
   device, file='dust_param_lognormal.model.2.'+models[imod]+'.ps', /color, $
    /helvetica, font_size=14, xsize=42, ysize=14
   !p.font=0
...
; Some kind of synthesis figure
  set_plot, 'ps'
  device, file='dust_param_lognormal.models.ps', /helvetica, font_size=14, $
