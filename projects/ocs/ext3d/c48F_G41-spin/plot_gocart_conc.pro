...
; Now make a plot
  set_plot, 'ps'
  device, file='plot_gocart_conc.'+expid+'.ps', $
...
;  xtickname[1:xyrs-1:2] = ' '
  ...
  xyouts, .525, .01, 'GOCART OCS Produced Sulfate Concentration [ng m!E-3!N]', align=.5, /normal
  tvlct, red, green, blue
  dcolors=indgen(n_elements(red))
