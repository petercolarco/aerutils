  ...
  nc4readvar, filename, 'suextcoefstrat', su, $
...
; Now make a plot
  set_plot, 'ps'
  device, file='plot_gocart_ext.'+expid+'.ps', $
...
;  xtickname[1:xyrs-1:2] = ' '
  ...
  xyouts, .525, .01, 'GOCART OCS Produced Sulfate Extinction [10!E-6!N km]', align=.5, /normal
  tvlct, red, green, blue
  dcolors=indgen(n_elements(red))
