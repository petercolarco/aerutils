...
; CARMA OCS+Pinatubo
  ...
  nymd = nymd[a]
  filename = filename[a]
  nc4readvar, filename, 'suexttau', suexttauv_c_pin, lon=lon, lat=lat

; CARMA all sources of sulfate
  ...
  nymd = nymd[a]
  filename = filename[a]
  nc4readvar, filename, 'suexttau', suexttauv_c_pint, lon=lon, lat=lat
...
; Global area average
  ...
  suext_c_pin = aave(suexttauv_c_pin,area)
  suext_c_pint= aave(suexttauv_c_pint,area)

  set_plot, 'ps'
  device, file='plot_global_pinatubo.carma.compare.ps', $
  ...
  oplot, x, suext_c_pint, thick=6, color=1, lin=2
  oplot, x, suext_pin, thick=6, color=2
  oplot, x, suext_c_pin, thick=6, color=2, lin=2
