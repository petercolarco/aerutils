...
; Now make a plot
  set_plot, 'ps'
  device, file='plot_suconc.north.ps', /color, /helvetica, font_size=12, $
  ...
  contour, suconc, indgen(n_elements(nymd)), lev, /nodata, $
   ...
   ystyle=9, yrange=[200,5],  yticks=5, ytickv=[200,100,50,20,10,5], $
