  filetemplate = 'c48_aG40-gcocs-spin.tavg2d_carma_x.ddf'
...
; tables
;################
  su[0:102,*] = su[0:102,*]*2.8


; Now make a plot
  set_plot, 'ps'
  device, file='plot_zonal_carma.ps', /color, /helvetica, font_size=12, $
  ...
  makekey, .1, .08, .85, .04, 0., -0.04, color=findgen(7), $
           labels=['1','1.5','2','2.5','3','4','5'], align=0
