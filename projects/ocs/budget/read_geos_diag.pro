...
;  Loop over number of needed variables
   for ivar = 0, n_elements(varwant_)-1 do begin
    ...
    case varwant_[ivar] of
              ...
              'tau': begin
                     levelarray = [.1,.2,.3,.4,.5,.7,1.0]
                     if(type eq 'TOT') then varn = ['duexttau','suexttau','ssexttau','bcexttau','ocexttau']
                     ...
                     if(type eq 'OCS') then varn = 'suexttau'
                     if(type eq 'OCS') then levelarray = [1,1.5,2,2.5,3,3.5,4]*.001
                     if(type eq 'OCS') then labelarray = ['1','1.5','2','2.5','3','3.5','4']
                     if(type eq 'SS') then varn = 'ssexttau'
                     if(type eq 'POM' or type eq 'OC') then varn = 'ocexttau'
                     varTitle = 'TAUEXT [550 nm]'
                     end
              'tausca': begin
                     if(type eq 'TOT') then varn = ['duscatau','suscatau','ssscatau','bcscatau','ocscatau']
                     if(type eq 'TOT') then sum = 1
              ...
              'emis': begin
                     ...
                     if(type eq 'POM' or type eq 'OC' or type eq 'BC' or type eq 'SU') then template = 0
                     end
             'emisso2':  begin
             ...
             'emisdms':  begin
              ...
              'sed': begin
                     ...
                     if(type eq 'OCS') then varn = ['susd003']
                     if(type eq 'OCS') then levelarray = [0.1,0.2,0.5,1,2,5,10]*.000001
                     if(type eq 'OCS') then labelarray = ['0.1','0.2','0.5','1','2','5','10']
               ...
               'dep': begin
                     ...
                     if(type eq 'POM' or type eq 'OC') then varn = ['ocdp001','ocdp002'];,'ocsd001','ocsd002']
                     if(type eq 'BC')                  then varn = ['bcdp001','bcdp002'];,'bcsd001','bcsd002']
                     if(type eq 'SS')                  then varn = 'ssdp0'
                     if(type eq 'SU')                  then varn = ['sudp003'];,'susd003']
                     if(type eq 'SUV')                 then varn = ['sudp003volc'];,'susd003volc']
                     if(type eq 'OCS') then varn = ['sudp003']
                     if(type eq 'OCS') then levelarray = [0.1,0.2,0.5,1,2,5,10]*.000001
                     if(type eq 'OCS') then labelarray = ['0.1','0.2','0.5','1','2','5','10']
                     if(type eq 'POM' or type eq 'OC' or type eq 'BC') then template = 0
                     end
             'depso2':  begin
               ...
               'wet': begin
                     ...
                     if(type eq 'OCS') then varn = ['suwt003']
                     if(type eq 'OCS') then levelarray = [0.1,0.2,0.5,1,2,5,10]*.00001
                     if(type eq 'OCS') then labelarray = ['0.1','0.2','0.5','1','2','5','10']
                     if(type eq 'POM' or type eq 'OC' or type eq 'BC') then template = 0
                     end
               'scav': begin
                     ...
                     if(type eq 'OCS') then varn = ['susv003']
                     if(type eq 'OCS') then levelarray = [0.1,0.2,0.5,1,2,5,10]*.00001
                     if(type eq 'OCS') then labelarray = ['0.1','0.2','0.5','1','2','5','10']
                     if(type eq 'POM' or type eq 'OC' or type eq 'BC') then template = 0
                     end
               'load': begin
                     ...
                     if(type eq 'OCS') then varn = ['so4cmass']
                     if(type eq 'OCS') then levelarray = [0.1,0.2,0.5,1,2,5,10]*.001
                     if(type eq 'OCS') then labelarray = ['0.1','0.2','0.5','1','2','5','10']
             ...
             'pso4g': begin
                     ...
                     if(type eq 'OCS') then varn = 'SUPSO4g'
                     if(type eq 'OCS') then levelarray = [0.1,0.2,0.5,1,2,5,10]*.00001
                     if(type eq 'OCS') then labelarray = ['0.1','0.2','0.5','1','2','5','10']
...
;if(varn[0] eq 'susv003') then varn = 'susv'
   ...
   if(strlowcase(varwant) eq 'ssa')    then begin
      varvalue = tausca/tau
      vartitle = 'SSA [550 nm]'
      levelarray = reverse(findgen(100)*.002 + .8)
      labelarray = ['0.8','1']
      ...
      if(type eq 'DU') then begin
       levelarray = reverse(findgen(100)*.001 + .9)
       labelarray = ['0.9','1']
      endif
   endif
