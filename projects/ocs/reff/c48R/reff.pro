  dtitle= '200906'
  filedir  = '/misc/prc14/colarco/c48R_G40b11_carma/inst3d_carma_v/'
  filename = 'c48R_G40b11_carma.inst3d_carma_v.monthly.'+dtitle+'.nc4'
; set up size bins
  nbin = 42
  rmrat = 1.9988272
...
; Zonal mean
  ...
  plot, indgen(100), /nodata, $
        ...
        xrange=[-90,90], yrange=[0,10], xstyle=9, ystyle=9
  loadct, 56
