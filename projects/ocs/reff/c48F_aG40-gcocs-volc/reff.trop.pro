  dtitle= '200104'
  filedir  = '/misc/prc14/colarco/c48F_G40b11_ocs/tavg3d_carma_v/'
  filename = 'c48F_G40b11_ocs.tavg3d_carma_v.monthly.'+dtitle+'.nc4'
; set up size bins
  nbin = 42
  rmrat = 1.9988272
...
; Zonal mean
  ...
  set_plot, 'ps'
  device, file='reff.trop.'+dtitle+'.ps', /color, /helvetica, font_size=11, $
  ...
  plot, indgen(100), /nodata, $
        ...
        xrange=[-90,90], yrange=[0,35], xstyle=9, ystyle=9
  loadct, 56
  levels = [.001,.005,.01,.05,.1,.15,.2,.25,.3]
