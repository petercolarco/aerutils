...
; OPAC (full refractive indices)
  ...
  set_plot, 'ps'
  device, file='plot_bext.bin01.ps', /helvetica, font_size=12, /color, $
   xoff=.5, yoff=.5, xsize=16, ysize=10
  !p.font=0

  loadct, 0
  plot, lambda*1d6, bext[*,0,0], /nodata, $
   xrange=[.25,40], xstyle=1, /xlog, xtitle='lambda [!Mm!Nm]', $
   yrange=[0,2500], ystyle=1, $
   ytitle='Mass Extinction Efficiency [m!E2!N kn!E-1!N]'
  oplot, lambda*1e6, bext[*,0,0], thick=8, color=100, lin=2
...
; Spher (new optics, truncated)
  ...
  oplot, lambda*1e6, bext[*,0,0], thick=8, color=254
...
; Mie (new optics, truncated)
  ...
  oplot, lambda*1e6, bext[*,0,0], thick=8, color=254, lin=1
...
; Mie (new optics)
  ...
  oplot, lambda*1e6, bext[*,0,0], thick=8, color=254, lin=2
