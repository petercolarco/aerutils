...
; Make a plot
  set_plot, 'ps'
  device, file='lwtneteff_all_sky.'+expid0+'_'+expid1+'.eps', $
 ...
 !p.font=0
  ...
  levels = [-1000.,-60,-40,-25,-10,-5,-1,1,5,10,25]/10.
  levels = [-1000.,-10,-5,-2,-1,-0.5,-0.1,.1,.5,1,2]
  levels = [-1000.,0.1,0.5,1,2,5,10]
  labelarray = string(levels,format='(f5.1)')
  levels[0] = -1000.
  labelarray[0] = ' '
  colors = [255,84,176,192,208,220,254]

  dlevels = findgen(21)*.4-4.4
  dlevels[0] = -100.
