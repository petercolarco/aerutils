...
; OPAC (full refractive indices)
  ...
  plot, lambda*1d6, refimag[*,0,0], /nodata, $
   ...
   yrange=[.001,1], ystyle=1, ytitle='Imaginary Part', yticks=3, /ylog
  oplot, lambda*1e6, abs(refimag[*,0,0]), thick=8, color=100
...
; Mie (new optics)
  ...
  oplot, lambda*1e6, abs(refimag[*,0,0]), thick=8, color=254, lin=2
