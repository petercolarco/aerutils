...
; do a size distribution
  ...
  if(i eq 0) then begin
   ...
   loadct, 0
   plot, r, du[0,0,*]*r/dr, $
    /xlog, /ylog, /nodata, xrange=[1,20.], yrange=[1e,100], charsize=1.2, $
    xtitle='diameter [um]', ytitle='dMdlnr [Tg]', xstyle=1, ystyle=1

   x = [diam,reverse(diam),diam[0]]
   y = [dmdlndp2,reverse(dmdlndm2),dmdlndp2[0]]
   polyfill, x, y, color=220, noclip=0
   oplot, diam, dmdlnd, thick=6, color=0, lin=2
