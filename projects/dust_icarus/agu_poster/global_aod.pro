; Array for global AOD
  ...
  plot, totexttau[*,0], thick=8, /nodata, $
  ...
  for iexpid = 0, nexpid-1 do begin
   ...
   oplot, x, totexttau[*,iexpid], color=color[iexpid], thick=8, lin=lin[iexpid]
  endfor
  ...
  for iexpid = 0, nexpid-1 do begin
   if(iexpid lt 2) then loadct, 0
   if(iexpid ge 2) then loadct, 39
   oplot, x, duexttau[*,iexpid], color=color[iexpid], thick=8, lin=lin[iexpid]
  endfor
