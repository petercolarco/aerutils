...
; Make a plot of the difference in the wind speeds between two simulations
  ...
  expid = ['c180F_pI20p1-acma_spher','c180F_pI20p1-acma', $
           'c180F_pI20p1-acma_gocart', $
           'c180F_pI20p1-acma_mie','c180F_pI20p1-acma_miet', $
           'c180F_pI20p1-acma_spher_noir']
  diffs = ['!4Kok - No Forcing !415!Eo!NW - 0!Eo!NW!3', $
           '!4Kok (Old) - No Forcing !415!Eo!NW - 0!Eo!NW!3', $
           '!4GOCART - No Forcing !415!Eo!NW - 0!Eo!NW!3', $
           '!4Kok (Mie) - No Forcing !415!Eo!NW - 0!Eo!NW!3', $
           '!4Kok (Mie truncated) - No Forcing !415!Eo!NW - 0!Eo!NW!3', $
           '!4Kok (No-IR) - No Forcing !415!Eo!NW - 0!Eo!NW!3'  ]
...
; Get the forcing for first experiment
  ...
  filen = '/misc/prc18/colarco/'+expid0+'/'+expid0+ $
          '.geosgcm_prog.monthly.200807.nc4'
  ...
  filen = '/misc/prc18/colarco/'+expid0+'/tavg3d_aer_p/'+expid0+ $
          '.tavg3d_aer_p.monthly.200807.nc4'

  nc4readvar, filen, 'du', du, lon=lon, lat=lat, lev=lev2
  nc4readvar, filen, 'airdens', airdens, lon=lon, lat=lat, lev=lev2
  duconc = du*airdens
...
; Get the forcing for baseline experiment
  expid1 = 'c180F_pI20p1-acma_nodu'
  filen = '/misc/prc18/colarco/'+expid1+'/'+expid1+ $
          '.geosgcm_prog.monthly.200807.nc4'
...
; Now do the zonal averaging
  a = where(lon ge -30 and lon le 15)
...
;  find levels lt 0
  ...
  set_plot, 'ps'
  device, file = expid0+'.tprofile_15W.eps', /color, /helvetica, $
  ...
  contour, dt, lat, lev, $
   title=difftitle, $
   xrange=[-10,40], yrange=[1000,300], /ylog, $
   levels=dlevels, c_colors=dcolors, /cell, $
   yticks=7, ytickv=tickv, $
   ystyle=9, xstyle=9, $
