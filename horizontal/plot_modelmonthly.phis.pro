...
; satellite plotted
  ...
  device, file='./output/plots/'+expid+'.phis.'+yyyymm+'.ps', $
 ...
 !p.font=0
   ...
   levelArray[0] = -1000.
   levelArray = [-1000, 50, 100, 150, 200, 300, 500, 750, 1000, 2000, 3000]
   labelArray = strcompress(string(levelarray,format='(i4)'),/rem)
   labelArray[0] = '0'
