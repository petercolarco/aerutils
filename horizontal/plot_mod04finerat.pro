...
; Plot AOT from model diag files
  ...
  datewant=['-9999']
  modisdir = '/output/colarco/MODIS/Level3/MOD04/GRITAS/Y2001/M04/'
  ctlfilelnd = modisdir + 'MOD04_L2_ocn.aeroqa_005.200104.hdf'
  ctlfileocn = modisdir + 'MOD04_L2_ocn.aeroqa_005.200104.hdf'

;  datewant=['200103','200104']
;  ctlfilelnd = 'MOD04_L2_005.lnd.ctl'
;  ctlfileocn = 'MOD04_L2_005.ocn.ctl'

  varwant = ['finerat']
  wantlev = [-9999]
  wantlat = ['0', '80']
  wantlon = ['80', '300']
  titleStr = 'MODIS Fine Mode Fraction of AOT April 2001'
  plotstr  = 'MOD04_L2_005finerat'


  ga_getvar, ctlfilelnd, '', varout, lon=lon, lat=lat, lev=lev, time=time, $
                             wanttime=datewant, wantlev=wantlev, wantlon=wantlon, wantlat=wantlat,/noprint
  nt = n_elements(time)
  nx = n_elements(lon)
  ny = n_elements(lat)
