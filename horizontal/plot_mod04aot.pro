...
; Plot AOT from model diag files
  ...
  datewant=['-9999']
  modisdir = '/output/colarco/MODIS/Level3/MYD04/d/GRITAS/Y2007/M07/'
  ctlfilelnd = modisdir + 'MYD04_L2_lnd.aero_005.noqawt.200707.hdf'
  ctlfileocn = modisdir + 'MYD04_L2_ocn.aero_005.noqawt.200707.hdf'

  varwant = ['aodtau']
  wantlev = '550'
  wantlat = ['-60', '80']
  wantlon = ['-180', '180']
  titleStr = 'MODIS Aqua AOT July 13 - 31, 2007'
  plotstr  = 'MYD04_L2_005.noqawt'
