...
; final
  ...
  datewant=['200001','200712']
  ctlfile  = ['MOD04_L2_051.mm.qawt3.lnd.b.ctl', 'MYD04_L2_051.mm.qawt3.lnd.b.ctl', $
              'R_control.MOD04_lnd.qawt3.ctl','MISR.mm.b.ctl']
  nctl = n_elements(ctlfile)
  typefile = ['MODIS','MODIS','tau','MISR']
  colorarray = [0, 0, 254, 84]
  linarray = [0,2,0,0]
  resolution = ['b','b','b','b']
  scolorarray = [0,0,0,0,0]
  thick = make_array(nctl,val=12)

;; diurnal
;  plottitlehead = 't003_c32_final_MOD04.qawt.diurnal'
;  datewant=['200001','200612']
;  ctlfile  = ['MOD04_L2_005.lnd.qawt.ctl', 'MISR.ctl', $
;              't003_c32.tau2d.v2.SSo2.total.ctl', $
;              't003_c32.tau2d.v2.SSo2.total.00z.ctl', $
;              't003_c32.tau2d.v2.SSo2.total.06z.ctl', $
;              't003_c32.tau2d.v2.SSo2.total.12z.ctl', $
;              't003_c32.tau2d.v2.SSo2.total.18z.ctl']
;  typefile = ['MODIS','MISR','tau_tot','tau_tot','tau_tot','tau_tot','tau_tot','tau_tot']
;  colorarray = [0, 0, 120, 120, 120, 120, 120]
;  linarray = [0,1,0,1,2,3,4]
;  resolution = ['c','c','c','c','c','c','c']
;  thick = [9,9,9,2,2,2,2]
;  scolorarray = [0,0,0,0,0,0,0]
...
; Plot
  ...
  plot_strip, date, val, ymaxwant[ireg], title[ireg], ytitle, ctlfile, $
              ...
              std=std, scolorarray=scolorarray, thick=thick, $
...
; Ocean -------------------------------------------------------------------
; final
  plottitlehead = 'CR_control'
  datewant=['200001','200712']
  ctlfile  = ['MOD04_L2_051.mm.qawt.ocn.b.ctl', 'MYD04_L2_051.mm.qawt.ocn.b.ctl', $
              'R_control.MOD04_ocn.qawt.ctl','MISR.mm.b.ctl']
  nctl = n_elements(ctlfile)
  typefile = ['MODIS','MODIS','tau','MISR']
  colorarray = [0, 0, 254, 84]
  linarray = [0,2,0,0]
