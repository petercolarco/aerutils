...
; Model experiments you want to sample
  expidstr = 'dR_MERRA-AA-r1.MISR'  ; plot string
  expid = ['dR_MERRA-AA-r1','dR_Fortuna-M-1-1','bR_Fortuna-2_5-b5','bR_Fortuna-2_5-b4','bR_Fortuna-2_5-b2']
  nnr = 0
  resmodel = ['d','d','b','b','b']
  colorarr_mod = [0,0,254,75,176]
  colortab_mod = [39,39,39,39,39]
  linesarr_mod = [0,2,0,0,0]
