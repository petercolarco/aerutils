...
# Specify the resolution as input (a, b, c, d, e)
  ...
  if ( $#argv < 2 ) then
   ...
   echo "./satellite2satellite_monmean.csh SATID RES {YYYY MM QA}"
   exit 1
  endif
...
# Satellite data
  ...
  if($satid == 'MOD04') set set odsver = aero_005
...
# Resolution
  ...
  set expdir = $MODISDIR/MODIS/Level3/${satid}/GRANULE/${res}/GRITAS/
