...
; Read in a MODIS "ocn" and "lnd" file and merge to plot a monthly mean AOT
  ...
  for jday = jday0, jday1, 5L do begin
   ...
   fileland = filehead+'/Y'+yyyy+'/M'+mm+'/'+satid+'_L2_lnd.pentad.aero_005.qawt.'+yyyy+mm+dd+'.hdf'
   fileocn  = filehead+'/Y'+yyyy+'/M'+mm+'/'+satid+'_L2_ocn.pentad.aero_005.qawt.'+yyyy+mm+dd+'.hdf'
...
; Now average results together
  ...
  set_plot, 'ps'
  device, file='./output/plots/'+satId+'.pentad.aodtau550.'+yyyy+mm+dd+'.ps', $
  ...
  !p.font=0
   ...
   titlestr = 'MODIS '+satStr+' AOT [550 nm] ('+yyyy+'/'+mm+'/'+dd+' - '+yyyy_+'/'+mm_+'/'+dd_+')'
