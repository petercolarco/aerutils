...
;               '.aodtau550_difference.tropatl.ps', $
 ...
 !p.font=0
  ...
  filetemplate = '/misc/prc15/colarco/'+expid+'/chem/Y%y4/M%m2/'+ $
                  expid+'.inst1_2d_hwl_Nx.'+satid+'_L2_ocn.aero_tc8_051.qawt.%y4%m2.nc4' 
  ...
  filetemplate = '/misc/prc15/colarco/'+expid+'/chem/Y%y4/M%m2/'+ $
                  expid+'.inst1_2d_hwl_Nx.'+satid+'_L2_lnd.aero_tc8_051.qawt3.%y4%m2.nc4' 
  filename = strtemplate(filetemplate,nymd[ii],nhms[ii],str=expid)
