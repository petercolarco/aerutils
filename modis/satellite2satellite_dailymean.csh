...
set months     = `echo 06 07 08 09 10`
set qastr      = `echo qawt `
...
#       Average the QAFL
        ...
        \mv -f tmp_qawt.${rand}.nc4 $datadir/Y$YYYY/M$MM/$datatyp.$odsver.$qawt.$YYYY$MM${dd}dd.nc4
        \mv -f tmp_qafl.${rand}.nc4 $datadir/Y$YYYY/M$MM/$datatyp.$odsver.$qafl.$YYYY$MM${dd}dd.nc4
        \mv -f tmp_fine.${rand}.nc4 $datadir/Y$YYYY/M$MM/$datatyp.$odsver.${qawt}_fineaot.$YYYY$MM${dd}dd.nc4
