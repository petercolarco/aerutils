...
#   cd /tmp/colarco
    ...
    set BIN_EXEC   = /home/colarco/sourcemotel/futils/Linux/bin

# foreach INSTRUMENT ( MOD04 MYD04 )
 foreach INSTRUMENT ( MOD04 )
    set IN_DIR     = /output/MODIS/Level3/$INSTRUMENT
    set OUT_DIR    = /output/MODIS/Level3/$INSTRUMENT
     ...
     while ( $DD < $DAYMAX )
       ...
       foreach TYPE ( land ocean )
        ...
        if ( $INSTRUMENT == MOD04 ) then
         $BIN_EXEC/gritas.x -rc $RC_DIR/gritas_.c5.$TYPE.rc -res c -obs -o $OUT_FILE $IN_FILE
        else
         $BIN_EXEC/gritas.x -rc $RC_DIR/gritas_.myd04.c5.$TYPE.rc -res c -obs -o $OUT_FILE $IN_FILE
        endif
