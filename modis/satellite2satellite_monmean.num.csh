...
#           -func "sum(@.1*finerat.2(z=1)*num.2(z=1),t=1,t=$ntime)/sum(maskout(num.2(z=1),@.1),t=1,t=$ntime)" \
#           -time $middletime $middletime
...
#           -func "sum(maskout(@.1,aodtau.2(z=1)),t=1,t=$ntime)" \
#           -vars num qasum \
#           -time $middletime $middletime
...
#        chmod g+w,g+s tmp_fine.${rand}.nc4
        ...
        \mv -f tmp_qawt.${rand}.nc4 $datadir/Y$YYYY/M$MM/$datatyp.$odsver.$qawt.num.$YYYY$MM.nc4
