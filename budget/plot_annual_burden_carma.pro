...
; Plot the different instances
  ...
  oplot, years, dubur_bF_v8, thick=6, color=208        ; colarco mie
  oplot, years, dubur_bF_v10, thick=6, color=208, lin=1; colarco spheroid
  oplot, years, dubur_bF_v11, thick=6, color=254, lin=1; opac spheroid
  oplot, years, dubur_bF_v7, thick=6, color=254, lin=2; opac ellipsoid
;  oplot, years, dubur_bF_kok, thick=6, color=176      ; kok sphere, v1 optics

  plots, [2012,2015], 19.0, thick=6, color=254
  plots, [2012,2015], 17.5, thick=6, color=254, lin=2
  plots, [2012,2015], 16.0, thick=6, color=254, lin=1
  plots, [2024,2027], 19.0, thick=6, color=84
  plots, [2024,2027], 17.5, thick=6, color=84, lin=2
  plots, [2024,2027], 16.0, thick=6
  plots, [2037,2040], 19.0, thick=6, color=208
  plots, [2037,2040], 17.5, thick=6, color=208, lin=1
;  plots, [2037,2040], 16.0, thick=6, color=176
  
  xyouts, 2016, 18.9, 'OPAC', charsize=.8
  xyouts, 2016, 17.4, 'OPAC!C(Ellipsoid)', charsize=.8
  xyouts, 2016, 15.9, 'OPAC!C(Spheroid)', charsize=.8
  xyouts, 2028, 18.9, 'Shettle/Fenn', charsize=.8
  xyouts, 2028, 17.4, 'Shettle/Fenn!C(Ellipsoid)', charsize=.8
  xyouts, 2028, 15.9, 'No Forcing', charsize=.8
  xyouts, 2041, 18.9, 'Colarco/Kim', charsize=.8
  xyouts, 2041, 17.4, 'Colarco/Kim!C(Spheroid)', charsize=.8
;  xyouts, 2041, 15.9, 'Kok w/OPAC Mie', charsize=.8

  device, /close

; Plot the box-whisker plot
  device, file='annual_burden_carma.stat.ps', /color, /helvetica, $
          font_size=8, xoff=.5, yoff=.5, xsize=14, ysize=9
  !p.font=0
  plot, findgen(10), /nodata, $
        title='Variability in Dust Burden', $
        xrange=[0,9], xstyle=9, $
        ytitle='Burden [Tg]', yrange=[18,26], ystyle=9, $
        thick=3, xticks=9, $
  ...
  for i = 0, 8 do begin
   xyouts, i, 17.8, /data, xtickname[i], orient=-60
  endfor

  boxwhisker, dubur_b_v1 , 1, .5, 255, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
print, 'b_v1:  ', meanval, stddv
  boxwhisker, dubur_bF_v1, 2, .5, 254, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
print, 'bF_v1:  ', meanval, stddv
  boxwhisker, dubur_bF_v7, 3, .5, 254, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
print, 'bF_v7:  ', meanval, stddv
  boxwhisker, dubur_bF_v11, 4, .5, 254, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
print, 'bF_v11:  ', meanval, stddv
  boxwhisker, dubur_bF_v6, 5, .5, 84, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
print, 'bF_v6:  ', meanval, stddv
  boxwhisker, dubur_bF_v5, 6, .5, 84, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
print, 'bF_v5:  ', meanval, stddv
  boxwhisker, dubur_bF_v8, 7, .5, 208, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
print, 'bF_v8:  ', meanval, stddv
  boxwhisker, dubur_bF_v10, 8, .5, 208, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
print, 'bF_v10:  ', meanval, stddv
;  boxwhisker, dubur_bF_kok, 9, .5, 176, medval, qtr_25th, qtr_75th, minval, maxval, meanval, stddv
