...
; Given a species type and a variable name, return a filled variable array
  ...
  pro read_geos_diag, filename, varWant, varValue, $
                      ...
                      wantlon=wantlon, wantlat=wantlat, type=type, $
                      oldscav=oldscav, gocart2g=gocart2g, rc=rc

   brstr = 'brc'
   if(keyword_set(gocart2g)) then brstr = 'br'
   if(not(keyword_set(gocart2g))) then gocart2g = 0
   ...
   for ivar = 0, n_elements(varwant_)-1 do begin
    ...
    case varwant_[ivar] of
              ...
              'tautot': begin
                     ...
                     varn = ['duexttau','suexttau','ssexttau','bcexttau','ocexttau',brstr+'exttau']
                     if(type eq 'SUV') then varn = [varn,'suexttauvolc']
                     sum = 1
                     levelarray = findgen(100)*.01
                     labelarray = ['0','1']
                     varTitle = 'TAUEXT [550 nm]'
                     if(keyword_set(gocart2g)) then varn = varn+'550'
                     end
              'tau': begin
                     levelarray = [.1,.2,.3,.4,.5,.7,1.0]
                     if(type eq 'TOT') then varn = ['duexttau','suexttau','ssexttau','bcexttau', $
                                                    'ocexttau','niexttau','suexttauvolc',brstr+'exttau']
                     ...
                     if(type eq 'BRC' or type eq 'BRC') then varn = brstr+'exttau'
                     varTitle = 'TAUEXT [550 nm]'
                     if(keyword_set(gocart2g)) then varn = varn+'550'
                     end
              'tausca': begin
                     if(type eq 'TOT') then varn = ['duscatau','suscatau','ssscatau','bcscatau', $
                                                    'ocscatau','niscatau',brstr+'scatau']
                     if(type eq 'SUV') then varn = [varn,'suscatauvolc']
                     if(type eq 'TOT') then sum = 1
                     ...
                     if(type eq 'BRC' or type eq 'BRC') then varn = brstr+'scatau'
                     levelarray = findgen(100)*.01
                     labelarray = ['0','1']
              ...
              'emis': begin
                     ...
                     if(type eq 'BRC'                ) then varn = [brstr+'em001',brstr+'em002']
                     ...
                     if(gocart2g) then begin
                      if(type eq 'BRC'                ) then varn = [varn,brstr+'psoa']
                      if(type eq 'POM' or type eq 'OC') then varn = [varn,'ocpsoa']
                     endif
                     end
             'emisso2':  begin
             ...
             'emisdms':  begin
              ...
              'sed': begin
                     ...
                     if(type eq 'BRC'                ) then varn = [brstr+'sd001',brstr+'sd002']
               ...
               'dep': begin
                     ...
                     if(type eq 'BRC'                ) then varn = [brstr+'dp001',brstr+'dp002']
             ...
             'depso2':  begin
               ...
               'wet': begin
                     ...
                     if(type eq 'BRC'                ) then varn = [brstr+'wt001',brstr+'wt002']
...
;                     if(type ne 'SU') then sum = 1
                     ...
                     if(type eq 'BRC'                ) then varn = brstr+'sv' ;['brcsv001','brcsv002']
...
;                        type eq 'BC' or type eq 'SU') then template = 0
                     if(keyword_set(oldscav)) then begin
                      ...
                      if(type eq 'BRC'                ) then varn = [brstr+'sv001',brstr+'sv002']
            ...
            'scavnh4': begin
               ...
               'load': begin
                     ...
                     if(type eq 'BRC'                ) then varn = brstr+'cmass'
               ...
               'load25': begin
                     ...
                     if(type eq 'BRC'                ) then varn = brstr+'cmass25'
             ...
             'loaddms':  begin
               ...
               'embb':  begin
                     ...
                     if(type eq 'BRC')                 then varn = brstr+'embb'
                     end
               'embf':  begin
                     ...
                     if(type eq 'BRC')                 then varn = brstr+'embf'
                     end
               'eman':  begin
                     ...
                     if(type eq 'BRC')                 then varn = brstr+'eman'
                     end
               'embg':  begin
                     ...
                     if(type eq 'BRC')                 then varn = brstr+'embg'
                     end
               'psoa':  begin
                     varTitle = 'Production of SOA'
                     varUnits = ' [kg m!E-2!N s!E-1!N]'
                     if(type eq 'POM' or type eq 'OC') then varn = 'ocpsoa'
                     if(type eq 'BRC')                 then varn = brstr+'psoa'
                     end
             'emisvolcn':  begin
