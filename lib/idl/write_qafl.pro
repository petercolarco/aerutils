  pro write_qafl, outPath, filehead, nx, ny, dx, dy, nt, nlev, date, $
                  lon, lat, lev, finemode, qa, num, std, minval, maxval, $
...
;  Set time for end of day
   ...
   cdfid = ncdf_create(fileout, /clobber)
    ...
    idfnOcean      = NCDF_VARDEF(cdfid,'finerat',[idLon,idLat,idLambdaO,idTime], /float)
    idqaOcean      = NCDF_VARDEF(cdfid,'qasum',[idLon,idLat,idLambdaO,idTime], /float)
    idnumOcean      = NCDF_VARDEF(cdfid,'num',[idLon,idLat,idLambdaO,idTime], /float)
    idstdOcean      = NCDF_VARDEF(cdfid,'stddev',[idLon,idLat,idLambdaO,idTime], /float)
    idmnOcean      = NCDF_VARDEF(cdfid,'aotmin',[idLon,idLat,idLambdaO,idTime], /float)
    idmxOcean      = NCDF_VARDEF(cdfid,'aotmax',[idLon,idLat,idLambdaO,idTime], /float)
    ...
    ncdf_varput, cdfid, idfnOcean, finemode
