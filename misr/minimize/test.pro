...
;  Read the observation
   filename = strtemplate(dset_otest,nymd[it],nhms[it])
...
;contour, k,title=f[iff]
  ...
  set_plot, 'ps'
  device, file='ss_minimize.2009.ps', /helvetica, font_size=12, /color
  !p.font=0
...
; Find min of each curve
  ...
  plot, f, r_[*,0], /nodata, $
   ...
   title = 'Sea salt minimization vs. MISR, R_qfed21_2_3 (2009)!Ckernel = step function'
