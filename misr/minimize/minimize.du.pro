...
;contour, k,title=f[iff]
  ...
  set_plot, 'ps'
  device, file='du_minimize.2009.ps', /helvetica, font_size=12, /color
  !p.font=0
...
; Find min of each curve
  ...
  plot, f, r_[*,0], /nodata, $
   ...
   title = 'Dust minimization vs. MISR, R_qfed21_2_3 (2009)!Ckernel = step function'
  ...
  save, file='misr.du.2009.sav', /all
