...
# Average the QAFL
  ...
  \mv -f tmp_qawt.${rand}.nc4 $datadir/Y$YYYY/M$MM/$datatyp.$algorithm.$qawt.$YYYY$MM${dd}dd.nc4
  \mv -f tmp_qafl.${rand}.nc4 $datadir/Y$YYYY/M$MM/$datatyp.$algorithm.$qafl.$YYYY$MM${dd}dd.nc4
