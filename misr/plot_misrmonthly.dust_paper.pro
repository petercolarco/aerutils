...
; satellite plotted
  ...
  filetemplate = '/science/terra/misr/data/Level3/b/GRITAS/clim/MISR_L2.aero_tc8_F12_0022.noqawt.clim'+mm+'.nc4'
...
;  device, file='./output/plots/'+satId+'.aodtau550.'+yyyymm+'.ps', $
  device, file='./output/plots/'+satId+'.aodtau550.JJA.eps', $
