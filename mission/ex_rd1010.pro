; $Header: /cvsroot/esma/sandbox/colarco/aerutils/mission/ex_rd1010.pro,v 1.1.1.1 2008/04/30 19:04:12 colarco Exp $

pro ex_rd1010, filename, xname=xname, xvalues=xvals $
...
;   ex_rd1010
; PURPOSE:
;   reads a format-1010 exchange file
; CATEGORY:
;   exchange
; CALLING SEQUENCE:
;   ex_rd1010, filename, xname=xname, xvalues=xvals $
;             , vname=vname, data=dat, vmiss=vmiss $
...
;    n_dimens = 1 (format 1010 deals only with 1D data)
...
if ftype ne 1010 then stop,"Wrong file type for 1010:",ftype
