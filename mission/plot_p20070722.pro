...
; Plot AOT from model diag files
  ...
  datewant=['16:30z22jul2007']
  filetag = '1630z22jul2007'
  forecast = ['20070718_00z', '20070718_12z', $
              '20070719_00z', '20070719_12z', '20070720_00z', '20070720_12z', $
              '20070721_00z', '20070721_12z', '20070722_00z', '20070722_12z' ]

  nfore = n_elements(forecast)

  for ifore = 0, nfore-1 do begin

  dir = 'p20070722/'+forecast[ifore]
  wantlat = ['-5','25']
  wantlon = ['-100','-40']
