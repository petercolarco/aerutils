; $Header: /cvsroot/esma/sandbox/colarco/aerutils/mission/ex_rd1001.pro,v 1.1.1.1 2008/04/30 19:04:12 colarco Exp $

pro ex_rd1001, filename, xname=xname, xvalues=xvals $
...
;   ex_rd1001
; PURPOSE:
;   reads a format-1001 exchange file
; CATEGORY:
;   exchange
; CALLING SEQUENCE:
;   ex_rd1001, filename, xname=xname, xvalues=xvals $
;             , vname=vname, data=dat, vmiss=vmiss $
...
;    nauxv = 0, the number of auxiliary variables in a 1001-format file
;    aname = unused
;    auxdat = unused
;    amiss = unused
;    n_dimens = 1 (format 1001 deals only with 1D data)
...
if ftype ne 1001 then stop,"Wrong file type for 1001:",ftype
