...
; Loop over the individual trackfiles
  for ifiles = 0, nfiles-1 do begin
   ...
   for id = 0, 8 do begin
    ...
    outfile = '/misc/prc12/dao_ops/e530_yotc_01/Y2009/e530_yotc_01.calipso.532nm.'+datestr+'.nc'
    model_track, outfile, tracklon, tracklat, trackdates, lambda='532'
   endfor
