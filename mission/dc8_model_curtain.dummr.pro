  ...
  title = 'GEOS-5 Dust mmr [ppbm] 16:30z22jul2007 on DC-8 track'
  ...
  get_model_navtrack, modelurl, 'du', dummr, lonf, latf, lev, $
...
; Make a plot
  set_plot, 'ps'
  device, file='./p'+datewant+'/dummr_dc8.'+datewant+'.ps', font_size=18, /helvetica, $
  ...
  levelarray = [1,2,5,10,25,50,100,150,200,250]
  loadct, 39
