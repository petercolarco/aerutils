...
; Plot AOT from model diag files
  ...
  datewant=['16:30z19jul2007']
  filetag = '1630z19jul2007'
  forecast = ['20070715_00z', '20070715_12z', '20070716_00z', '20070716_12z', $
              '20070717_00z', '20070717_12z', '20070718_00z', '20070718_12z', $
              '20070719_00z', '20070719_12z' ]

  nfore = n_elements(forecast)

  for ifore = 0, nfore-1 do begin

  dir = 'p20070719/'+forecast[ifore]
  wantlat = ['-5','25']
  wantlon = ['-100','-40']
