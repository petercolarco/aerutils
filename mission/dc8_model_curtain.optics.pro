  ...
  title = 'GEOS-5 ~Aerosol Extinction [km!E-1!N] 16:30z'+dd+'jul2007 on DC-8 track'
  datadir = '/Users/colarco/Desktop/TC4/data/'
  navfile = dataDir + 'TN'+datewant+'.DC8.txt'

  modelfile = 'asm_optics.dc8.geos4.'+datewant+'.nc'
...
; Make a plot
  set_plot, 'ps'
  fileps  = './p'+datewant+'/ext_dc8.geos4.'+datewant+'.ps'
  filepng = './p'+datewant+'/ext_dc8.geos4.'+datewant+'.png'
