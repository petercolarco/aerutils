; horizontal plot -- makes postscript
  ...
  pro hplot, input_, lon, lat, $
      ...
      datadir=datadir, er2=er2, dc8=dc8, datewant=datewant, routelat=routelat, routelon=routelon
...
; title
  ...
  map_set, 90, -110, 0, /noborder, limit=maplimits, position=[.05,.2,.95,.88], /stereo, /iso
  plotgrid, input, levelarray, colorarray, lon, lat, dx, dy, undef=!values.f_nan, /map
  map_continents, thick=5, color=0
  map_set, 90, -110, 0, /noerase, limit=maplimits, position=[.05,.2,.95,.88], /stereo, /iso
