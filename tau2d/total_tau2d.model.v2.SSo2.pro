...
;   Read the monthly averaged file
    ...
    ga_getvar, filewant, varwant, varout1, /sum, /save, ofile='tmp.nc', $
     lon=lon, lat=lat, lev=lev

    varwant = ['ss001','ss002','ss003','ss004','ss005']
    ga_getvar, filewant, varwant, varout2, /sum, /save, ofile='tmp.nc', $
     lon=lon, lat=lat, lev=lev

;   Add half the SS AOT
    varout = varout1+(varout2/2.)
...
;   Write to a new file
    write_aot, filedir, filehead[iff]+'SSo2.total', nx, ny, dx, dy, nt, nlev, date, $
