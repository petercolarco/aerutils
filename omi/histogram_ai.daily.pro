; From model calculations, grab the model AOT and plot
  nc4readvar, 'omia.ai.ddf', 'ana', aota, lon=lon, lat=lat
  nc4readvar, 'omib.ai.ddf', 'ana', aotb, lon=lon, lat=lat
  nc4readvar, 'omic.ai.ddf', 'ana', aotc, lon=lon, lat=lat
  nc4readvar, 'omid.ai.ddf', 'ana', aotd, lon=lon, lat=lat
  nc4readvar, 'omie.ai.ddf', 'ana', aote, lon=lon, lat=lat
  nc4readvar, 'omif.ai.ddf', 'ana', aotf, lon=lon, lat=lat
  nc4readvar, 'omig.ai.ddf', 'ana', aotg, lon=lon, lat=lat
...
; Make a histogram plot
  set_plot, 'ps'
  device, file='ai_histogram.daily.ps', /color, /helvetica, font_size=10, $
