; File to read
  lambda = '532'
  filedir  = './'
  filename = 'e572p5_fp.20120911.nc'
; Read
  depol = 1
  extinction = 1
  cloud=1
...
; Make an inset map for display
  ...
  map_set, /noerase, position=[x0,y0,x1,y1], limit=[5,-80,45,-30]
; Plot the AOT
  filename = '/misc/prc13/dao_ops/e572p5_fp/das/Y2012/M09/e572p5_fp.inst1_2d_hwl_Nx.20120912_0000z.nc4'
