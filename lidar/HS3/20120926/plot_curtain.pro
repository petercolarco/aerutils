; File to read
  lambda = '532'
  filedir  = './'
  filename = 'e572p5_fp.20120919.nc'
; Read
  depol = 1
  extinction = 1
  cloud=1
...
; Put time into hour of day
  ...
  time[a[0]:nt-1] = time[a[0]:nt-1] + 24.
...
; Make an inset map for display
  ...
  map_set, /noerase, position=[x0,y0,x1,y1], limit=[20,-80,60,-20]
; Plot the AOT
  filename = '/misc/prc13/dao_ops/e572p5_fp/das/Y2012/M09/e572p5_fp.inst1_2d_hwl_Nx.20120920_0000z.nc4'
  ...
  map_continents, thick=.5, color=255
  oplot, lon, lat, thick=6, color=192
  ...
  plots, [x0,x1,x1,x0,x0], [y0,y0,y1,y1,y0], thick=6, /normal, color=255
