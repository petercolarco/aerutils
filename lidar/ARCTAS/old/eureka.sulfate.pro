; Eureka
  ...
  ga_getvar, 'arctas_suext.ddf', 'tau', tau, $
...
; Make a plot
  ...
  fileps  = './'+sitelow+'.geos5.sulfate.ext.ps'
  filepng = './'+sitelow+'.geos5.sulfate.ext.png'
  ...
  contour, ext, findgen(nt)*.25+daynum0, reform(hght[0,*])/1000., /nodata, /noerase, $
   ...
   xrange=[daynum0,daynum0+nt/4]
  xyouts, .15, .92, 'GEOS-5 Sulfate Aerosol Extinction [532 nm, 1/km] at '+site, $
          charsize=.8, /normal
