...
# extractions at present.
  ...
  set expid  = d591_rpit2_jun06
  set inpdir = /misc/prc15/colarco/$expid/chem/
  set outdir = $inpdir
  ...
  extract_stations.x -rc aeronet_locs.dat.sav \
    -i $inpdir/Y%y4/M%m2/$expid.inst1_2d_hwl_Nx.%y4%m2%d2_%h200z.nc4 \
