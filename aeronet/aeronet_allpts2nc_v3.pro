; Colarco
; March 2019
; Updated from original aeronet_allpts2nc.pro
; Goal is to manipulate the AERONET Level 2.0 version 3.0 data and
; grid to a uniform time array.

  spawn, 'echo $AERONETDIR', headDir
  dataDir = '/misc/prc10/AERONET/V3/AOT/AOD/AOD20/ALL_POINTS/'
...
; Structure of desired output file
  ...
  nchannels = 22
  channels = [1640, 1020, 870, 865, 779, 675, 667, 620, 560, 555, 551, $
              532, 531, 510, 500, 490, 443, 440, 412, 400, 380, 340]
  nangpairs = 6
...
;   On return the values returned are the daily averaged aot, etc.
    ...
    read_aeronet_allpts_v3, filename, location, lon, lat, elev, nmeas, pi, pi_email, $
     dateIn, aotIn, angIn
...
;   Create netcdf file for output
    s1 = systime(1,/seconds)
    cdfid = ncdf_create(dataDir+'../../../../LEV30/aot_allpts.'+location+'.nc', /clobber)
